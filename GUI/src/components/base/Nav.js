                ...
                <header id="header" className="fixed-top d-flex align-items-center header-transparent">
                    <div className="container d-flex align-items-center">
                        ...
                        <nav className="nav-menu d-none d-lg-block mx-auto">
                            <ul>
                                <li className="active"><Link to="/"> <span className="h5">Product</span></Link></li>
                                ...
                                <li className="d-xl-none d-lg-none d-md-block my-2 btn btn-primary rounded-pill mx-2 h6"><Link to="" className="text-white">Sign in <i className="la la-angle-right"></i></Link></li>
                        ...
                        <nav className="d-none d-lg-block d-sm-none d-md-none">
                            <li className="btn btn-primary rounded-pill mx-2 h6"><Link to="" className="text-white">Sign in <i className="la la-angle-right"></i></Link></li>
