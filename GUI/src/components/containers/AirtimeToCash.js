...
export class AirtimeToCash extends Component {
    render() {
        return (
            <div>
                                    ...
                                    <div className="row">
                                        <div className="col-md-6 pb-4">
                                            <div className="border px-2" style={{ borderRadius: "1em" }}>
                                                <div>
                                                    <p className="text-muted font-weight-bold py-2">Convert your airtime to cash</p>
                                                ...
                                                <div>
                                                    <sup className="text-muted " style={{ fontSize: "10px" }}>SENDER’S PHONE NUMBER</sup>
                                                    <div className="form-group">
                                                        <input type="text" className="form-control form-control-lg" placeholder="Eg. 08080808089" />
                                                    </div>
                                                </div>
                                                <div>
                                                    <sup className="text-muted " style={{ fontSize: "10px" }}>CONFIRM SENDER’S PHONE NUMBER</sup>
                                                    <div className="form-group">
                                                        <input type="text" className="form-control form-control-lg" placeholder="Eg. 08080808089" />
                                                    </div>
                                                </div>
                                                <div className="row">
                                                    <div className="col-6">
                                                        <sup className="text-muted " style={{ fontSize: "10px" }}>AMOUNT</sup>
                                                        <div className="form-group">
                                                            <input type="text" className="form-control form-control-lg" placeholder="" />
                                                        </div>
                                                    </div>
                                                    <div className="col-6">
                                                        <sup className="text-muted " style={{ fontSize: "10px" }}>RATE(%)</sup>
                                                        <div className="form-group">
