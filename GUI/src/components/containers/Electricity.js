                                    ...
                                    <div className="row">
                                        <div className="col-md-6 pb-4">
                                            <div className="border px-2" style={{ borderRadius: "1em" }}>
                                                <div>
                                                    <p className="text-muted font-weight-bold py-2">Pay Electricity Bill</p>
                                                ...
                                                <div>
                                                    <sup className="text-muted " style={{ fontSize: "10px" }}>SELECT METER TYPE</sup>
                                                    <div className="form-group">
                                                        <div className="border px-3 rounded-lg">
                                                            <div className="mt-4 mb-0">
                                                                <label htmlFor="air_select">
                                                                    ...
                                                                    &ensp;
                                                                    <span className="font-weight-bold">Select Meter Type</span>
                                                                </label>
                                                            </div>
                                                            <select
                                                                id="air_select"
                                                ...
                                                <div>
                                                    <sup className="text-muted " style={{ fontSize: "10px" }}>SELECT PROVIDER</sup>
                                                    <div className="form-group">
                                                        <div className="border px-3 rounded-lg">
                                                            <div className="mt-4 mb-0">
                                                                <label htmlFor="air_select">
                                                                    {/* <img src="static/img/dstv.jpg" alt="" className="img-fluid" /> */}
                                                                    &ensp;
                                                                    <span className="font-weight-bold">Select Provider</span>
                                                                </label>
                                                            </div>
                                                            <select
                                                                id="air_select"
                                                ...
                                                <div>
                                                    <sup className="text-muted " style={{ fontSize: "10px" }}>INPUT METER NUMBER</sup>
                                                    <div className="form-group">
                                                ...
                                                <div className="pt-3">
                                                    <sup className="text-muted " style={{ fontSize: "10px" }}>ENTER AMOUNT</sup>
                                                    <div>
                                                        <div className="form-group">
                                                            <input type="text" className="form-control form-control-lg" />
                                                        </div>
                                        ...
                                        <div className="col-md-6 text-center mx-auto border airtime_sec_2" style={{ height: "42.5em" }}>
                                            ...
                                            <div className="card-header rounded-lg">
                                                <div className="p-3 row">
                                                    ...
                                                    <div className="col-6">
                                                        <span className="float-right font-weight-bold">Electricity</span>
                                                    </div>
                                                </div>
