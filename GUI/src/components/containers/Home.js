                                ...
                                <div className="col-md-4">
                                    ...
                                    <form>
                                        <div class="input-group mb-3">
                                            <div className="">
                                                <input type="email" class="form-control rounded-pill" placeholder="Recipient's username" />
                                            </div>
                                            <div class="input-group-append" style={{ zIndex: 99 }}>
                                                <span class="input-group-text rounded-pill" id="basic-addon2">Subscribe <i className="la la-angle-right"></i></span>
                                            </div>
                                        </div>
                                    </form>
                                </div>
