(function () {
  function oa(k, m) { k.prototype = cb(m.prototype); k.prototype.constructor = k; k.base = m.prototype } function cb(k) { function m() { } m.prototype = k; return new m } function Va(k, m, v) {
    "millisecond" === v ? k.setMilliseconds(k.getMilliseconds() + 1 * m) : "second" === v ? k.setSeconds(k.getSeconds() + 1 * m) : "minute" === v ? k.setMinutes(k.getMinutes() + 1 * m) : "hour" === v ? k.setHours(k.getHours() + 1 * m) : "day" === v ? k.setDate(k.getDate() + 1 * m) : "week" === v ? k.setDate(k.getDate() + 7 * m) : "month" === v ? k.setMonth(k.getMonth() + 1 * m) : "year" === v && k.setFullYear(k.getFullYear() +
      1 * m); return k
  } function aa(k, m) { var v = !1; 0 > k && (v = !0, k *= -1); k = "" + k; for (m = m ? m : 1; k.length < m;)k = "0" + k; return v ? "-" + k : k } function Fa(k) { if (!k) return k; k = k.replace(/^\s\s*/, ""); for (var m = /\s/, v = k.length; m.test(k.charAt(--v));); return k.slice(0, v + 1) } function Ba(k) {
    k.roundRect = function (k, v, r, s, ra, D, w, E) {
      w && (this.fillStyle = w); E && (this.strokeStyle = E); "undefined" === typeof ra && (ra = 5); this.lineWidth = D; this.beginPath(); this.moveTo(k + ra, v); this.lineTo(k + r - ra, v); this.quadraticCurveTo(k + r, v, k + r, v + ra); this.lineTo(k +
        r, v + s - ra); this.quadraticCurveTo(k + r, v + s, k + r - ra, v + s); this.lineTo(k + ra, v + s); this.quadraticCurveTo(k, v + s, k, v + s - ra); this.lineTo(k, v + ra); this.quadraticCurveTo(k, v, k + ra, v); this.closePath(); w && this.fill(); E && 0 < D && this.stroke()
    }
  } function Pa(k, m) { return k - m } function S(k) { var m = ((k & 16711680) >> 16).toString(16), v = ((k & 65280) >> 8).toString(16); k = ((k & 255) >> 0).toString(16); m = 2 > m.length ? "0" + m : m; v = 2 > v.length ? "0" + v : v; k = 2 > k.length ? "0" + k : k; return "#" + m + v + k } function db(k, m) {
    var v = this.length >>> 0, r = Number(m) || 0, r = 0 > r ? Math.ceil(r) :
      Math.floor(r); for (0 > r && (r += v); r < v; r++)if (r in this && this[r] === k) return r; return -1
  } function r(k) { return null === k || "undefined" === typeof k } function Ca(k) { k.indexOf || (k.indexOf = db); return k } function eb(k) { if (I.fSDec) k[Z("`eeDwdouMhrudods")](Z("e`u`@ohl`uhnoHuds`uhnoDoe"), function () { I._fTWm && I._fTWm(k) }) } function Wa(k, m, v) {
    v = v || "normal"; var r = k + "_" + m + "_" + v, s = Xa[r]; if (isNaN(s)) {
      try {
        ...
        k + "; font-size:" + m + "px; font-weight:" + v + ";"; if (!wa) { var ra = document.body; wa = document.createElement("span"); wa.innerHTML = ""; var D = document.createTextNode("Mpgyi"); wa.appendChild(D); ra.appendChild(wa) } wa.style.display = ""; wa.setAttribute("style", k); s = Math.round(wa.offsetHeight); wa.style.display = "none"
      } catch (w) { s = Math.ceil(1.1 * m) } s = Math.max(s, m); Xa[r] = s
    } return s
  } function Q(k, m) {
    var v = []; if (v = {
    ...
    }[k || "solid"]) for (var r = 0; r < v.length; r++)v[r] *= m; else v = []; return v
  } function W(k, m, v, s, w) {
    s = s || []; w = r(w) ? fb ? { passive: !1, capture: !1 } : !1 : w; s.push([k, m, v, w]); return k.addEventListener ? (k.addEventListener(m, v, w), v) : k.attachEvent ? (s = function (m) { m = m || window.event; m.preventDefault = m.preventDefault || function () { m.returnValue = !1 }; m.stopPropagation = m.stopPropagation || function () { m.cancelBubble = !0 }; v.call(k, m) }, k.attachEvent("on" +
      m, s), s) : !1
  } function gb(k) {
    if (k._menuButton) k.exportEnabled ? Ka(k._menuButton) : ua(k._menuButton); else if (k.exportEnabled && s) {
      var m = !1; k._menuButton = document.createElement("button"); va(k, k._menuButton, "menu"); k._toolBar.appendChild(k._menuButton); W(k._menuButton, "touchstart", function (k) { m = !0 }, k.allDOMEventHandlers); W(k._menuButton, "click", function () {
      ...
      m = !1; k._dropdownMenu = document.createElement("div"); k._dropdownMenu.setAttribute("tabindex", -1); var v = -1 !== k.theme.indexOf("dark") ? "black" : "#888888"; k._dropdownMenu.style.cssText = "position: absolute; z-index: 1; -webkit-user-select: none; -moz-user-select: none; -ms-user-select: none; user-select: none; cursor: pointer;right: 0px;top: 25px;min-width: 120px;outline: 0;font-size: 14px; font-family: Arial, Helvetica, sans-serif;padding: 5px 0px 5px 0px;text-align: left;line-height: 10px;background-color:" +
        k.toolbar.backgroundColor + ";box-shadow: 2px 2px 10px " + v; k._dropdownMenu.style.display = "none"; k._toolBar.appendChild(k._dropdownMenu); W(k._dropdownMenu, "blur", function () { ua(k._dropdownMenu); k._dropDownCloseTime = new Date }, k.allDOMEventHandlers, !0); v = document.createElement("div"); v.style.cssText = "padding: 12px 8px 12px 8px"; v.innerHTML = k._cultureInfo.printText; v.style.backgroundColor = k.toolbar.backgroundColor; v.style.color = k.toolbar.fontColor; k._dropdownMenu.appendChild(v); W(v, "touchstart", function (k) {
          ...
          k._cultureInfo.saveJPGText; v.style.backgroundColor = k.toolbar.backgroundColor; v.style.color = k.toolbar.fontColor; k._dropdownMenu.appendChild(v); W(v, "touchstart", function (k) { m = !0 }, k.allDOMEventHandlers); W(v, "mouseover", function () { m || (this.style.backgroundColor = k.toolbar.backgroundColorOnHover, this.style.color = k.toolbar.fontColorOnHover) }, k.allDOMEventHandlers, !0); W(v, "mouseout", function () { m || (this.style.backgroundColor = k.toolbar.backgroundColor, this.style.color = k.toolbar.fontColor) }, k.allDOMEventHandlers,
            !0); W(v, "click", function () { k.exportChart({ format: "jpeg", fileName: k.exportFileName }); ua(k._dropdownMenu) }, k.allDOMEventHandlers, !0); v = document.createElement("div"); v.style.cssText = "padding: 12px 8px 12px 8px"; v.innerHTML = k._cultureInfo.savePNGText; v.style.backgroundColor = k.toolbar.backgroundColor; v.style.color = k.toolbar.fontColor; k._dropdownMenu.appendChild(v); W(v, "touchstart", function (k) { m = !0 }, k.allDOMEventHandlers); W(v, "mouseover", function () {
              m || (this.style.backgroundColor = k.toolbar.backgroundColorOnHover,
                this.style.color = k.toolbar.fontColorOnHover)
            }, k.allDOMEventHandlers, !0); W(v, "mouseout", function () { m || (this.style.backgroundColor = k.toolbar.backgroundColor, this.style.color = k.toolbar.fontColor) }, k.allDOMEventHandlers, !0); W(v, "click", function () { k.exportChart({ format: "png", fileName: k.exportFileName }); ua(k._dropdownMenu) }, k.allDOMEventHandlers, !0)
    }
  } function Ya(k, m, v) {
    k *= ja; m *= ja; k = v.getImageData(k, m, 2, 2).data; m = !0; for (v = 0; 4 > v; v++)if (k[v] !== k[v + 4] | k[v] !== k[v + 8] | k[v] !== k[v + 12]) { m = !1; break } return m ? k[0] <<
      16 | k[1] << 8 | k[2] : 0
  } function ma(k, m, v) { return k in m ? m[k] : v[k] } function La(k, m, v) { if (s && Za) { var r = k.getContext("2d"); Ma = r.webkitBackingStorePixelRatio || r.mozBackingStorePixelRatio || r.msBackingStorePixelRatio || r.oBackingStorePixelRatio || r.backingStorePixelRatio || 1; ja = Qa / Ma; k.width = m * ja; k.height = v * ja; Qa !== Ma && (k.style.width = m + "px", k.style.height = v + "px", r.scale(ja, ja)) } else k.width = m, k.height = v } function hb(k) {
    if (!ib) {
      var m = !1, v = !1; "undefined" === typeof qa.Chart.creditHref ? (k.creditHref = Z("iuuqr;..b`ow`rkr/bnl."),
        k.creditText = Z("B`ow`rKR/bnl")) : (m = k.updateOption("creditText"), v = k.updateOption("creditHref")); if (k.creditHref && k.creditText) {
          k._creditLink || (k._creditLink = document.createElement("a"), k._creditLink.setAttribute("class", "canvasjs-chart-credit"), k._creditLink.setAttribute("title", "JavaScript Charts"), k._creditLink.setAttribute("style", "outline:none;margin:0px;position:absolute;right:2px;top:" + (k.height - 14) + "px;color:dimgrey;text-decoration:none;font-size:11px;font-family: Calibri, Lucida Grande, Lucida Sans Unicode, Arial, sans-serif"),
            k._creditLink.setAttribute("tabIndex", -1), k._creditLink.setAttribute("target", "_blank")); if (0 === k.renderCount || m || v) k._creditLink.setAttribute("href", k.creditHref), k._creditLink.innerHTML = k.creditText; k._creditLink && k.creditHref && k.creditText ? (k._creditLink.parentElement || k._canvasJSContainer.appendChild(k._creditLink), k._creditLink.style.top = k.height - 14 + "px") : k._creditLink.parentElement && k._canvasJSContainer.removeChild(k._creditLink)
        }
    }
  } function ta(k, m) {
    Ga && (this.canvasCount |= 0, window.console.log(++this.canvasCount));
    var v = document.createElement("canvas"); v.setAttribute("class", "canvasjs-chart-canvas"); La(v, k, m); s || "undefined" === typeof G_vmlCanvasManager || G_vmlCanvasManager.initElement(v); return v
  } function pa(k, m) { for (var v in m) k.style[v] = m[v] } function va(k, m, v) {
    m.getAttribute("state") || (m.style.backgroundColor = k.toolbar.backgroundColor, m.style.color = k.toolbar.fontColor, m.style.border = "none", pa(m, { WebkitUserSelect: "none", MozUserSelect: "none", msUserSelect: "none", userSelect: "none" })); m.getAttribute("state") !==
  ...
  } function Ka() { for (var k = null, m = 0; m < arguments.length; m++)k = arguments[m], k.style && (k.style.display = "inline") } function ua() {
    for (var k =
      null, m = 0; m < arguments.length; m++)(k = arguments[m]) && k.style && (k.style.display = "none")
  } function Ra(k, m, v, r, s) { if (null === k || "undefined" === typeof k) return "undefined" === typeof v ? m : v; k = parseFloat(k.toString()) * (0 <= k.toString().indexOf("%") ? m / 100 : 1); "undefined" !== typeof r && (k = Math.min(r, k), "undefined" !== typeof s && (k = Math.max(s, k))); return !isNaN(k) && k <= m && 0 <= k ? k : "undefined" === typeof v ? m : v } function X(k, m, v, s, w) {
    this._defaultsKey = k; this._themeOptionsKey = m; this._index = s; this.parent = w; this._eventListeners = [];
    ...
    "undefined" ===
    typeof s && (s = 0); this._padding = s; this._x1 = k; this._y1 = m; this._x2 = v; this._y2 = r; this._rightOccupied = this._leftOccupied = this._bottomOccupied = this._topOccupied = this._padding
  } function la(k, m) { la.base.constructor.call(this, "TextBlock", null, m, null, null); this.ctx = k; this._isDirty = !0; this._wrappedText = null; this._initialize() } function Sa(k, m) { Sa.base.constructor.call(this, "Toolbar", "toolbar", m, null, k); this.chart = k; this.canvas = k.canvas; this.ctx = this.chart.ctx; this.optionsName = "toolbar" } function ya(k, m) {
  ...
  } function Ha(k, m, v) { Ha.base.constructor.call(this, "Subtitle", "subtitles", m, v, k); this.chart = k; this.canvas = k.canvas; this.ctx = this.chart.ctx; this.optionsName = "subtitles"; this.isOptionsInArray = !0; "undefined" === typeof this.options.fontSize && (this.fontSize = this.chart.getAutoFontSize(this.fontSize)); this.height = this.width = null; this.bounds = { x1: null, y1: null, x2: null, y2: null } } function Ta() {
    this.pool =
    []
  } function Ia(k) { var m; k && Ja[k] && (m = Ja[k]); Ia.base.constructor.call(this, "CultureInfo", null, m, null, null) } var Ga = !1, I = {}, s = !!document.createElement("canvas").getContext, qa = {
    Chart: {
      ...
      reversed: !1, backgroundColor: s ? "transparent" : null, borderColor: s ? "transparent" : null, borderThickness: 0, cornerRadius: 0, maxWidth: null, maxHeight: null, markerMargin: null, itemMaxWidth: null, itemWidth: null, itemWrap: !0, itemTextFormatter: null, publicProperties: { options: "readWrite", bounds: "readOnly", chart: "readOnly" }
    }, ToolTip: {
      enabled: !0, shared: !1, animationEnabled: !0, content: null, contentFormatter: null, reversed: !1, backgroundColor: s ? "rgba(255,255,255,.9)" : "rgb(255,255,255)", borderColor: null, borderThickness: 2, cornerRadius: 5,
  ...
  ka = ea = "#000000"; var V = 20, E = 14, Ua = {
    colorSet: "colorSet1", backgroundColor: "#FFFFFF", title: { fontFamily: Ea, fontSize: 32, fontColor: ba, fontWeight: "normal", verticalAlign: "top", margin: 5 }, subtitles: [{ fontFamily: Ea, fontSize: E, fontColor: ba, fontWeight: "normal", verticalAlign: "top", margin: 5 }], data: [{ indexLabelFontFamily: w, indexLabelFontSize: E, indexLabelFontColor: ba, indexLabelFontWeight: "normal", indexLabelLineThickness: 1 }], axisX: [{
      titleFontFamily: w, titleFontSize: V, titleFontColor: ba, titleFontWeight: "normal", labelFontFamily: w,
      labelFontSize: E, labelFontColor: U, labelFontWeight: "normal", lineThickness: 1, lineColor: G, tickThickness: 1, tickColor: G, gridThickness: 0, gridColor: G, stripLines: [{ labelFontFamily: w, labelFontSize: E, labelFontColor: "#FF7300", labelFontWeight: "normal", labelBackgroundColor: null, color: "#FF7300", thickness: 1 }], crosshair: { labelFontFamily: w, labelFontSize: E, labelFontColor: "#EEEEEE", labelFontWeight: "normal", labelBackgroundColor: ka, color: ea, thickness: 1, lineDashType: "dash" }, scaleBreaks: {
        type: "zigzag", spacing: "2%", lineColor: "#BBBBBB",
        lineThickness: 1, lineDashType: "solid"
      }
    }], axisX2: [{
      titleFontFamily: w, titleFontSize: V, titleFontColor: ba, titleFontWeight: "normal", labelFontFamily: w, labelFontSize: E, labelFontColor: U, labelFontWeight: "normal", lineThickness: 1, lineColor: G, tickThickness: 1, tickColor: G, gridThickness: 0, gridColor: G, stripLines: [{ labelFontFamily: w, labelFontSize: E, labelFontColor: "#FF7300", labelFontWeight: "normal", labelBackgroundColor: null, color: "#FF7300", thickness: 1 }], crosshair: {
      ...
      titleFontFamily: w, titleFontSize: V, titleFontColor: ba, titleFontWeight: "normal", labelFontFamily: w, labelFontSize: E, labelFontColor: U, labelFontWeight: "normal", lineThickness: 1, lineColor: G, tickThickness: 1, tickColor: G, gridThickness: 1, gridColor: G, stripLines: [{
      ...
      }], crosshair: { labelFontFamily: w, labelFontSize: E, labelFontColor: "#EEEEEE", labelFontWeight: "normal", labelBackgroundColor: ka, color: ea, thickness: 1, lineDashType: "dash" }, scaleBreaks: { type: "zigzag", spacing: "2%", lineColor: "#BBBBBB", lineThickness: 1, lineDashType: "solid" }
    }], axisY2: [{
      titleFontFamily: w, titleFontSize: V, titleFontColor: ba, titleFontWeight: "normal", labelFontFamily: w, labelFontSize: E, labelFontColor: U, labelFontWeight: "normal",
      lineThickness: 1, lineColor: G, tickThickness: 1, tickColor: G, gridThickness: 1, gridColor: G, stripLines: [{ labelFontFamily: w, labelFontSize: E, labelFontColor: "#FF7300", labelFontWeight: "normal", labelBackgroundColor: null, color: "#FF7300", thickness: 1 }], crosshair: { labelFontFamily: w, labelFontSize: E, labelFontColor: "#EEEEEE", labelFontWeight: "normal", labelBackgroundColor: ka, color: ea, thickness: 1, lineDashType: "dash" }, scaleBreaks: { type: "zigzag", spacing: "2%", lineColor: "#BBBBBB", lineThickness: 1, lineDashType: "solid" }
    }], legend: {
      fontFamily: w,
  ...
  }; U = ba = "#F5F5F5"; G = "#FFFFFF"; ea = "#40BAF1"; ka = "#F5F5F5"; var V = 20, E = 14, $a = {
    colorSet: "colorSet2", title: { fontFamily: w, fontSize: 33, fontColor: "#3A3A3A", fontWeight: "bold", verticalAlign: "top", margin: 5 }, subtitles: [{ fontFamily: w, fontSize: E, fontColor: "#3A3A3A", fontWeight: "normal", verticalAlign: "top", margin: 5 }], data: [{
      ...
      titleFontFamily: w, titleFontSize: V, titleFontColor: "#666666", titleFontWeight: "normal", labelFontFamily: w, labelFontSize: E, labelFontColor: "#666666", labelFontWeight: "normal", lineThickness: 1, lineColor: "#BBBBBB", tickThickness: 1, tickColor: "#BBBBBB", gridThickness: 1, gridColor: "#BBBBBB", stripLines: [{
        labelFontFamily: w, labelFontSize: E, labelFontColor: "#FFA500", labelFontWeight: "normal", labelBackgroundColor: null,
        color: "#FFA500", thickness: 1
      }], crosshair: { labelFontFamily: w, labelFontSize: E, labelFontColor: "#EEEEEE", labelFontWeight: "normal", labelBackgroundColor: "black", color: "black", thickness: 1, lineDashType: "dot" }, scaleBreaks: { type: "zigzag", spacing: "2%", lineColor: "#BBBBBB", lineThickness: 1, lineDashType: "solid" }
    }], axisX2: [{
      titleFontFamily: w, titleFontSize: V, titleFontColor: "#666666", titleFontWeight: "normal", labelFontFamily: w, labelFontSize: E, labelFontColor: "#666666", labelFontWeight: "normal", lineThickness: 1, lineColor: "#BBBBBB",
      tickColor: "#BBBBBB", tickThickness: 1, gridThickness: 1, gridColor: "#BBBBBB", stripLines: [{ labelFontFamily: w, labelFontSize: E, labelFontColor: "#FFA500", labelFontWeight: "normal", labelBackgroundColor: null, color: "#FFA500", thickness: 1 }], crosshair: { labelFontFamily: w, labelFontSize: E, labelFontColor: "#EEEEEE", labelFontWeight: "normal", labelBackgroundColor: "black", color: "black", thickness: 1, lineDashType: "dot" }, scaleBreaks: { type: "zigzag", spacing: "2%", lineColor: "#BBBBBB", lineThickness: 1, lineDashType: "solid" }
    }], axisY: [{
      titleFontFamily: w,
      ...
      titleFontFamily: w, titleFontSize: V, titleFontColor: "#666666", titleFontWeight: "normal", labelFontFamily: w, labelFontSize: E, labelFontColor: "#666666", labelFontWeight: "normal", lineThickness: 0, lineColor: "#BBBBBB", tickColor: "#BBBBBB", tickThickness: 1, gridThickness: 1, gridColor: "#BBBBBB", stripLines: [{
        labelFontFamily: w, labelFontSize: E,
        labelFontColor: "#FFA500", labelFontWeight: "normal", labelBackgroundColor: null, color: "#FFA500", thickness: 1
      }], crosshair: { labelFontFamily: w, labelFontSize: E, labelFontColor: "#EEEEEE", labelFontWeight: "normal", labelBackgroundColor: "black", color: "black", thickness: 1, lineDashType: "dot" }, scaleBreaks: { type: "zigzag", spacing: "2%", lineColor: "#BBBBBB", lineThickness: 1, lineDashType: "solid" }
    }], legend: { fontFamily: w, fontSize: 14, fontColor: "#3A3A3A", fontWeight: "bold", verticalAlign: "bottom", horizontalAlign: "center" }, toolTip: {
      fontFamily: w,
      fontSize: 14, fontStyle: "normal", cornerRadius: 0, borderThickness: 1
    }
  }; U = ba = "#F5F5F5"; G = "#FFFFFF"; ea = "#40BAF1"; ka = "#F5F5F5"; V = 20; E = 14; Ea = {
    colorSet: "colorSet12", backgroundColor: "#2A2A2A", title: { fontFamily: Ea, fontSize: 32, fontColor: ba, fontWeight: "normal", verticalAlign: "top", margin: 5 }, subtitles: [{ fontFamily: Ea, fontSize: E, fontColor: ba, fontWeight: "normal", verticalAlign: "top", margin: 5 }], toolbar: {
    ...
    }, data: [{ indexLabelFontFamily: w, indexLabelFontSize: E, indexLabelFontColor: U, indexLabelFontWeight: "normal", indexLabelLineThickness: 1 }], axisX: [{
      titleFontFamily: w, titleFontSize: V, titleFontColor: U, titleFontWeight: "normal", labelFontFamily: w, labelFontSize: E, labelFontColor: U, labelFontWeight: "normal", lineThickness: 1, lineColor: G, tickThickness: 1, tickColor: G, gridThickness: 0, gridColor: G, stripLines: [{
        labelFontFamily: w, labelFontSize: E, labelFontColor: "#FF7300", labelFontWeight: "normal", labelBackgroundColor: null,
        color: "#FF7300", thickness: 1
      }], crosshair: { labelFontFamily: w, labelFontSize: E, labelFontColor: "#000000", labelFontWeight: "normal", labelBackgroundColor: ka, color: ea, thickness: 1, lineDashType: "dash" }, scaleBreaks: { type: "zigzag", spacing: "2%", lineColor: "#777777", lineThickness: 1, lineDashType: "solid", color: "#111111" }
    }], axisX2: [{
      titleFontFamily: w, titleFontSize: V, titleFontColor: U, titleFontWeight: "normal", labelFontFamily: w, labelFontSize: E, labelFontColor: U, labelFontWeight: "normal", lineThickness: 1, lineColor: G, tickThickness: 1,
      ...
      titleFontFamily: w, titleFontSize: V,
      ...
      titleFontFamily: w, titleFontSize: V, titleFontColor: U, titleFontWeight: "normal", labelFontFamily: w, labelFontSize: E, labelFontColor: U, labelFontWeight: "normal", lineThickness: 1, lineColor: G, tickThickness: 1, tickColor: G, gridThickness: 1, gridColor: G, stripLines: [{ labelFontFamily: w, labelFontSize: E, labelFontColor: "#FF7300", labelFontWeight: "normal", labelBackgroundColor: null, color: "#FF7300", thickness: 1 }],
      crosshair: { labelFontFamily: w, labelFontSize: E, labelFontColor: "#000000", labelFontWeight: "normal", labelBackgroundColor: ka, color: ea, thickness: 1, lineDashType: "dash" }, scaleBreaks: { type: "zigzag", spacing: "2%", lineColor: "#777777", lineThickness: 1, lineDashType: "solid", color: "#111111" }
    }], legend: { fontFamily: w, fontSize: 14, fontColor: ba, fontWeight: "bold", verticalAlign: "bottom", horizontalAlign: "center" }, toolTip: { fontFamily: w, fontSize: 14, fontStyle: "normal", cornerRadius: 0, borderThickness: 1, fontColor: U, backgroundColor: "rgba(0, 0, 0, .7)" }
  };
  G = "#FFFFFF"; U = ba = "#FAFAFA"; ea = "#40BAF1"; ka = "#F5F5F5"; var V = 20, E = 14, ab = {
    light1: Ua, light2: $a, dark1: Ea, dark2: {
      ...
      data: [{ indexLabelFontFamily: w, indexLabelFontSize: E, indexLabelFontColor: U, indexLabelFontWeight: "normal", indexLabelLineThickness: 1 }], axisX: [{
        titleFontFamily: w, titleFontSize: V, titleFontColor: U, titleFontWeight: "normal", labelFontFamily: w, labelFontSize: E, labelFontColor: U, labelFontWeight: "normal", lineThickness: 1, lineColor: G, tickThickness: 1, tickColor: G, gridThickness: 0, gridColor: G, stripLines: [{
          labelFontFamily: w, labelFontSize: E, labelFontColor: "#FF7300", labelFontWeight: "normal", labelBackgroundColor: null, color: "#FF7300",
          thickness: 1
        }], crosshair: { labelFontFamily: w, labelFontSize: E, labelFontColor: "#000000", labelFontWeight: "normal", labelBackgroundColor: ka, color: ea, thickness: 1, lineDashType: "dash" }, scaleBreaks: { type: "zigzag", spacing: "2%", lineColor: "#777777", lineThickness: 1, lineDashType: "solid", color: "#111111" }
      }], axisX2: [{
        titleFontFamily: w, titleFontSize: V, titleFontColor: U, titleFontWeight: "normal", labelFontFamily: w, labelFontSize: E, labelFontColor: U, labelFontWeight: "normal", lineThickness: 1, lineColor: G, tickThickness: 1, tickColor: G,
        ...
        titleFontFamily: w, titleFontSize: V, titleFontColor: U, titleFontWeight: "normal", labelFontFamily: w, labelFontSize: E, labelFontColor: U, labelFontWeight: "normal", lineThickness: 0, lineColor: G, tickThickness: 1, tickColor: G, gridThickness: 1, gridColor: G, stripLines: [{ labelFontFamily: w, labelFontSize: E, labelFontColor: "#FF7300", labelFontWeight: "normal", labelBackgroundColor: null, color: "#FF7300", thickness: 1 }], crosshair: {
          labelFontFamily: w,
          labelFontSize: E, labelFontColor: "#000000", labelFontWeight: "normal", labelBackgroundColor: ka, color: ea, thickness: 1, lineDashType: "dash"
        }, scaleBreaks: { type: "zigzag", spacing: "2%", lineColor: "#777777", lineThickness: 1, lineDashType: "solid", color: "#111111" }
      }], legend: { fontFamily: w, fontSize: 14, fontColor: ba, fontWeight: "bold", verticalAlign: "bottom", horizontalAlign: "center" }, toolTip: { fontFamily: w, fontSize: 14, fontStyle: "normal", cornerRadius: 0, borderThickness: 1, fontColor: U, backgroundColor: "rgba(0, 0, 0, .7)" }
    }, theme1: Ua,
    theme2: $a, theme3: Ua
  }, T = { numberDuration: 1, yearDuration: 314496E5, monthDuration: 2592E6, weekDuration: 6048E5, dayDuration: 864E5, hourDuration: 36E5, minuteDuration: 6E4, secondDuration: 1E3, millisecondDuration: 1, dayOfWeekFromInt: "Sunday Monday Tuesday Wednesday Thursday Friday Saturday".split(" ") }; (function () {
    I.fSDec = function (k) { for (var m = "", v = 0; v < k.length; v++)m += String.fromCharCode(Math.ceil(k.length / 57 / 5) ^ k.charCodeAt(v)); return m }; I.obj = {
  ...
  var fb = function () { var k = !1; try { var m = Object.defineProperty && Object.defineProperty({}, "passive", { get: function () { k = !0; return !1 } }); window.addEventListener && (window.addEventListener("test", null, m), window.removeEventListener("test", null, m)) } catch (v) { k = !1 } return k }(), Xa = {}, wa = null, kb = function () { this.ctx.clearRect(0, 0, this.width, this.height); this.backgroundColor && (this.ctx.fillStyle = this.backgroundColor, this.ctx.fillRect(0, 0, this.width, this.height)) }, lb = function (k, m, v) {
    ...
    var k = /D{1,4}|M{1,4}|Y{1,4}|h{1,2}|H{1,2}|m{1,2}|s{1,2}|f{1,3}|t{1,2}|T{1,2}|K|z{1,3}|"[^"]*"|'[^']*'/g, m = "Sunday Monday Tuesday Wednesday Thursday Friday Saturday".split(" "), v = "Sun Mon Tue Wed Thu Fri Sat".split(" "), r = "January February March April May June July August September October November December".split(" "), s = "Jan Feb Mar Apr May Jun Jul Aug Sep Oct Nov Dec".split(" "), w = /\b(?:[PMCEA][SDP]T|(?:Pacific|Mountain|Central|Eastern|Atlantic) (?:Standard|Daylight|Prevailing) Time|(?:GMT|UTC)(?:[-+]\d{4})?)\b/g,
    D = /[^-+\dA-Z]/g; return function (E, Q, N) {
      var G = N ? N.days : m, S = N ? N.months : r, W = N ? N.shortDays : v, T = N ? N.shortMonths : s; N = ""; var I = !1; E = E && E.getTime ? E : E ? new Date(E) : new Date; if (isNaN(E)) throw SyntaxError("invalid date"); "UTC:" === Q.slice(0, 4) && (Q = Q.slice(4), I = !0); N = I ? "getUTC" : "get"; var X = E[N + "Date"](), L = E[N + "Day"](), Y = E[N + "Month"](), a = E[N + "FullYear"](), d = E[N + "Hours"](), c = E[N + "Minutes"](), b = E[N + "Seconds"](), e = E[N + "Milliseconds"](), f = I ? 0 : E.getTimezoneOffset(); return N = Q.replace(k, function (l) {
        switch (l) {
          case "D": return X;
          case "DD": return aa(X, 2); case "DDD": return W[L]; case "DDDD": return G[L]; case "M": return Y + 1; case "MM": return aa(Y + 1, 2); case "MMM": return T[Y]; case "MMMM": return S[Y]; case "Y": return parseInt(String(a).slice(-2)); case "YY": return aa(String(a).slice(-2), 2); case "YYY": return aa(String(a).slice(-3), 3); case "YYYY": return aa(a, 4); case "h": return d % 12 || 12; case "hh": return aa(d % 12 || 12, 2); case "H": return d; case "HH": return aa(d, 2); case "m": return c; case "mm": return aa(c, 2); case "s": return b; case "ss": return aa(b,
            2); case "f": return String(e).slice(0, 1); case "ff": return aa(String(e).slice(0, 2), 2); case "fff": return aa(String(e).slice(0, 3), 3); case "t": return 12 > d ? "a" : "p"; case "tt": return 12 > d ? "am" : "pm"; case "T": return 12 > d ? "A" : "P"; case "TT": return 12 > d ? "AM" : "PM"; case "K": return I ? "UTC" : (String(E).match(w) || [""]).pop().replace(D, ""); case "z": return (0 < f ? "-" : "+") + Math.floor(Math.abs(f) / 60); case "zz": return (0 < f ? "-" : "+") + aa(Math.floor(Math.abs(f) / 60), 2); case "zzz": return (0 < f ? "-" : "+") + aa(Math.floor(Math.abs(f) / 60),
              2) + aa(Math.abs(f) % 60, 2); default: return l.slice(1, l.length - 1)
        }
      })
    }
  }(), fa = function (k, m, v) {
    if (null === k) return ""; if (!isFinite(k)) return k; k = Number(k); var r = 0 > k ? !0 : !1; r && (k *= -1); var s = v ? v.decimalSeparator : ".", w = v ? v.digitGroupSeparator : ",", D = ""; m = String(m); var D = 1, E = v = "", Q = -1, N = [], G = [], S = 0, I = 0, W = 0, T = !1, X = 0, E = m.match(/"[^"]*"|'[^']*'|[eE][+-]*[0]+|[,]+[.]|\u2030|./g); m = null; for (var L = 0; E && L < E.length; L++)if (m = E[L], "." === m && 0 > Q) Q = L; else {
      if ("%" === m) D *= 100; else if ("\u2030" === m) { D *= 1E3; continue } else if ("," ===
        m[0] && "." === m[m.length - 1]) { D /= Math.pow(1E3, m.length - 1); Q = L + m.length - 1; continue } else "E" !== m[0] && "e" !== m[0] || "0" !== m[m.length - 1] || (T = !0); 0 > Q ? (N.push(m), "#" === m || "0" === m ? S++ : "," === m && W++) : (G.push(m), "#" !== m && "0" !== m || I++)
    } T && (m = Math.floor(k), E = -Math.floor(Math.log(k) / Math.LN10 + 1), X = 0 === k ? 0 : 0 === m ? -(S + E) : String(m).length - S, D /= Math.pow(10, X)); 0 > Q && (Q = L); D = (k * D).toFixed(I); m = D.split("."); D = (m[0] + "").split(""); k = (m[1] + "").split(""); D && "0" === D[0] && D.shift(); for (T = E = L = I = Q = 0; 0 < N.length;)if (m = N.pop(), "#" === m ||
      "0" === m) if (Q++, Q === S) { var Y = D, D = []; if ("0" === m) for (m = S - I - (Y ? Y.length : 0); 0 < m;)Y.unshift("0"), m--; for (; 0 < Y.length;)v = Y.pop() + v, T++, 0 === T % E && (L === W && 0 < Y.length) && (v = w + v) } else 0 < D.length ? (v = D.pop() + v, I++, T++) : "0" === m && (v = "0" + v, I++, T++), 0 === T % E && (L === W && 0 < D.length) && (v = w + v); else "E" !== m[0] && "e" !== m[0] || "0" !== m[m.length - 1] || !/[eE][+-]*[0]+/.test(m) ? "," === m ? (L++, E = T, T = 0, 0 < D.length && (v = w + v)) : v = 1 < m.length && ('"' === m[0] && '"' === m[m.length - 1] || "'" === m[0] && "'" === m[m.length - 1]) ? m.slice(1, m.length - 1) + v : m + v : (m = 0 > X ?
        m.replace("+", "").replace("-", "") : m.replace("-", ""), v += m.replace(/[0]+/, function (a) { return aa(X, a.length) })); w = ""; for (N = !1; 0 < G.length;)m = G.shift(), "#" === m || "0" === m ? 0 < k.length && 0 !== Number(k.join("")) ? (w += k.shift(), N = !0) : "0" === m && (w += "0", N = !0) : 1 < m.length && ('"' === m[0] && '"' === m[m.length - 1] || "'" === m[0] && "'" === m[m.length - 1]) ? w += m.slice(1, m.length - 1) : "E" !== m[0] && "e" !== m[0] || "0" !== m[m.length - 1] || !/[eE][+-]*[0]+/.test(m) ? w += m : (m = 0 > X ? m.replace("+", "").replace("-", "") : m.replace("-", ""), w += m.replace(/[0]+/, function (a) {
          return aa(X,
            a.length)
        })); v += (N ? s : "") + w; return r ? "-" + v : v
  }, Na = function (k) { var m = 0, v = 0; k = k || window.event; k.offsetX || 0 === k.offsetX ? (m = k.offsetX, v = k.offsetY) : k.layerX || 0 == k.layerX ? (m = k.layerX, v = k.layerY) : (m = k.pageX - k.target.offsetLeft, v = k.pageY - k.target.offsetTop); return { x: m, y: v } }, Za = !0, Qa = window.devicePixelRatio || 1, Ma = 1, ja = Za ? Qa / Ma : 1, da = function (k, m, v, r, s, w, D, E, Q, N, T, S, G) {
    "undefined" === typeof G && (G = 1); D = D || 0; E = E || "black"; var I = 15 < r - m && 15 < s - v ? 8 : 0.35 * Math.min(r - m, s - v); k.beginPath(); k.moveTo(m, v); k.save(); k.fillStyle =
  ...
  }, Z = function (k) { for (var m = "", r = 0; r < k.length; r++)m += String.fromCharCode(Math.ceil(k.length / 57 / 5) ^ k.charCodeAt(r)); return m }, bb = window && window[Z("mnb`uhno")] && window[Z("mnb`uhno")].href && window[Z("mnb`uhno")].href.indexOf &&
    (-1 !== window[Z("mnb`uhno")].href.indexOf(Z("b`ow`rkr/bnl")) || -1 !== window[Z("mnb`uhno")].href.indexOf(Z("gdonqhy/bnl")) || -1 !== window[Z("mnb`uhno")].href.indexOf(Z("gheemd"))), ib = bb && -1 === window[Z("mnb`uhno")].href.indexOf(Z("gheemd")), jb = {
  ...
  X.prototype.setOptions = function (k, m) { if (qa[this._defaultsKey]) { var r = qa[this._defaultsKey], s; for (s in r) "publicProperties" !== s && r.hasOwnProperty(s) && (this[s] = k && s in k ? k[s] : m && s in m ? m[s] : r[s]) } else Ga && window.console && console.log("defaults not set") }; X.prototype.get = function (k) {
    var m = qa[this._defaultsKey]; if ("options" === k) return this.options && this.options._isPlaceholder ? null : this.options; if (m.hasOwnProperty(k) || m.publicProperties && m.publicProperties.hasOwnProperty(k)) return this[k]; window.console &&
      window.console.log('Property "' + k + "\" doesn't exist. Please check for typo.")
  }; X.prototype.set = function (k, m, r) {
    r = "undefined" === typeof r ? !0 : r; var s = qa[this._defaultsKey]; if ("options" === k) this.createUserOptions(m); else if (s.hasOwnProperty(k) || s.publicProperties && s.publicProperties.hasOwnProperty(k) && "readWrite" === s.publicProperties[k]) this.options._isPlaceholder && this.createUserOptions(), this.options[k] = m; else {
    ...
    s = "undefined" === typeof s ? !0 : s; var w = qa[this._defaultsKey]; w.hasOwnProperty(k) || w.publicProperties && w.publicProperties.hasOwnProperty(k) && "readWrite" === w.publicProperties[k] ? (this.options._isPlaceholder && this.createUserOptions(), "undefined" === typeof this.options[k] && (this.options[k] =
  ...
  }; X.prototype.remove = function (k) { k = "undefined" === typeof k ? !0 : k; if (this.isOptionsInArray) { var m = this.parent.options[this.optionsName]; Ca(m); var r = m.indexOf(this.options); 0 <= r && m.splice(r, 1) } else delete this.parent.options[this.optionsName]; k && (this.stockChart || this.chart || this).render() }; X.prototype.updateOption = function (k) {
    !qa[this._defaultsKey] && (Ga && window.console) && console.log("defaults not set"); var m = qa[this._defaultsKey], s = {}, w = this[k], E = this._themeOptionsKey,
  ...
  }; X.prototype.removeEventListener = function (k, m) { if (k && m && this._eventListeners[k]) for (var r = this._eventListeners[k], s = 0; s < r.length; s++)if (r[s].eventHandler === m) { r[s].splice(s, 1); break } }; X.prototype.removeAllEventListeners = function () { this._eventListeners = [] }; X.prototype.dispatchEvent = function (k, m, r) {
    if (k && this._eventListeners[k]) {
      m = m || {}; for (var s = this._eventListeners[k], w = 0; w < s.length; w++)s[w].eventHandler.call(s[w].context,
        m)
    ...
    function () { return { x1: this._x1 + this._leftOccupied, y1: this._y1 + this._topOccupied, x2: this._x2 - this._rightOccupied, y2: this._y2 - this._bottomOccupied, width: this._x2 - this._x1 - this._rightOccupied - this._leftOccupied, height: this._y2 - this._y1 - this._bottomOccupied - this._topOccupied } }; Da.prototype.reset = function () { this._rightOccupied = this._leftOccupied = this._bottomOccupied = this._topOccupied = this._padding }; oa(la, X); la.prototype._initialize = function () {
      ...
      if (0 !== this.fontSize) {
        k && this.ctx.save(); var m = this.ctx.font; this.ctx.textBaseline = this.textBaseline; var r = 0; this._isDirty &&
          this.measureText(this.ctx); this.ctx.translate(this.x, this.y + r); "middle" === this.textBaseline && (r = -this._lineHeight / 2); this.ctx.font = this._getFontString(); this.ctx.rotate(Math.PI / 180 * this.angle); var s = 0, w = this.topPadding, E = null; this.ctx.roundRect || Ba(this.ctx); (0 < this.borderThickness && this.borderColor || this.backgroundColor) && this.ctx.roundRect(0, r, this.width, this.height, this.cornerRadius, this.borderThickness, this.backgroundColor, this.borderColor); this.ctx.fillStyle = this.fontColor; for (r = 0; r < this._wrappedText.lines.length; r++) {
            E =
            this._wrappedText.lines[r]; if ("right" === this.horizontalAlign || "right" === this.textAlign) s = this.width - E.width - this.rightPadding; else if ("left" === this.horizontalAlign || "left" === this.textAlign) s = this.leftPadding; else if ("center" === this.horizontalAlign || "center" === this.textAlign) s = (this.width - (this.leftPadding + this.rightPadding)) / 2 - E.width / 2 + this.leftPadding; this.ctx.fillText(E.text, s, w); w += E.height
          } this.ctx.font = m; k && this.ctx.restore()
      }
    }; la.prototype.setText = function (k) {
      this.text = k; this._isDirty = !0; this._wrappedText =
        null
    }; la.prototype.measureText = function () { this._lineHeight = Wa(this.fontFamily, this.fontSize, this.fontWeight); if (null === this.maxWidth) throw "Please set maxWidth and height for TextBlock"; this._wrapText(this.ctx); this._isDirty = !1; return { width: this.width, height: this.height } }; la.prototype._getLineWithWidth = function (k, m, r) {
      k = String(k); if (!k) return { text: "", width: 0 }; var s = r = 0, w = k.length - 1, E = Infinity; for (this.ctx.font = this._getFontString(); s <= w;) {
        var E = Math.floor((s + w) / 2), D = k.substr(0, E + 1); r = this.ctx.measureText(D).width;
        if (r < m) s = E + 1; else if (r > m) w = E - 1; else break
      } r > m && 1 < D.length && (D = D.substr(0, D.length - 1), r = this.ctx.measureText(D).width); m = !0; if (D.length === k.length || " " === k[D.length]) m = !1; m && (k = D.split(" "), 1 < k.length && k.pop(), D = k.join(" "), r = this.ctx.measureText(D).width); return { text: D, width: r }
    }; la.prototype._wrapText = function () {
      var k = new String(Fa(String(this.text))), m = [], r = this.ctx.font, s = 0, w = 0; this.ctx.font = this._getFontString(); if (0 === this.frontSize) w = s = 0; else for (; 0 < k.length;) {
      ...
      } this._wrappedText = { lines: m, width: w, height: s }; this.width = w + (this.leftPadding + this.rightPadding); this.height = s + (this.topPadding + this.bottomPadding); this.ctx.font = r
    }; la.prototype._getFontString = function () {
      var k; k = "" + (this.fontStyle ? this.fontStyle + " " :
        ""); k += this.fontWeight ? this.fontWeight + " " : ""; k += this.fontSize ? this.fontSize + "px " : ""; var m = this.fontFamily ? this.fontFamily + "" : ""; !s && m && (m = m.split(",")[0], "'" !== m[0] && '"' !== m[0] && (m = "'" + m + "'")); return k += m
    }; oa(Sa, X); oa(ya, X); ya.prototype.setLayout = function () {
      if (this.text) {
        var k = this.dockInsidePlotArea ? this.chart.plotArea : this.chart, m = k.layoutManager.getFreeSpace(), s = m.x1, w = m.y1, E = 0, I = 0, D = this.chart._menuButton && this.chart.exportEnabled && "top" === this.verticalAlign ? 22 : 0, Q, G; "top" === this.verticalAlign ||
          "bottom" === this.verticalAlign ? (null === this.maxWidth && (this.maxWidth = m.width - 4 - D * ("center" === this.horizontalAlign ? 2 : 1)), I = 0.5 * m.height - this.margin - 2, E = 0) : "center" === this.verticalAlign && ("left" === this.horizontalAlign || "right" === this.horizontalAlign ? (null === this.maxWidth && (this.maxWidth = m.height - 4), I = 0.5 * m.width - this.margin - 2) : "center" === this.horizontalAlign && (null === this.maxWidth && (this.maxWidth = m.width - 4), I = 0.5 * m.height - 4)); var N; r(this.padding) || "number" !== typeof this.padding ? r(this.padding) || "object" !==
            typeof this.padding || (N = this.padding.top ? this.padding.top : this.padding.bottom ? this.padding.bottom : 0, N += this.padding.bottom ? this.padding.bottom : this.padding.top ? this.padding.top : 0) : N = 2 * this.padding; this.wrap || (I = Math.min(I, 1.5 * this.fontSize + N)); I = new la(this.ctx, {
            ...
            }); N = I.measureText(); "top" === this.verticalAlign || "bottom" === this.verticalAlign ? ("top" === this.verticalAlign ? (w = m.y1 + 2, G = "top") : "bottom" === this.verticalAlign && (w = m.y2 - 2 - N.height, G = "bottom"), "left" === this.horizontalAlign ? s = m.x1 + 2 : "center" === this.horizontalAlign ? s = m.x1 + m.width / 2 - N.width / 2 : "right" === this.horizontalAlign && (s = m.x2 - 2 - N.width - D), Q = this.horizontalAlign,
              this.width = N.width, this.height = N.height) : "center" === this.verticalAlign && ("left" === this.horizontalAlign ? (s = m.x1 + 2, w = m.y2 - 2 - (this.maxWidth / 2 - N.width / 2), E = -90, G = "left", this.width = N.height, this.height = N.width) : "right" === this.horizontalAlign ? (s = m.x2 - 2, w = m.y1 + 2 + (this.maxWidth / 2 - N.width / 2), E = 90, G = "right", this.width = N.height, this.height = N.width) : "center" === this.horizontalAlign && (w = k.y1 + (k.height / 2 - N.height / 2), s = k.x1 + (k.width / 2 - N.width / 2), G = "center", this.width = N.width, this.height = N.height), Q = "center"); I.x =
                s; I.y = w; I.angle = E; I.horizontalAlign = Q; this._textBlock = I; k.layoutManager.registerSpace(G, { width: this.width + ("left" === G || "right" === G ? this.margin + 2 : 0), height: this.height + ("top" === G || "bottom" === G ? this.margin + 2 : 0) }); this.bounds = { x1: s, y1: w, x2: s + this.width, y2: w + this.height }; this.ctx.textBaseline = "top"
      }
    }; ya.prototype.render = function () { this._textBlock && this._textBlock.render(!0) }; oa(Ha, X); Ha.prototype.setLayout = ya.prototype.setLayout; Ha.prototype.render = ya.prototype.render; Ta.prototype.get = function (k, m) {
      var s =
        null; 0 < this.pool.length ? (s = this.pool.pop(), La(s, k, m)) : s = ta(k, m); return s
    }; Ta.prototype.release = function (k) { this.pool.push(k) }; oa(Ia, X); var Oa = { addTheme: function (k, m) { ab[k] = m }, addColorSet: function (k, m) { za[k] = m }, addCultureInfo: function (k, m) { Ja[k] = m }, formatNumber: function (k, m, s) { s = s || "en"; if (Ja[s]) return fa(k, m || "#,##0.##", new Ia(s)); throw "Unknown Culture Name"; }, formatDate: function (k, m, s) { s = s || "en"; if (Ja[s]) return Aa(k, m || "DD MMM YYYY", new Ia(s)); throw "Unknown Culture Name"; } }; "undefined" !== typeof module &&
      "undefined" !== typeof module.exports ? module.exports = Oa : "function" === typeof define && define.amd ? define([], function () { return Oa }) : (window.CanvasJS && window.console && window.console.log("CanvasJS namespace already exists. If you are loading both chart and stockchart scripts, just load stockchart alone as it includes all chart features."), window.CanvasJS = window.CanvasJS ? window.CanvasJS : Oa); w = Oa.Chart = function () {
        function k(a, d) { return a.x - d.x } function m(a, d, c) {
          d = d || {}; r(c) ? (this.predefinedThemes = ab, this.optionsName =
            this.parent = this.index = null) : (this.parent = c.parent, this.index = c.index, this.predefinedThemes = c.predefinedThemes, this.optionsName = c.optionsName, this.stockChart = c.stockChart, this.panel = a, this.isOptionsInArray = c.isOptionsInArray); this.theme = r(d.theme) || r(this.predefinedThemes[d.theme]) ? "light1" : d.theme; m.base.constructor.call(this, "Chart", this.optionsName, d, this.index, this.parent); var b = this; this._containerId = a; this._objectsInitialized = !1; this.overlaidCanvasCtx = this.ctx = null; this._indexLabels = []; this._panTimerId =
              0; this._lastTouchEventType = ""; this._lastTouchData = null; this.isAnimating = !1; this.renderCount = 0; this.disableToolTip = this.animatedRender = !1; this.canvasPool = new Ta; this.allDOMEventHandlers = []; this.panEnabled = !1; this._defaultCursor = "default"; this.plotArea = { canvas: null, ctx: null, x1: 0, y1: 0, x2: 0, y2: 0, width: 0, height: 0 }; this._dataInRenderedOrder = []; (this.container = "string" === typeof this._containerId ? document.getElementById(this._containerId) : this._containerId) ? (this.container.innerHTML = "", d = a = 0, a = this.options.width ?
                ...
                (this._canvasJSContainer.appendChild(this.canvas), this.ctx = this.canvas.getContext("2d"), this.ctx.textBaseline = "top", Ba(this.ctx), this._preRenderCtx = this._preRenderCanvas.getContext("2d"), this._preRenderCtx.textBaseline = "top", Ba(this._preRenderCtx), s ? this.plotArea.ctx = this.ctx : (this.plotArea.canvas = ta(a, d), this.plotArea.canvas.style.position = "absolute", this.plotArea.canvas.setAttribute("class", "plotAreaCanvas"), this._canvasJSContainer.appendChild(this.plotArea.canvas), this.plotArea.ctx = this.plotArea.canvas.getContext("2d")),
                  ...
                  this.toolTip = new aa(this, this.options.toolTip), this.data = null, this.axisX = [], this.axisX2 = [], this.axisY = [], this.axisY2 = [], this.sessionVariables = { axisX: [], axisX2: [], axisY: [], axisY2: [] })) : window.console && window.console.log('CanvasJS Error: Chart Container with id "' + this._containerId + '" was not found')
        } function v(a, d) {
          for (var c = [], b, e = 0; e < a.length; e++)if (0 == e) c.push(a[0]); else {
            var f, l, u; u = e - 1; f = 0 === u ? 0 : u - 1; l = u === a.length - 1 ? u : u + 1; b = Math.abs((a[l].x - a[f].x) / (0 === a[l].x - a[u].x ? 0.01 : a[l].x - a[u].x)) * (d - 1) /
              2 + 1; var z = (a[l].x - a[f].x) / b; b = (a[l].y - a[f].y) / b; c[c.length] = a[u].x > a[f].x && 0 < z || a[u].x < a[f].x && 0 > z ? { x: a[u].x + z / 3, y: a[u].y + b / 3 } : { x: a[u].x, y: a[u].y + b / 9 }; u = e; f = 0 === u ? 0 : u - 1; l = u === a.length - 1 ? u : u + 1; b = Math.abs((a[l].x - a[f].x) / (0 === a[u].x - a[f].x ? 0.01 : a[u].x - a[f].x)) * (d - 1) / 2 + 1; z = (a[l].x - a[f].x) / b; b = (a[l].y - a[f].y) / b; c[c.length] = a[u].x > a[f].x && 0 < z || a[u].x < a[f].x && 0 > z ? { x: a[u].x - z / 3, y: a[u].y - b / 3 } : { x: a[u].x, y: a[u].y - b / 9 }; c[c.length] = a[e]
          } return c
        } function w(a, d, c, b, e, f, l, u, z, h) {
          var p = 0; h ? (l.color = f, u.color = f) :
          ...
          V.base.constructor.call(this, "Break", d, c, b, f); this.id = e; this.chart = a; this.ctx = this.chart.ctx; this.scaleBreaks = f; this.optionsName =
          ...
          N.base.constructor.call(this, "StripLine", "stripLines", d, c, e); this.id = b; this.chart = a; this.ctx = this.chart.ctx; this.label = this.label; this.axis = e; this.optionsName = "stripLines"; this.isOptionsInArray = !0; this._thicknessType = "pixel"; null !== this.startValue && null !== this.endValue && (this.value = e.logarithmic ? Math.sqrt((this.startValue.getTime ? this.startValue.getTime() : this.startValue) * (this.endValue.getTime ? this.endValue.getTime() : this.endValue)) : ((this.startValue.getTime ? this.startValue.getTime() :
            this.startValue) + (this.endValue.getTime ? this.endValue.getTime() : this.endValue)) / 2, this._thicknessType = null)
        } function ba(a, d, c) { ba.base.constructor.call(this, "Crosshair", "crosshair", d, null, c); this.chart = a; this.ctx = this.chart.ctx; this.axis = c; this.optionsName = "crosshair"; this._thicknessType = "pixel" } function aa(a, d) {
          aa.base.constructor.call(this, "ToolTip", "toolTip", d, null, a); this.chart = a; this.canvas = a.canvas; this.ctx = this.chart.ctx; this.currentDataPointIndex = this.currentSeriesIndex = -1; this._prevY = this._prevX =
        ...
        } function ea(a) { this.chart = a; this.lastObjectId = 0; this.objectMap = []; this.rectangularRegionEventSubscriptions = []; this.previousDataPointEventObject = null; this.ghostCanvas = ta(this.chart.width, this.chart.height); this.ghostCtx = this.ghostCanvas.getContext("2d"); this.mouseoveredObjectMaps = [] } function ka(a) {
          this.chart = a; this.ctx = this.chart.plotArea.ctx;
          this.animations = []; this.animationRequestId = null
        } oa(m, X); m.prototype.destroy = function () {
          ...
          var a =
            this; this.updateOption("width"); this.updateOption("height"); this.updateOption("dataPointWidth"); this.updateOption("dataPointMinWidth"); this.updateOption("dataPointMaxWidth"); this.updateOption("interactivityEnabled"); this.updateOption("theme"); this.updateOption("colorSet") && (this._selectedColorSet = "undefined" !== typeof za[this.colorSet] ? za[this.colorSet] : za.colorSet1); this.updateOption("backgroundColor"); this.backgroundColor || (this.backgroundColor = "rgba(0,0,0,0)"); this.updateOption("culture"); this._cultureInfo =
              new Ia(this.options.culture); this.updateOption("animationEnabled"); this.animationEnabled = this.animationEnabled && s; this.updateOption("animationDuration"); this.updateOption("rangeChanging"); this.updateOption("rangeChanged"); this.updateOption("exportEnabled"); this.updateOption("exportFileName"); this.updateOption("zoomType"); if (this.options.zoomEnabled || this.panEnabled) {
                if (!this._zoomButton) {
                  var d = !1; ua(this._zoomButton = document.createElement("button")); va(this, this._zoomButton, "pan"); this._toolBar.appendChild(this._zoomButton);
                  this._zoomButton.style.borderRight = this.toolbar.borderThickness + "px solid " + this.toolbar.borderColor; W(this._zoomButton, "touchstart", function (a) { d = !0 }, this.allDOMEventHandlers); W(this._zoomButton, "click", function () { a.zoomEnabled ? (a.zoomEnabled = !1, a.panEnabled = !0, va(a, a._zoomButton, "zoom")) : (a.zoomEnabled = !0, a.panEnabled = !1, va(a, a._zoomButton, "pan")); a.render() }, this.allDOMEventHandlers); W(this._zoomButton, "mouseover", function () {
                    ...
                    }), 0 >= navigator.userAgent.search("MSIE") && pa(a._zoomButton.childNodes[0], { WebkitFilter: "invert(100%)", filter: "invert(100%)" }))
                  }, this.allDOMEventHandlers); W(this._zoomButton, "mouseout", function () { d || (pa(a._zoomButton, { backgroundColor: a.toolbar.backgroundColor, color: a.toolbar.fontColor, transition: "0.4s", WebkitTransition: "0.4s" }), 0 >= navigator.userAgent.search("MSIE") && pa(a._zoomButton.childNodes[0], { WebkitFilter: "invert(0%)", filter: "invert(0%)" })) },
                    this.allDOMEventHandlers)
                } this._resetButton || (d = !1, ua(this._resetButton = document.createElement("button")), va(this, this._resetButton, "reset"), this._resetButton.style.borderRight = (this.exportEnabled ? this.toolbar.borderThickness : 0) + "px solid " + this.toolbar.borderColor, this._toolBar.appendChild(this._resetButton), W(this._resetButton, "touchstart", function (a) { d = !0 }, this.allDOMEventHandlers), W(this._resetButton, "click", function () {
                ...
                }, this.allDOMEventHandlers), W(this._resetButton, "mouseover", function () { d || (pa(a._resetButton, { backgroundColor: a.toolbar.backgroundColorOnHover, color: a.toolbar.hoverFfontColorOnHoverontColor, transition: "0.4s", WebkitTransition: "0.4s" }), 0 >= navigator.userAgent.search("MSIE") && pa(a._resetButton.childNodes[0], { WebkitFilter: "invert(100%)", filter: "invert(100%)" })) }, this.allDOMEventHandlers), W(this._resetButton, "mouseout", function () {
                  d || (pa(a._resetButton, {
                    backgroundColor: a.toolbar.backgroundColor,
                    color: a.toolbar.fontColor, transition: "0.4s", WebkitTransition: "0.4s"
                  }), 0 >= navigator.userAgent.search("MSIE") && pa(a._resetButton.childNodes[0], { WebkitFilter: "invert(0%)", filter: "invert(0%)" }))
              ...
              } else this.panEnabled = this.zoomEnabled = !1; gb(this); "none" !== this._toolBar.style.display && this._zoomButton && (this.panEnabled ? va(a, a._zoomButton, "zoom") : va(a, a._zoomButton, "pan"), a._resetButton.getAttribute("state") !== a._cultureInfo.resetText && va(a, a._resetButton, "reset")); this.options.toolTip && this.toolTip.options !== this.options.toolTip && (this.toolTip.options = this.options.toolTip); for (var c in this.toolTip.options) this.toolTip.options.hasOwnProperty(c) && this.toolTip.updateOption(c)
        };
        m.prototype._updateSize = function () {
          var a; a = [this.canvas, this.overlaidCanvas, this._eventManager.ghostCanvas]; var d = 0, c = 0; this.options.width ? d = this.width : this.width = d = 0 < this.container.clientWidth ? this.container.clientWidth : this.width; this.options.height ? c = this.height : this.height = c = 0 < this.container.clientHeight ? this.container.clientHeight : this.height; if (this.canvas.width !== d * ja || this.canvas.height !== c * ja) {
          ...
          this.isNavigator = r(this.parent) || r(this.parent._defaultsKey) || "Navigator" !== this.parent._defaultsKey ? !1 : !0; this.toolbar = new Sa(this, this.options.toolbar); this._animator ? this._animator.cancelAllAnimations() : this._animator = new ka(this); this.removeAllEventListeners(); this.disableToolTip = !1; this._axes = []; this.funnelPyramidClickHandler = this.pieDoughnutClickHandler = null; this._updateOptions(); this.animatedRender = s && this.animationEnabled &&
            0 === this.renderCount; this._updateSize(); this.clearCanvas(); this.ctx.beginPath(); this.axisX = []; this.axisX2 = []; this.axisY = []; this.axisY2 = []; this._indexLabels = []; this._dataInRenderedOrder = []; this._events = []; this._eventManager && this._eventManager.reset(); this.plotInfo = { axisPlacement: null, plotTypes: [] }; this.layoutManager = new Da(0, 0, this.width, this.height, this.isNavigator ? 0 : 2); this.plotArea.layoutManager && this.plotArea.layoutManager.reset(); this.data = []; var a = 0, d = null; if (this.options.data) {
              for (var c = 0; c <
                this.options.data.length; c++)if (a++, !this.options.data[c].type || 0 <= m._supportedChartTypes.indexOf(this.options.data[c].type)) {
                  var b = new G(this, this.options.data[c], a - 1, ++this._eventManager.lastObjectId); "error" === b.type && (b.linkedDataSeriesIndex = r(this.options.data[c].linkedDataSeriesIndex) ? c - 1 : this.options.data[c].linkedDataSeriesIndex, 0 > b.linkedDataSeriesIndex || b.linkedDataSeriesIndex >= this.options.data.length || "number" !== typeof b.linkedDataSeriesIndex || "error" === this.options.data[b.linkedDataSeriesIndex].type) &&
        ...
        m.prototype.setLayout = function () {
          for (var a = this._plotAreaElements, d = 0; d < this.data.length; d++)if ("normal" === this.plotInfo.axisPlacement || "xySwapped" === this.plotInfo.axisPlacement) {
            if (!this.data[d].axisYType || "primary" === this.data[d].axisYType) if (this.options.axisY && 0 < this.options.axisY.length) {
              ...
              0, "axisY", "left")) : "xySwapped" === this.plotInfo.axisPlacement && this._axes.push(this.axisY[0] = new D(this, "axisY", this.options.axisY, 0, "axisY", "bottom"))), this.data[d].axisY = this.axisY[0], this.axisY[0].dataSeries.push(this.data[d]); if ("secondary" === this.data[d].axisYType) if (this.options.axisY2 && 0 < this.options.axisY2.length) {
                ...
                new D(this, "axisY2", this.options.axisY2, 0, "axisY", "right")) : "xySwapped" === this.plotInfo.axisPlacement && this._axes.push(this.axisY2[0] = new D(this, "axisY2", this.options.axisY2, 0, "axisY", "top"))), this.data[d].axisY = this.axisY2[0], this.axisY2[0].dataSeries.push(this.data[d]); if (!this.data[d].axisXType || "primary" === this.data[d].axisXType) if (this.options.axisX && 0 < this.options.axisX.length) {
                  if (!this.axisX.length) for (c = 0; c < this.options.axisX.length; c++)"normal" === this.plotInfo.axisPlacement ? this._axes.push(this.axisX[c] =
                    new D(this, "axisX", this.options.axisX[c], c, "axisX", "bottom")) : "xySwapped" === this.plotInfo.axisPlacement && this._axes.push(this.axisX[c] = new D(this, "axisX", this.options.axisX[c], c, "axisX", "left")); this.data[d].axisX = this.axisX[0 <= this.data[d].axisXIndex && this.data[d].axisXIndex < this.axisX.length ? this.data[d].axisXIndex : 0]; this.axisX[0 <= this.data[d].axisXIndex && this.data[d].axisXIndex < this.axisX.length ? this.data[d].axisXIndex : 0].dataSeries.push(this.data[d])
                } else this.axisX.length || ("normal" === this.plotInfo.axisPlacement ?
                  this._axes.push(this.axisX[0] = new D(this, "axisX", this.options.axisX, 0, "axisX", "bottom")) : "xySwapped" === this.plotInfo.axisPlacement && this._axes.push(this.axisX[0] = new D(this, "axisX", this.options.axisX, 0, "axisX", "left"))), this.data[d].axisX = this.axisX[0], this.axisX[0].dataSeries.push(this.data[d]); if ("secondary" === this.data[d].axisXType) if (this.options.axisX2 && 0 < this.options.axisX2.length) {
          ...
          var a = this._plotAreaElements; this.title && !this.title.dockInsidePlotArea && this.title.render(); for (var d = 0; d < this.subtitles.length; d++)this.subtitles[d].dockInsidePlotArea || this.subtitles[d].render(); this.legend.dockInsidePlotArea || this.legend.render(); if ("normal" ===
            this.plotInfo.axisPlacement || "xySwapped" === this.plotInfo.axisPlacement) D.render(this.axisX, this.axisX2, this.axisY, this.axisY2, this.plotInfo.axisPlacement); else if ("none" === this.plotInfo.axisPlacement) this.preparePlotArea(); else return; for (d = 0; d < a.length; d++)a[d].setLayout(), a[d].render(); var c = []; if (this.animatedRender) { var b = ta(this.width, this.height); b.getContext("2d").drawImage(this.canvas, 0, 0, this.width, this.height) } hb(this); var a = this.ctx.miterLimit, e; this.ctx.miterLimit = 3; s && this._breaksCanvas &&
              (this._preRenderCtx.drawImage(this.canvas, 0, 0, this.width, this.height), this._preRenderCtx.drawImage(this._breaksCanvas, 0, 0, this.width, this.height), this._breaksCanvasCtx.globalCompositeOperation = "source-atop", this._breaksCanvasCtx.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), this._preRenderCtx.clearRect(0, 0, this.width, this.height)); for (d = 0; d < this.plotInfo.plotTypes.length; d++)for (var f = this.plotInfo.plotTypes[d], l = 0; l < f.plotUnits.length; l++) {
                var u = f.plotUnits[l], z = null; u.targetCanvas =
                ...
                for (var h = 0; h < u.dataSeriesIndexes.length; h++)this._dataInRenderedOrder.push(this.data[u.dataSeriesIndexes[h]]); this.animatedRender && (u.targetCanvasCtx.miterLimit = e, z && c.push(z))
                ...
                c.push(this.renderIndexLabels(e))); var p = this; if (0 < c.length) p.disableToolTip = !0, p._animator.animate(200, p.animationDuration, function (a) {
                ...
                }, function () { c = []; for (var a = 0; a < p.plotInfo.plotTypes.length; a++)for (var e = p.plotInfo.plotTypes[a], d = 0; d < e.plotUnits.length; d++)e.plotUnits[d].targetCanvas = null; b = null; p.disableToolTip = !1; p.dispatchEvent("dataAnimationEnd", { chart: p }) }); else {
                  if (p._breaksCanvas) if (s) p.plotArea.ctx.drawImage(p._breaksCanvas, 0, 0, this.width, this.height); else for (h = 0; h < p._axes.length; h++)p._axes[h].createMask(); 0 < p._indexLabels.length && p.renderIndexLabels(); p.dispatchEvent("dataAnimationIterationEnd",
                    { chart: p }); p.dispatchEvent("dataAnimationEnd", { chart: p })
        ...
        }; m.prototype.render = function (a) { a && (this.options = a); this._initialize(); this.setLayout(); this.renderElements(); this._preRenderCanvas = null }; m.prototype.attachPlotAreaEventHandlers = function () {
          this.attachEvent({
          ...
          for (var a = "", d = 0; d < this.data.length; d++)if (a = this.data[d], a.dataPoints && (0 !== a.dataPoints.length && a.visible) && 0 <= m._supportedChartTypes.indexOf(a.type)) {
            for (var c = null, b = !1, e = null, f = !1, l = 0; l < this.plotInfo.plotTypes.length; l++)if (this.plotInfo.plotTypes[l].type === a.type) { b = !0; c = this.plotInfo.plotTypes[l]; break } b || (c = { type: a.type, totalDataSeries: 0, plotUnits: [] }, this.plotInfo.plotTypes.push(c)); for (l = 0; l <
              c.plotUnits.length; l++)if (c.plotUnits[l].axisYType === a.axisYType && c.plotUnits[l].axisXType === a.axisXType && c.plotUnits[l].axisYIndex === a.axisYIndex && c.plotUnits[l].axisXIndex === a.axisXIndex) { f = !0; e = c.plotUnits[l]; break } f || (e = {
          ...
          if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, l = 0; l < a.dataSeriesIndexes.length; l++) {
            var u = this.data[a.dataSeriesIndexes[l]], z = 0, h = !1, p = !1, n; if ("normal" === u.axisPlacement ||
              "xySwapped" === u.axisPlacement) var q = a.axisX.sessionVariables.newViewportMinimum ? a.axisX.sessionVariables.newViewportMinimum : this.options.axisX && this.options.axisX.viewportMinimum ? this.options.axisX.viewportMinimum : this.options.axisX && this.options.axisX.minimum ? this.options.axisX.minimum : a.axisX.logarithmic ? 0 : -Infinity, g = a.axisX.sessionVariables.newViewportMaximum ? a.axisX.sessionVariables.newViewportMaximum : this.options.axisX && this.options.axisX.viewportMaximum ? this.options.axisX.viewportMaximum : this.options.axisX &&
                this.options.axisX.maximum ? this.options.axisX.maximum : Infinity; if (u.dataPoints[z].x && u.dataPoints[z].x.getTime || "dateTime" === u.xValueType) f = !0; for (z = 0; z < u.dataPoints.length; z++) {
                  "undefined" === typeof u.dataPoints[z].x && (u.dataPoints[z].x = z + (a.axisX.logarithmic ? 1 : 0)); u.dataPoints[z].x.getTime ? (f = !0, b = u.dataPoints[z].x.getTime()) : b = u.dataPoints[z].x; e = u.dataPoints[z].y; b < c.min && (c.min = b); b > c.max && (c.max = b); e < d.min && "number" === typeof e && (d.min = e); e > d.max && "number" === typeof e && (d.max = e); if (0 < z) {
                    if (a.axisX.logarithmic) {
                      var B =
                        b / u.dataPoints[z - 1].x; 1 > B && (B = 1 / B); c.minDiff > B && 1 !== B && (c.minDiff = B)
                    } else B = b - u.dataPoints[z - 1].x, 0 > B && (B *= -1), c.minDiff > B && 0 !== B && (c.minDiff = B); null !== e && null !== u.dataPoints[z - 1].y && (a.axisY.logarithmic ? (B = e / u.dataPoints[z - 1].y, 1 > B && (B = 1 / B), d.minDiff > B && 1 !== B && (d.minDiff = B)) : (B = e - u.dataPoints[z - 1].y, 0 > B && (B *= -1), d.minDiff > B && 0 !== B && (d.minDiff = B)))
                  } if (b < q && !h) null !== e && (n = b); else {
                    if (!h && (h = !0, 0 < z)) { z -= 2; continue } if (b > g && !p) p = !0; else if (b > g && p) continue; u.dataPoints[z].label && (a.axisX.labels[b] = u.dataPoints[z].label);
                    b < c.viewPortMin && (c.viewPortMin = b); b > c.viewPortMax && (c.viewPortMax = b); null === e ? c.viewPortMin === b && n < b && (c.viewPortMin = n) : (e < d.viewPortMin && "number" === typeof e && (d.viewPortMin = e), e > d.viewPortMax && "number" === typeof e && (d.viewPortMax = e))
                  }
            ...
            for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, l = [], u = [], z = Infinity, h = -Infinity, p = 0; p < a.dataSeriesIndexes.length; p++) {
              var n =
                this.data[a.dataSeriesIndexes[p]], q = 0, g = !1, B = !1, k; if ("normal" === n.axisPlacement || "xySwapped" === n.axisPlacement) var O = a.axisX.sessionVariables.newViewportMinimum ? a.axisX.sessionVariables.newViewportMinimum : this.options.axisX && this.options.axisX.viewportMinimum ? this.options.axisX.viewportMinimum : this.options.axisX && this.options.axisX.minimum ? this.options.axisX.minimum : -Infinity, t = a.axisX.sessionVariables.newViewportMaximum ? a.axisX.sessionVariables.newViewportMaximum : this.options.axisX && this.options.axisX.viewportMaximum ?
                  this.options.axisX.viewportMaximum : this.options.axisX && this.options.axisX.maximum ? this.options.axisX.maximum : Infinity; if (n.dataPoints[q].x && n.dataPoints[q].x.getTime || "dateTime" === n.xValueType) f = !0; for (q = 0; q < n.dataPoints.length; q++) {
                    "undefined" === typeof n.dataPoints[q].x && (n.dataPoints[q].x = q + (a.axisX.logarithmic ? 1 : 0)); n.dataPoints[q].x.getTime ? (f = !0, b = n.dataPoints[q].x.getTime()) : b = n.dataPoints[q].x; e = r(n.dataPoints[q].y) ? 0 : n.dataPoints[q].y; b < c.min && (c.min = b); b > c.max && (c.max = b); if (0 < q) {
                      if (a.axisX.logarithmic) {
                        var m =
                          b / n.dataPoints[q - 1].x; 1 > m && (m = 1 / m); c.minDiff > m && 1 !== m && (c.minDiff = m)
                      } else m = b - n.dataPoints[q - 1].x, 0 > m && (m *= -1), c.minDiff > m && 0 !== m && (c.minDiff = m); null !== e && null !== n.dataPoints[q - 1].y && (a.axisY.logarithmic ? 0 < e && (m = e / n.dataPoints[q - 1].y, 1 > m && (m = 1 / m), d.minDiff > m && 1 !== m && (d.minDiff = m)) : (m = e - n.dataPoints[q - 1].y, 0 > m && (m *= -1), d.minDiff > m && 0 !== m && (d.minDiff = m)))
                    } if (b < O && !g) null !== n.dataPoints[q].y && (k = b); else {
                      if (!g && (g = !0, 0 < q)) { q -= 2; continue } if (b > t && !B) B = !0; else if (b > t && B) continue; n.dataPoints[q].label && (a.axisX.labels[b] =
                        n.dataPoints[q].label); b < c.viewPortMin && (c.viewPortMin = b); b > c.viewPortMax && (c.viewPortMax = b); null === n.dataPoints[q].y ? c.viewPortMin === b && k < b && (c.viewPortMin = k) : (a.yTotals[b] = (a.yTotals[b] ? a.yTotals[b] : 0) + e, 0 <= e ? l[b] ? l[b] += e : (l[b] = e, z = Math.min(e, z)) : u[b] ? u[b] += e : (u[b] = e, h = Math.max(e, h)))
                    }
                    ...
                    u)) : (d.dataPointYPositiveSums = l, d.dataPointYNegativeSums = u)); n.axisX.valueType = n.xValueType = f ? "dateTime" : "number"
            } for (q in l) l.hasOwnProperty(q) && !isNaN(q) && (a = l[q], a < d.min && (d.min = Math.min(a, z)), a > d.max && (d.max = a), q < c.viewPortMin || q > c.viewPortMax || (a < d.viewPortMin && (d.viewPortMin = Math.min(a, z)), a > d.viewPortMax && (d.viewPortMax = a))); for (q in u) u.hasOwnProperty(q) && !isNaN(q) && (a = u[q], a < d.min && (d.min = a), a > d.max && (d.max = Math.max(a, h)), q < c.viewPortMin || q > c.viewPortMax || (a < d.viewPortMin && (d.viewPortMin =
          ...
          if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
            for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, l = !1, u = !1, z = [], h = 0; h < a.dataSeriesIndexes.length; h++) {
              var p = this.data[a.dataSeriesIndexes[h]], n = 0, q = !1, g = !1, B; if ("normal" === p.axisPlacement || "xySwapped" === p.axisPlacement) var k = a.axisX.sessionVariables.newViewportMinimum ? a.axisX.sessionVariables.newViewportMinimum : this.options.axisX &&
                this.options.axisX.viewportMinimum ? this.options.axisX.viewportMinimum : this.options.axisX && this.options.axisX.minimum ? this.options.axisX.minimum : -Infinity, m = a.axisX.sessionVariables.newViewportMaximum ? a.axisX.sessionVariables.newViewportMaximum : this.options.axisX && this.options.axisX.viewportMaximum ? this.options.axisX.viewportMaximum : this.options.axisX && this.options.axisX.maximum ? this.options.axisX.maximum : Infinity; if (p.dataPoints[n].x && p.dataPoints[n].x.getTime || "dateTime" === p.xValueType) f = !0; for (n =
                  0; n < p.dataPoints.length; n++) {
                    "undefined" === typeof p.dataPoints[n].x && (p.dataPoints[n].x = n + (a.axisX.logarithmic ? 1 : 0)); p.dataPoints[n].x.getTime ? (f = !0, b = p.dataPoints[n].x.getTime()) : b = p.dataPoints[n].x; e = r(p.dataPoints[n].y) ? null : p.dataPoints[n].y; b < c.min && (c.min = b); b > c.max && (c.max = b); if (0 < n) {
                      if (a.axisX.logarithmic) { var t = b / p.dataPoints[n - 1].x; 1 > t && (t = 1 / t); c.minDiff > t && 1 !== t && (c.minDiff = t) } else t = b - p.dataPoints[n - 1].x, 0 > t && (t *= -1), c.minDiff > t && 0 !== t && (c.minDiff = t); r(e) || null === p.dataPoints[n - 1].y ||
                      ...
                      if (!q && (q = !0, 0 < n)) { n -= 2; continue } if (b > m && !g) g = !0; else if (b > m && g) continue; p.dataPoints[n].label && (a.axisX.labels[b] = p.dataPoints[n].label); b < c.viewPortMin && (c.viewPortMin = b); b > c.viewPortMax && (c.viewPortMax = b); null === e ? c.viewPortMin === b && B < b && (c.viewPortMin = B) : (a.yTotals[b] = (a.yTotals[b] ? a.yTotals[b] :
              ...
              -99 : Math.min(d.viewPortMin, -99)) : !l && u && (d.max = r(d.viewPortMax) ? -1 : Math.max(d.viewPortMax, -1), d.min = r(d.viewPortMin) ? -99 : Math.min(d.viewPortMin, -99)); d.viewPortMin = d.min; d.viewPortMax = d.max; a.dataPointYSums = z
          }
          ...
          if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f, l, u = !1, z = 0; z < a.dataSeriesIndexes.length; z++) {
            var h = this.data[a.dataSeriesIndexes[z]], p = 0, n = !1, q = !1, g, B, k; if ("normal" === h.axisPlacement ||
              "xySwapped" === h.axisPlacement) var m = a.axisX.sessionVariables.newViewportMinimum ? a.axisX.sessionVariables.newViewportMinimum : this.options.axisX && this.options.axisX.viewportMinimum ? this.options.axisX.viewportMinimum : this.options.axisX && this.options.axisX.minimum ? this.options.axisX.minimum : a.axisX.logarithmic ? 0 : -Infinity, t = a.axisX.sessionVariables.newViewportMaximum ? a.axisX.sessionVariables.newViewportMaximum : this.options.axisX && this.options.axisX.viewportMaximum ? this.options.axisX.viewportMaximum : this.options.axisX &&
                this.options.axisX.maximum ? this.options.axisX.maximum : Infinity; if (h.dataPoints[p].x && h.dataPoints[p].x.getTime || "dateTime" === h.xValueType) u = !0; for (p = 0; p < h.dataPoints.length; p++) {
                  "undefined" === typeof h.dataPoints[p].x && (h.dataPoints[p].x = p + (a.axisX.logarithmic ? 1 : 0)); h.dataPoints[p].x.getTime ? (u = !0, b = h.dataPoints[p].x.getTime()) : b = h.dataPoints[p].x; if ((e = h.dataPoints[p].y) && e.length) {
                    f = Math.min.apply(null, e); l = Math.max.apply(null, e); B = !0; for (var x = 0; x < e.length; x++)null === e.k && (B = !1); B && (n || (k = g), g =
                      b)
                  } b < c.min && (c.min = b); b > c.max && (c.max = b); f < d.min && (d.min = f); l > d.max && (d.max = l); 0 < p && (a.axisX.logarithmic ? (B = b / h.dataPoints[p - 1].x, 1 > B && (B = 1 / B), c.minDiff > B && 1 !== B && (c.minDiff = B)) : (B = b - h.dataPoints[p - 1].x, 0 > B && (B *= -1), c.minDiff > B && 0 !== B && (c.minDiff = B)), e && (null !== e[0] && h.dataPoints[p - 1].y && null !== h.dataPoints[p - 1].y[0]) && (a.axisY.logarithmic ? (B = e[0] / h.dataPoints[p - 1].y[0], 1 > B && (B = 1 / B), d.minDiff > B && 1 !== B && (d.minDiff = B)) : (B = e[0] - h.dataPoints[p - 1].y[0], 0 > B && (B *= -1), d.minDiff > B && 0 !== B && (d.minDiff = B))));
          ...
          function (a) {
            if ("waterfall" === a.type && a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, l = 0; l < a.dataSeriesIndexes.length; l++) {
              var u = this.data[a.dataSeriesIndexes[l]], z = 0, h = !1, p = !1, n = b = 0; if ("normal" === u.axisPlacement || "xySwapped" === u.axisPlacement) var q = a.axisX.sessionVariables.newViewportMinimum ? a.axisX.sessionVariables.newViewportMinimum : this.options.axisX && this.options.axisX.viewportMinimum ? this.options.axisX.viewportMinimum : this.options.axisX &&
                    ...
                    b = 0) : (e = "number" !== typeof u.dataPoints[z].y ? 0 : u.dataPoints[z].y, u.dataPointEOs[z].cumulativeSumYStartValue = 0 === z ? 0 : u.dataPointEOs[z - 1].cumulativeSum, u.dataPointEOs[z].cumulativeSum = 0 === z ? e : u.dataPointEOs[z - 1].cumulativeSum + e, b += e); for (z = 0; z < u.dataPoints.length; z++)if ("undefined" === typeof u.dataPoints[z].x && (u.dataPoints[z].x = z + (a.axisX.logarithmic ? 1 : 0)), u.dataPoints[z].x.getTime ? (f = !0, b = u.dataPoints[z].x.getTime()) : b = u.dataPoints[z].x, e = u.dataPoints[z].y, b < c.min && (c.min = b), b > c.max && (c.max = b), u.dataPointEOs[z].cumulativeSum <
                      d.min && (d.min = u.dataPointEOs[z].cumulativeSum), u.dataPointEOs[z].cumulativeSum > d.max && (d.max = u.dataPointEOs[z].cumulativeSum), 0 < z && (a.axisX.logarithmic ? (n = b / u.dataPoints[z - 1].x, 1 > n && (n = 1 / n), c.minDiff > n && 1 !== n && (c.minDiff = n)) : (n = b - u.dataPoints[z - 1].x, 0 > n && (n *= -1), c.minDiff > n && 0 !== n && (c.minDiff = n)), null !== e && null !== u.dataPoints[z - 1].y && (a.axisY.logarithmic ? (e = u.dataPointEOs[z].cumulativeSum / u.dataPointEOs[z - 1].cumulativeSum, 1 > e && (e = 1 / e), d.minDiff > e && 1 !== e && (d.minDiff = e)) : (e = u.dataPointEOs[z].cumulativeSum -
                        u.dataPointEOs[z - 1].cumulativeSum, 0 > e && (e *= -1), d.minDiff > e && 0 !== e && (d.minDiff = e)))), !(b < q) || h) {
                          if (!h && (h = !0, 0 < z)) { z -= 2; continue } if (b > g && !p) p = !0; else if (b > g && p) continue; u.dataPoints[z].label && (a.axisX.labels[b] = u.dataPoints[z].label); b < c.viewPortMin && (c.viewPortMin = b); b > c.viewPortMax && (c.viewPortMax = b); 0 < z && (u.dataPointEOs[z - 1].cumulativeSum < d.viewPortMin && (d.viewPortMin = u.dataPointEOs[z - 1].cumulativeSum), u.dataPointEOs[z - 1].cumulativeSum > d.viewPortMax && (d.viewPortMax = u.dataPointEOs[z - 1].cumulativeSum));
                      u.dataPointEOs[z].cumulativeSum < d.viewPortMin && (d.viewPortMin = u.dataPointEOs[z].cumulativeSum); u.dataPointEOs[z].cumulativeSum > d.viewPortMax && (d.viewPortMax = u.dataPointEOs[z].cumulativeSum)
                    } u.axisX.valueType = u.xValueType = f ? "dateTime" : "number"
            }
            ...
            function a(a, b, c, e) {
              ...
              if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
                var b = a.axisX.scaleBreaks && a.axisX.scaleBreaks.autoCalculate && 1 <= a.axisX.scaleBreaks.maxNumberOfAutoBreaks, c = a.axisY.scaleBreaks && a.axisY.scaleBreaks.autoCalculate && 1 <= a.axisY.scaleBreaks.maxNumberOfAutoBreaks; if (b || c) for (var d = a.axisY.dataInfo, f = a.axisX.dataInfo, g, h = f.min, l = f.max, p = d.min, q = d.max, f = f._dataRanges, d = d._dataRanges, n, u = 0, z = 0; z < a.dataSeriesIndexes.length; z++) {
                  ...
                  if (!(4 > k.dataPoints.length)) for (u = 0; u < k.dataPoints.length; u++)if (b && (n = (l + 1 - h) * Math.max(parseFloat(a.axisX.scaleBreaks.collapsibleThreshold) || 10, 10) / 100, g = k.dataPoints[u].x.getTime ? k.dataPoints[u].x.getTime() : k.dataPoints[u].x, n = Math.floor((g - h) / n), g < f[n].min && (f[n].min = g), g > f[n].max && (f[n].max = g)), c) {
                    var m = (q + 1 - p) * Math.max(parseFloat(a.axisY.scaleBreaks.collapsibleThreshold) || 10, 10) / 100; if ((g = "waterfall" === a.type ? k.dataPointEOs[u].cumulativeSum : k.dataPoints[u].y) && g.length) for (var s = 0; s < g.length; s++)n =
              ...
              if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length) && a.axisX.scaleBreaks && a.axisX.scaleBreaks.autoCalculate && 1 <= a.axisX.scaleBreaks.maxNumberOfAutoBreaks) for (var b = a.axisX.dataInfo, c = b.min, d = b.max, f = b._dataRanges, g, h = 0, l = 0; l < a.dataSeriesIndexes.length; l++) {
                var p = e.data[a.dataSeriesIndexes[l]]; if (!(4 > p.dataPoints.length)) for (h =
              ...
              f = !0; this._axes[l].dataInfo._dataRanges = []; for (var u = 0; u < 100 / Math.max(parseFloat(this._axes[l].scaleBreaks.collapsibleThreshold) ||
              ...
              for (l = 0; l < this.plotInfo.plotTypes.length; l++)for (f = this.plotInfo.plotTypes[l], u = 0; u < f.plotUnits.length; u++)b = f.plotUnits[u], "line" === b.type || "stepLine" === b.type || "spline" === b.type || "column" === b.type || "area" === b.type || "stepArea" === b.type || "splineArea" === b.type || "bar" === b.type || "bubble" === b.type || "scatter" === b.type || "candlestick" === b.type || "ohlc" === b.type || "rangeColumn" === b.type || "rangeBar" === b.type || "rangeArea" ===
                b.type || "rangeSplineArea" === b.type || "waterfall" === b.type || "error" === b.type || "boxAndWhisker" === b.type ? d(b) : 0 <= b.type.indexOf("stacked") && c(b); for (l = 0; l < this._axes.length; l++)if (this._axes[l].dataInfo._dataRanges) {
                  var z = this._axes[l].dataInfo.min; b = (this._axes[l].dataInfo.max + 1 - z) * Math.max(parseFloat(this._axes[l].scaleBreaks.collapsibleThreshold) || 10, 10) / 100; var h = this._axes[l].dataInfo._dataRanges, p, n, f = []; if (this._axes[l].dataInfo.dataPointYPositiveSums) {
                    var q = this._axes[l].dataInfo.dataPointYPositiveSums;
                    p = h; for (u in q) if (q.hasOwnProperty(u) && !isNaN(u) && (n = q[u], !r(n))) { var g = Math.floor((n - z) / b); n < p[g].min && (p[g].min = n); n > p[g].max && (p[g].max = n) } delete this._axes[l].dataInfo.dataPointYPositiveSums
                  } if (this._axes[l].dataInfo.dataPointYNegativeSums) { q = this._axes[l].dataInfo.dataPointYNegativeSums; p = h; for (u in q) q.hasOwnProperty(u) && !isNaN(u) && (n = -1 * q[u], r(n) || (g = Math.floor((n - z) / b), n < p[g].min && (p[g].min = n), n > p[g].max && (p[g].max = n))); delete this._axes[l].dataInfo.dataPointYNegativeSums } for (u = 0; u < h.length -
            ...
            var b = null; if (c = this.getDataPointAtXY(a,
              d, c || !1)) b = c.dataSeries.dataPointIds[c.dataPointIndex]; else if (s) b = Ya(a, d, this._eventManager.ghostCtx); else for (c = 0; c < this.legend.items.length; c++) { var e = this.legend.items[c]; a >= e.x1 && (a <= e.x2 && d >= e.y1 && d <= e.y2) && (b = e.id) } return b
            ...
            var c = { chart: this }; c.type = a; c.trigger = d; var b = []; this.axisX && 0 < this.axisX.length && b.push("axisX"); this.axisX2 && 0 < this.axisX2.length && b.push("axisX2"); this.axisY &&
                ...
                var c = 0, b = 0, e = c = null, e = 0 <= this.zoomType.indexOf("x"), f = 0 <= this.zoomType.indexOf("y"), l = this; "xySwapped" === this.plotInfo.axisPlacement && (c = f, f = e, e = c); c = this.dragStartPoint.x - a; b = this.dragStartPoint.y - d; 2 < Math.abs(c) && 8 > Math.abs(c) && (this.panEnabled || this.zoomEnabled) ? (this.toolTip.hide(), this.toolTip.dispatchEvent("hidden", { chart: this, toolTip: this.toolTip }, this.toolTip)) : this.panEnabled || this.zoomEnabled || this.toolTip.mouseMoveHandler(a, d); if ((!e || 2 < Math.abs(c) ||
                  !f || 2 < Math.abs(b)) && (this.panEnabled || this.zoomEnabled)) if (this.panEnabled) e = { x1: e ? this.plotArea.x1 + c : this.plotArea.x1, y1: f ? this.plotArea.y1 + b : this.plotArea.y1, x2: e ? this.plotArea.x2 + c : this.plotArea.x2, y2: f ? this.plotArea.y2 + b : this.plotArea.y2 }, clearTimeout(l._panTimerId), l._panTimerId = setTimeout(function (b, c, e, f) {
                    ...
                    c = this.overlaidCanvasCtx.globalAlpha; this.overlaidCanvasCtx.fillStyle = "#A89896"; var b = e ? this.dragStartPoint.x : this.plotArea.x1, u = f ? this.dragStartPoint.y : this.plotArea.y1, z = e ? a - this.dragStartPoint.x : this.plotArea.x2 - this.plotArea.x1, h = f ? d - this.dragStartPoint.y : this.plotArea.y2 - this.plotArea.y1; this.validateRegion(b, u, e ? a : this.plotArea.x2 - this.plotArea.x1, f ? d : this.plotArea.y2 - this.plotArea.y1, "xy" !== this.zoomType).isValid && (this.resetOverlayedCanvas(), this.overlaidCanvasCtx.fillStyle = "#99B2B5"); this.overlaidCanvasCtx.globalAlpha =
                      0.7; this.overlaidCanvasCtx.fillRect(b, u, z, h); this.overlaidCanvasCtx.globalAlpha = c
                  }
            ...
            e = e || !1; for (var f = 0 <= this.zoomType.indexOf("x"), l = 0 <= this.zoomType.indexOf("y"), u = !1, z = [], h = [], p = [], n = 0; n < this._axes.length; n++)("axisX" === this._axes[n].type && f || "axisY" === this._axes[n].type &&
              l) && h.push(this._axes[n]); for (l = 0; l < h.length; l++) {
                var n = h[l], f = !1, q = n.convertPixelToValue({ x: a, y: d }), g = n.convertPixelToValue({ x: c, y: b }); if (q > g) var B = g, g = q, q = B; if (n.scaleBreaks) for (B = 0; !f && B < n.scaleBreaks._appliedBreaks.length; B++)f = n.scaleBreaks._appliedBreaks[B].startValue <= q && n.scaleBreaks._appliedBreaks[B].endValue >= g; if (isFinite(n.dataInfo.minDiff)) if (B = n.getApparentDifference(q, g, null, !0), !(f || !(this.panEnabled && n.scaleBreaks && n.scaleBreaks._appliedBreaks.length) && (n.logarithmic && B < Math.pow(n.dataInfo.minDiff,
                  3) || !n.logarithmic && B < 3 * Math.abs(n.dataInfo.minDiff)) || q < n.minimum || g > n.maximum)) z.push(n), p.push({ val1: q, val2: g }), u = !0; else if (!e) { u = !1; break }
            ...
            } else d = this.layoutManager.getFreeSpace(), a.x1 = d.x1, a.x2 = d.x2, a.y1 = d.y1, a.y2 = d.y2, a.width = d.width, a.height = d.height; s || (a.canvas.width = a.width, a.canvas.height = a.height, a.canvas.style.left = a.x1 + "px", a.canvas.style.top = a.y1 + "px", (0 < a.x1 || 0 < a.y1) && a.ctx.translate(-a.x1, -a.y1)); a.layoutManager = new Da(a.x1, a.y1, a.x2, a.y2, 2)
          }; m.prototype.renderIndexLabels = function (a) {
            var d = a || this.plotArea.ctx, c = this.plotArea, b = 0, e = 0, f = 0, l = 0, u = b = l = e = f = 0, z = 0; for (a = 0; a < this._indexLabels.length; a++) {
              var h =
                this._indexLabels[a], p = h.chartType.toLowerCase(), n, q, u = ma("indexLabelFontColor", h.dataPoint, h.dataSeries), z = ma("indexLabelFontSize", h.dataPoint, h.dataSeries); n = ma("indexLabelFontFamily", h.dataPoint, h.dataSeries); q = ma("indexLabelFontStyle", h.dataPoint, h.dataSeries); var l = ma("indexLabelFontWeight", h.dataPoint, h.dataSeries), g = ma("indexLabelBackgroundColor", h.dataPoint, h.dataSeries), e = ma("indexLabelMaxWidth", h.dataPoint, h.dataSeries), f = ma("indexLabelWrap", h.dataPoint, h.dataSeries), B = ma("indexLabelLineDashType",
                  h.dataPoint, h.dataSeries), k = ma("indexLabelLineColor", h.dataPoint, h.dataSeries), m = r(h.dataPoint.indexLabelLineThickness) ? r(h.dataSeries.options.indexLabelLineThickness) ? 0 : h.dataSeries.options.indexLabelLineThickness : h.dataPoint.indexLabelLineThickness, b = 0 < m ? Math.min(10, ("normal" === this.plotInfo.axisPlacement ? this.plotArea.height : this.plotArea.width) << 0) : 0, t = { percent: null, total: null }, x = null; if (0 <= h.dataSeries.type.indexOf("stacked") || "pie" === h.dataSeries.type || "doughnut" === h.dataSeries.type) t = this.getPercentAndTotal(h.dataSeries,
                    h.dataPoint); if (h.dataSeries.indexLabelFormatter || h.dataPoint.indexLabelFormatter) x = { chart: this, dataSeries: h.dataSeries, dataPoint: h.dataPoint, index: h.indexKeyword, total: t.total, percent: t.percent }; var A = h.dataPoint.indexLabelFormatter ? h.dataPoint.indexLabelFormatter(x) : h.dataPoint.indexLabel ? this.replaceKeywordsWithValue(h.dataPoint.indexLabel, h.dataPoint, h.dataSeries, null, h.indexKeyword) : h.dataSeries.indexLabelFormatter ? h.dataSeries.indexLabelFormatter(x) : h.dataSeries.indexLabel ? this.replaceKeywordsWithValue(h.dataSeries.indexLabel,
                      h.dataPoint, h.dataSeries, null, h.indexKeyword) : null; if (null !== A && "" !== A) {
                        var t = ma("indexLabelPlacement", h.dataPoint, h.dataSeries), x = ma("indexLabelOrientation", h.dataPoint, h.dataSeries), J = h.direction, C = h.dataSeries.axisX, y = h.dataSeries.axisY, v = !1, g = new la(d, { x: 0, y: 0, maxWidth: e ? e : 0.5 * this.width, maxHeight: f ? 5 * z : 1.5 * z, angle: "horizontal" === x ? 0 : -90, text: A, padding: 0, backgroundColor: g, horizontalAlign: "left", fontSize: z, fontFamily: n, fontWeight: l, fontColor: u, fontStyle: q, textBaseline: "top" }); g.measureText(); h.dataSeries.indexLabelMaxWidth =
                          g.maxWidth; if ("stackedarea100" === p) { if (h.point.x < c.x1 || h.point.x > c.x2 || h.point.y < c.y1 - 1 || h.point.y > c.y2 + 1) continue } else if ("rangearea" === p || "rangesplinearea" === p) { if (h.dataPoint.x < C.viewportMinimum || h.dataPoint.x > C.viewportMaximum || Math.max.apply(null, h.dataPoint.y) < y.viewportMinimum || Math.min.apply(null, h.dataPoint.y) > y.viewportMaximum) continue } else if (0 <= p.indexOf("line") || 0 <= p.indexOf("area") || 0 <= p.indexOf("bubble") || 0 <= p.indexOf("scatter")) {
                            if (h.dataPoint.x < C.viewportMinimum || h.dataPoint.x > C.viewportMaximum ||
                              h.dataPoint.y < y.viewportMinimum || h.dataPoint.y > y.viewportMaximum) continue
                          } else if (0 <= p.indexOf("column") || "waterfall" === p || "error" === p && !h.axisSwapped) { if (h.dataPoint.x < C.viewportMinimum || h.dataPoint.x > C.viewportMaximum || h.bounds.y1 > c.y2 || h.bounds.y2 < c.y1) continue } else if (0 <= p.indexOf("bar") || "error" === p) { if (h.dataPoint.x < C.viewportMinimum || h.dataPoint.x > C.viewportMaximum || h.bounds.x1 > c.x2 || h.bounds.x2 < c.x1) continue } else if ("candlestick" === p || "ohlc" === p) {
                            if (h.dataPoint.x < C.viewportMinimum || h.dataPoint.x >
                              C.viewportMaximum || Math.max.apply(null, h.dataPoint.y) < y.viewportMinimum || Math.min.apply(null, h.dataPoint.y) > y.viewportMaximum) continue
                          } else if (h.dataPoint.x < C.viewportMinimum || h.dataPoint.x > C.viewportMaximum) continue; e = l = 2; "horizontal" === x ? (u = g.width, z = g.height) : (z = g.width, u = g.height); if ("normal" === this.plotInfo.axisPlacement) {
                            if (0 <= p.indexOf("line") || 0 <= p.indexOf("area")) t = "auto", l = 4; else if (0 <= p.indexOf("stacked")) "auto" === t && (t = "inside"); else if ("bubble" === p || "scatter" === p) t = "inside"; n = h.point.x -
                              u / 2; "inside" !== t ? (e = c.y1, f = c.y2, 0 < J ? (q = h.point.y - z - l - b, q < e && (q = "auto" === t ? Math.max(h.point.y, e) + l + b : e + l + b, v = q + z > h.point.y)) : (q = h.point.y + l + b, q > f - z - l - b && (q = "auto" === t ? Math.min(h.point.y, f) - z - l - b : f - z - l - b, v = q < h.point.y))) : (e = Math.max(h.bounds.y1, c.y1), f = Math.min(h.bounds.y2, c.y2), b = 0 <= p.indexOf("range") || "error" === p ? 0 < J ? Math.max(h.bounds.y1, c.y1) + z / 2 + l : Math.min(h.bounds.y2, c.y2) - z / 2 - l : (Math.max(h.bounds.y1, c.y1) + Math.min(h.bounds.y2, c.y2)) / 2, 0 < J ? (q = Math.max(h.point.y, b) - z / 2, q < e && ("bubble" === p || "scatter" ===
                                p) && (q = Math.max(h.point.y - z - l, c.y1 + l))) : (q = Math.min(h.point.y, b) - z / 2, q > f - z - l && ("bubble" === p || "scatter" === p) && (q = Math.min(h.point.y + l, c.y2 - z - l))), q = Math.min(q, f - z))
                          } else 0 <= p.indexOf("line") || 0 <= p.indexOf("area") || 0 <= p.indexOf("scatter") ? (t = "auto", e = 4) : 0 <= p.indexOf("stacked") ? "auto" === t && (t = "inside") : "bubble" === p && (t = "inside"), q = h.point.y - z / 2, "inside" !== t ? (l = c.x1, f = c.x2, 0 > J ? (n = h.point.x - u - e - b, n < l && (n = "auto" === t ? Math.max(h.point.x, l) + e + b : l + e + b, v = n + u > h.point.x)) : (n = h.point.x + e + b, n > f - u - e - b && (n = "auto" ===
            ...
            } d = { source: d, dest: this.plotArea.ctx, animationCallback: L.fadeInAnimation, easingFunction: L.easing.easeInQuad, animationBase: 0, startTimePercent: 0.7 }; for (a = 0; a < this._indexLabels.length; a++)h = this._indexLabels[a], g = ma("indexLabelBackgroundColor", h.dataPoint, h.dataSeries), h.dataSeries.indexLabelBackgroundColor = r(g) ? s ? "transparent" : null : g; return d
          }; m.prototype.renderLine = function (a) {
            var d = a.targetCanvasCtx || this.plotArea.ctx, c = s ? this._preRenderCtx : d; if (!(0 >= a.dataSeriesIndexes.length)) {
              var b =
                this._eventManager.ghostCtx; c.save(); var e = this.plotArea; c.beginPath(); c.rect(e.x1, e.y1, e.width, e.height); c.clip(); for (var f = [], l, u = 0; u < a.dataSeriesIndexes.length; u++) {
                  var z = a.dataSeriesIndexes[u], h = this.data[z]; c.lineWidth = h.lineThickness; var p = h.dataPoints, n = "solid"; if (c.setLineDash) { var q = Q(h.nullDataLineDashType, h.lineThickness), n = h.lineDashType, g = Q(n, h.lineThickness); c.setLineDash(g) } var B = h.id; this._eventManager.objectMap[B] = { objectType: "dataSeries", dataSeriesIndex: z }; B = S(B); b.strokeStyle = B;
                  b.lineWidth = 0 < h.lineThickness ? Math.max(h.lineThickness, 4) : 0; var B = h._colorSet, k = B = h.lineColor = h.options.lineColor ? h.options.lineColor : B[0]; c.strokeStyle = B; var m = !0, t = 0, x, r; c.beginPath(); if (0 < p.length) {
                    for (var J = !1, t = 0; t < p.length; t++)if (x = p[t].x.getTime ? p[t].x.getTime() : p[t].x, !(x < a.axisX.dataInfo.viewPortMin || x > a.axisX.dataInfo.viewPortMax && (!h.connectNullData || !J))) if ("number" !== typeof p[t].y) 0 < t && !(h.connectNullData || J || m) && (c.stroke(), s && b.stroke()), J = !0; else {
                      x = a.axisX.convertValueToPixel(x); r =
                        a.axisY.convertValueToPixel(p[t].y); var C = h.dataPointIds[t]; this._eventManager.objectMap[C] = { id: C, objectType: "dataPoint", dataSeriesIndex: z, dataPointIndex: t, x1: x, y1: r }; m || J ? (!m && h.connectNullData ? (c.setLineDash && (h.options.nullDataLineDashType || n === h.lineDashType && h.lineDashType !== h.nullDataLineDashType) && (c.stroke(), c.beginPath(), c.moveTo(l.x, l.y), n = h.nullDataLineDashType, c.setLineDash(q)), c.lineTo(x, r), s && b.lineTo(x, r)) : (c.beginPath(), c.moveTo(x, r), s && (b.beginPath(), b.moveTo(x, r))), J = m = !1) : (c.lineTo(x,
                          r), s && b.lineTo(x, r), 0 == t % 500 && (c.stroke(), c.beginPath(), c.moveTo(x, r), s && (b.stroke(), b.beginPath(), b.moveTo(x, r)))); l = { x: x, y: r }; t < p.length - 1 && (k !== (p[t].lineColor || B) || n !== (p[t].lineDashType || h.lineDashType)) && (c.stroke(), c.beginPath(), c.moveTo(x, r), k = p[t].lineColor || B, c.strokeStyle = k, c.setLineDash && (p[t].lineDashType ? (n = p[t].lineDashType, c.setLineDash(Q(n, h.lineThickness))) : (n = h.lineDashType, c.setLineDash(g)))); if (0 < p[t].markerSize || 0 < h.markerSize) {
                            var y = h.getMarkerProperties(t, x, r, c); f.push(y);
                            C = S(C); s && f.push({ x: x, y: r, ctx: b, type: y.type, size: y.size, color: C, borderColor: C, borderThickness: y.borderThickness })
                          } (p[t].indexLabel || h.indexLabel || p[t].indexLabelFormatter || h.indexLabelFormatter) && this._indexLabels.push({ chartType: "line", dataPoint: p[t], dataSeries: h, point: { x: x, y: r }, direction: 0 > p[t].y === a.axisY.reversed ? 1 : -1, color: B })
                    } c.stroke(); s && b.stroke()
                  }
                } Y.drawMarkers(f); s && (d.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.globalCompositeOperation = "source-atop", a.axisX.maskCanvas &&
            ...
            var d = a.targetCanvasCtx ||
              this.plotArea.ctx, c = s ? this._preRenderCtx : d; if (!(0 >= a.dataSeriesIndexes.length)) {
                var b = this._eventManager.ghostCtx; c.save(); var e = this.plotArea; c.beginPath(); c.rect(e.x1, e.y1, e.width, e.height); c.clip(); for (var f = [], l, u = 0; u < a.dataSeriesIndexes.length; u++) {
                  var z = a.dataSeriesIndexes[u], h = this.data[z]; c.lineWidth = h.lineThickness; var p = h.dataPoints, n = "solid"; if (c.setLineDash) { var q = Q(h.nullDataLineDashType, h.lineThickness), n = h.lineDashType, g = Q(n, h.lineThickness); c.setLineDash(g) } var B = h.id; this._eventManager.objectMap[B] =
                    { objectType: "dataSeries", dataSeriesIndex: z }; B = S(B); b.strokeStyle = B; b.lineWidth = 0 < h.lineThickness ? Math.max(h.lineThickness, 4) : 0; var B = h._colorSet, k = B = h.lineColor = h.options.lineColor ? h.options.lineColor : B[0]; c.strokeStyle = B; var m = !0, t = 0, x, r; c.beginPath(); if (0 < p.length) {
            ...
            function d(a) {
              a = v(a, 2); if (0 < a.length) {
                b.beginPath(); s && e.beginPath(); b.moveTo(a[0].x, a[0].y); a[0].newStrokeStyle && (b.strokeStyle = a[0].newStrokeStyle); a[0].newLineDashArray && b.setLineDash(a[0].newLineDashArray); s && e.moveTo(a[0].x, a[0].y); for (var c = 0; c < a.length - 3; c += 3)if (b.bezierCurveTo(a[c + 1].x, a[c + 1].y, a[c + 2].x, a[c + 2].y, a[c + 3].x, a[c + 3].y), s && e.bezierCurveTo(a[c + 1].x, a[c + 1].y, a[c + 2].x, a[c + 2].y, a[c + 3].x, a[c + 3].y),
                  0 < c && 0 === c % 3E3 || a[c + 3].newStrokeStyle || a[c + 3].newLineDashArray) b.stroke(), b.beginPath(), b.moveTo(a[c + 3].x, a[c + 3].y), a[c + 3].newStrokeStyle && (b.strokeStyle = a[c + 3].newStrokeStyle), a[c + 3].newLineDashArray && b.setLineDash(a[c + 3].newLineDashArray), s && (e.stroke(), e.beginPath(), e.moveTo(a[c + 3].x, a[c + 3].y)); b.stroke(); s && e.stroke()
              }
            } var c = a.targetCanvasCtx || this.plotArea.ctx, b = s ? this._preRenderCtx : c; if (!(0 >= a.dataSeriesIndexes.length)) {
              var e = this._eventManager.ghostCtx; b.save(); var f = this.plotArea; b.beginPath();
              b.rect(f.x1, f.y1, f.width, f.height); b.clip(); for (var l = [], u = 0; u < a.dataSeriesIndexes.length; u++) {
                var z = a.dataSeriesIndexes[u], h = this.data[z]; b.lineWidth = h.lineThickness; var p = h.dataPoints, n = "solid"; if (b.setLineDash) { var q = Q(h.nullDataLineDashType, h.lineThickness), n = h.lineDashType, g = Q(n, h.lineThickness); b.setLineDash(g) } var B = h.id; this._eventManager.objectMap[B] = { objectType: "dataSeries", dataSeriesIndex: z }; B = S(B); e.strokeStyle = B; e.lineWidth = 0 < h.lineThickness ? Math.max(h.lineThickness, 4) : 0; var B = h._colorSet,
              ...
              var b = null, e = this.plotArea, f = 0, l, u, z, h = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), f = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1, p = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth : Math.min(0.15 * this.width,
                0.9 * (this.plotArea.width / a.plotType.totalDataSeries)) << 0, n = a.axisX.dataInfo.minDiff; isFinite(n) || (n = 0.3 * Math.abs(a.axisX.range)); n = this.dataPointWidth = this.options.dataPointWidth ? this.dataPointWidth : 0.9 * (e.width * (a.axisX.logarithmic ? Math.log(n) / Math.log(a.axisX.range) : Math.abs(n) / Math.abs(a.axisX.range)) / a.plotType.totalDataSeries) << 0; this.dataPointMaxWidth && f > p && (f = Math.min(this.options.dataPointWidth ? this.dataPointWidth : Infinity, p)); !this.dataPointMaxWidth && (this.dataPointMinWidth && p < f) && (p = Math.max(this.options.dataPointWidth ?
                  this.dataPointWidth : -Infinity, f)); n < f && (n = f); n > p && (n = p); c.save(); s && this._eventManager.ghostCtx.save(); c.beginPath(); c.rect(e.x1, e.y1, e.width, e.height); c.clip(); s && (this._eventManager.ghostCtx.beginPath(), this._eventManager.ghostCtx.rect(e.x1, e.y1, e.width, e.height), this._eventManager.ghostCtx.clip()); for (p = 0; p < a.dataSeriesIndexes.length; p++) {
                    var q = a.dataSeriesIndexes[p], g = this.data[q], B = g.dataPoints; if (0 < B.length) for (var k = 5 < n && g.bevelEnabled ? !0 : !1, f = 0; f < B.length; f++)if (B[f].getTime ? z = B[f].x.getTime() :
                      z = B[f].x, !(z < a.axisX.dataInfo.viewPortMin || z > a.axisX.dataInfo.viewPortMax) && "number" === typeof B[f].y) {
                        l = a.axisX.convertValueToPixel(z); u = a.axisY.convertValueToPixel(B[f].y); l = a.axisX.reversed ? l + a.plotType.totalDataSeries * n / 2 - (a.previousDataSeriesCount + p) * n << 0 : l - a.plotType.totalDataSeries * n / 2 + (a.previousDataSeriesCount + p) * n << 0; var m = a.axisX.reversed ? l - n << 0 : l + n << 0, t; 0 <= B[f].y ? t = h : (t = u, u = h); u > t && (b = u, u = t, t = b); b = B[f].color ? B[f].color : g._colorSet[f % g._colorSet.length]; da(c, l, u, m, t, b, 0, null, k && 0 <= B[f].y,
                          0 > B[f].y && k, !1, !1, g.fillOpacity); b = g.dataPointIds[f]; this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: q, dataPointIndex: f, x1: l, y1: u, x2: m, y2: t }; b = S(b); s && da(this._eventManager.ghostCtx, l, u, m, t, b, 0, null, !1, !1, !1, !1); (B[f].indexLabel || g.indexLabel || B[f].indexLabelFormatter || g.indexLabelFormatter) && this._indexLabels.push({
                            chartType: "column", dataPoint: B[f], dataSeries: g, point: { x: l + (m - l) / 2, y: 0 > B[f].y === a.axisY.reversed ? u : t }, direction: 0 > B[f].y === a.axisY.reversed ? 1 : -1, bounds: {
                              x1: l,
              ...
              var b = null, e = this.plotArea, f = [], l = [], u = [], z = [], h = 0, p, n, q = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), h = this.options.dataPointMinWidth ?
                this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1; p = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth : 0.15 * this.width << 0; var g = a.axisX.dataInfo.minDiff; isFinite(g) || (g = 0.3 * Math.abs(a.axisX.range)); g = this.options.dataPointWidth ? this.dataPointWidth : 0.9 * (e.width * (a.axisX.logarithmic ? Math.log(g) / Math.log(a.axisX.range) : Math.abs(g) / Math.abs(a.axisX.range)) / a.plotType.plotUnits.length) << 0; this.dataPointMaxWidth && h > p && (h = Math.min(this.options.dataPointWidth ?
                  this.dataPointWidth : Infinity, p)); !this.dataPointMaxWidth && (this.dataPointMinWidth && p < h) && (p = Math.max(this.options.dataPointWidth ? this.dataPointWidth : -Infinity, h)); g < h && (g = h); g > p && (g = p); c.save(); s && this._eventManager.ghostCtx.save(); c.beginPath(); c.rect(e.x1, e.y1, e.width, e.height); c.clip(); s && (this._eventManager.ghostCtx.beginPath(), this._eventManager.ghostCtx.rect(e.x1, e.y1, e.width, e.height), this._eventManager.ghostCtx.clip()); for (var B = 0; B < a.dataSeriesIndexes.length; B++) {
                    ...
                    m = this.data[k], t = m.dataPoints; if (0 < t.length) {
                      var r = 5 < g && m.bevelEnabled ? !0 : !1; c.strokeStyle = "#4572A7 "; for (h = 0; h < t.length; h++)if (b = t[h].x.getTime ? t[h].x.getTime() : t[h].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof t[h].y) {
                        p = a.axisX.convertValueToPixel(b); var A = p - a.plotType.plotUnits.length * g / 2 + a.index * g << 0, J = A + g << 0, C; if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < t[h].y) u[b] = t[h].y + (u[b] ? u[b] : 0), 0 < u[b] && (n = a.axisY.convertValueToPixel(u[b]),
                          C = "undefined" !== typeof f[b] ? f[b] : q, f[b] = n); else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= t[h].y) z[b] = t[h].y + (z[b] ? z[b] : 0), C = a.axisY.convertValueToPixel(z[b]), n = "undefined" !== typeof l[b] ? l[b] : q, l[b] = C; else if (n = a.axisY.convertValueToPixel(t[h].y), 0 <= t[h].y) { var y = "undefined" !== typeof f[b] ? f[b] : 0; n -= y; C = q - y; f[b] = y + (C - n) } else y = l[b] ? l[b] : 0, C = n + y, n = q + y, l[b] = y + (C - n); b = t[h].color ? t[h].color : m._colorSet[h % m._colorSet.length]; da(c, A, n, J, C, b, 0, null, r && 0 <= t[h].y, 0 > t[h].y && r, !1,
                            !1, m.fillOpacity); b = m.dataPointIds[h]; this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: k, dataPointIndex: h, x1: A, y1: n, x2: J, y2: C }; b = S(b); s && da(this._eventManager.ghostCtx, A, n, J, C, b, 0, null, !1, !1, !1, !1); (t[h].indexLabel || m.indexLabel || t[h].indexLabelFormatter || m.indexLabelFormatter) && this._indexLabels.push({
                              chartType: "stackedColumn", dataPoint: t[h], dataSeries: m, point: { x: p, y: 0 <= t[h].y ? n : C }, direction: 0 > t[h].y === a.axisY.reversed ? 1 : -1, bounds: {
                    ...
                    animationCallback: L.yScaleAnimation, easingFunction: L.easing.easeOutQuart, animationBase: q < a.axisY.bounds.y1 ? a.axisY.bounds.y1 : q > a.axisY.bounds.y2 ? a.axisY.bounds.y2 : q
                  }
            }
          }; m.prototype.renderStackedColumn100 = function (a) {
            var d = a.targetCanvasCtx || this.plotArea.ctx, c = s ? this._preRenderCtx : d; if (!(0 >= a.dataSeriesIndexes.length)) {
              var b = null, e = this.plotArea, f = [], l = [], u = [], z = [], h = 0, p, n, q = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), h = this.options.dataPointMinWidth ? this.dataPointMinWidth :
                this.options.dataPointWidth ? this.dataPointWidth : 1; p = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth : 0.15 * this.width << 0; var g = a.axisX.dataInfo.minDiff; isFinite(g) || (g = 0.3 * Math.abs(a.axisX.range)); g = this.options.dataPointWidth ? this.dataPointWidth : 0.9 * (e.width * (a.axisX.logarithmic ? Math.log(g) / Math.log(a.axisX.range) : Math.abs(g) / Math.abs(a.axisX.range)) / a.plotType.plotUnits.length) << 0; this.dataPointMaxWidth && h > p && (h = Math.min(this.options.dataPointWidth ?
                  this.dataPointWidth : Infinity, p)); !this.dataPointMaxWidth && (this.dataPointMinWidth && p < h) && (p = Math.max(this.options.dataPointWidth ? this.dataPointWidth : -Infinity, h)); g < h && (g = h); g > p && (g = p); c.save(); s && this._eventManager.ghostCtx.save(); c.beginPath(); c.rect(e.x1, e.y1, e.width, e.height); c.clip(); s && (this._eventManager.ghostCtx.beginPath(), this._eventManager.ghostCtx.rect(e.x1, e.y1, e.width, e.height), this._eventManager.ghostCtx.clip()); for (var B = 0; B < a.dataSeriesIndexes.length; B++) {
                    var k = a.dataSeriesIndexes[B],
                    m = this.data[k], t = m.dataPoints; if (0 < t.length) for (var r = 5 < g && m.bevelEnabled ? !0 : !1, h = 0; h < t.length; h++)if (b = t[h].x.getTime ? t[h].x.getTime() : t[h].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof t[h].y) {
                      p = a.axisX.convertValueToPixel(b); n = 0 !== a.dataPointYSums[b] ? 100 * (t[h].y / a.dataPointYSums[b]) : 0; var A = p - a.plotType.plotUnits.length * g / 2 + a.index * g << 0, J = A + g << 0, C; if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < t[h].y) {
                        u[b] = n +
                          ("undefined" !== typeof u[b] ? u[b] : 0); if (0 >= u[b]) continue; n = a.axisY.convertValueToPixel(u[b]); C = f[b] ? f[b] : q; f[b] = n
                      } else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= t[h].y) z[b] = n + ("undefined" !== typeof z[b] ? z[b] : 0), C = a.axisY.convertValueToPixel(z[b]), n = l[b] ? l[b] : q, l[b] = C; else if (n = a.axisY.convertValueToPixel(n), 0 <= t[h].y) { var y = "undefined" !== typeof f[b] ? f[b] : 0; n -= y; C = q - y; a.dataSeriesIndexes.length - 1 === B && 1 >= Math.abs(e.y1 - n) && (n = e.y1); f[b] = y + (C - n) } else y = "undefined" !== typeof l[b] ?
                        l[b] : 0, C = n + y, n = q + y, a.dataSeriesIndexes.length - 1 === B && 1 >= Math.abs(e.y2 - C) && (C = e.y2), l[b] = y + (C - n); b = t[h].color ? t[h].color : m._colorSet[h % m._colorSet.length]; da(c, A, n, J, C, b, 0, null, r && 0 <= t[h].y, 0 > t[h].y && r, !1, !1, m.fillOpacity); b = m.dataPointIds[h]; this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: k, dataPointIndex: h, x1: A, y1: n, x2: J, y2: C }; b = S(b); s && da(this._eventManager.ghostCtx, A, n, J, C, b, 0, null, !1, !1, !1, !1); (t[h].indexLabel || m.indexLabel || t[h].indexLabelFormatter || m.indexLabelFormatter) &&
                          this._indexLabels.push({ chartType: "stackedColumn100", dataPoint: t[h], dataSeries: m, point: { x: p, y: 0 <= t[h].y ? n : C }, direction: 0 > t[h].y === a.axisY.reversed ? 1 : -1, bounds: { x1: A, y1: Math.min(n, C), x2: J, y2: Math.max(n, C) }, color: b })
                    }
                    ...
                    this._breaksCanvasCtx.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.clearRect(e.x1, e.y1, e.width, e.height), this._eventManager.ghostCtx.restore()); c.restore(); return { source: d, dest: this.plotArea.ctx, animationCallback: L.yScaleAnimation, easingFunction: L.easing.easeOutQuart, animationBase: q < a.axisY.bounds.y1 ? a.axisY.bounds.y1 : q > a.axisY.bounds.y2 ? a.axisY.bounds.y2 : q }
            }
            ...
            var d = a.targetCanvasCtx || this.plotArea.ctx, c = s ? this._preRenderCtx : d; if (!(0 >= a.dataSeriesIndexes.length)) {
              ...
              c.clip(); s && (this._eventManager.ghostCtx.beginPath(), this._eventManager.ghostCtx.rect(e.x1, e.y1, e.width, e.height), this._eventManager.ghostCtx.clip()); for (p = 0; p < a.dataSeriesIndexes.length; p++) {
                var q = a.dataSeriesIndexes[p], g = this.data[q], B = g.dataPoints; if (0 < B.length) {
                  var k = 5 < n && g.bevelEnabled ? !0 : !1; c.strokeStyle = "#4572A7 "; for (f = 0; f < B.length; f++)if (B[f].getTime ? z = B[f].x.getTime() : z = B[f].x, !(z < a.axisX.dataInfo.viewPortMin || z > a.axisX.dataInfo.viewPortMax) && "number" === typeof B[f].y) {
                ...
                0, 0, this.width, this.height), a.axisY.maskCanvas && c.drawImage(a.axisY.maskCanvas, 0, 0, this.width, this.height), this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.clearRect(e.x1, e.y1, e.width, e.height), this._eventManager.ghostCtx.restore()); c.restore(); return {
                  source: d, dest: this.plotArea.ctx, animationCallback: L.xScaleAnimation, easingFunction: L.easing.easeOutQuart, animationBase: h < a.axisY.bounds.x1 ? a.axisY.bounds.x1 : h > a.axisY.bounds.x2 ? a.axisY.bounds.x2 :
                    h
                }
            }
            ...
            var d = a.targetCanvasCtx || this.plotArea.ctx, c = s ? this._preRenderCtx : d; if (!(0 >= a.dataSeriesIndexes.length)) {
              var b = null, e = this.plotArea, f = [], l = [], u = [], z = [], h = 0, p, n, q = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), h = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1; n = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth : 0.15 * this.height <<
                0; var g = a.axisX.dataInfo.minDiff; isFinite(g) || (g = 0.3 * Math.abs(a.axisX.range)); g = this.options.dataPointWidth ? this.dataPointWidth : 0.9 * (e.height * (a.axisX.logarithmic ? Math.log(g) / Math.log(a.axisX.range) : Math.abs(g) / Math.abs(a.axisX.range)) / a.plotType.plotUnits.length) << 0; this.dataPointMaxWidth && h > n && (h = Math.min(this.options.dataPointWidth ? this.dataPointWidth : Infinity, n)); !this.dataPointMaxWidth && (this.dataPointMinWidth && n < h) && (n = Math.max(this.options.dataPointWidth ? this.dataPointWidth : -Infinity, h)); g <
                  h && (g = h); g > n && (g = n); c.save(); s && this._eventManager.ghostCtx.save(); c.beginPath(); c.rect(e.x1, e.y1, e.width, e.height); c.clip(); s && (this._eventManager.ghostCtx.beginPath(), this._eventManager.ghostCtx.rect(e.x1, e.y1, e.width, e.height), this._eventManager.ghostCtx.clip()); for (var B = 0; B < a.dataSeriesIndexes.length; B++) {
                    var k = a.dataSeriesIndexes[B], m = this.data[k], t = m.dataPoints; if (0 < t.length) {
                      var r = 5 < g && m.bevelEnabled ? !0 : !1; c.strokeStyle = "#4572A7 "; for (h = 0; h < t.length; h++)if (b = t[h].x.getTime ? t[h].x.getTime() :
                        t[h].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof t[h].y) {
                          n = a.axisX.convertValueToPixel(b); var A = n - a.plotType.plotUnits.length * g / 2 + a.index * g << 0, J = A + g << 0, C; if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < t[h].y) u[b] = t[h].y + (u[b] ? u[b] : 0), 0 < u[b] && (C = f[b] ? f[b] : q, f[b] = p = a.axisY.convertValueToPixel(u[b])); else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= t[h].y) z[b] = t[h].y + (z[b] ? z[b] : 0), p = l[b] ?
                            l[b] : q, l[b] = C = a.axisY.convertValueToPixel(z[b]); else if (p = a.axisY.convertValueToPixel(t[h].y), 0 <= t[h].y) { var y = f[b] ? f[b] : 0; C = q + y; p += y; f[b] = y + (p - C) } else y = l[b] ? l[b] : 0, C = p - y, p = q - y, l[b] = y + (p - C); b = t[h].color ? t[h].color : m._colorSet[h % m._colorSet.length]; da(c, C, A, p, J, b, 0, null, r, !1, !1, !1, m.fillOpacity); b = m.dataPointIds[h]; this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: k, dataPointIndex: h, x1: C, y1: A, x2: p, y2: J }; b = S(b); s && da(this._eventManager.ghostCtx, C, A, p, J, b, 0, null, !1, !1, !1,
                              !1); (t[h].indexLabel || m.indexLabel || t[h].indexLabelFormatter || m.indexLabelFormatter) && this._indexLabels.push({ chartType: "stackedBar", dataPoint: t[h], dataSeries: m, point: { x: 0 <= t[h].y ? p : C, y: n }, direction: 0 > t[h].y === a.axisY.reversed ? 1 : -1, bounds: { x1: Math.min(C, p), y1: A, x2: Math.max(C, p), y2: J }, color: b })
                      }
                    }
            ...
            var d =
              a.targetCanvasCtx || this.plotArea.ctx, c = s ? this._preRenderCtx : d; if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                c.beginPath(); c.rect(e.x1, e.y1, e.width, e.height); c.clip(); s && (this._eventManager.ghostCtx.beginPath(), this._eventManager.ghostCtx.rect(e.x1, e.y1, e.width, e.height), this._eventManager.ghostCtx.clip()); for (var B = 0; B < a.dataSeriesIndexes.length; B++) {
                  var k = a.dataSeriesIndexes[B], m = this.data[k], t = m.dataPoints; if (0 < t.length) {
                    var r = 5 < g && m.bevelEnabled ? !0 : !1; c.strokeStyle = "#4572A7 "; for (h = 0; h < t.length; h++)if (b = t[h].x.getTime ? t[h].x.getTime() : t[h].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) &&
                      "number" === typeof t[h].y) {
                        n = a.axisX.convertValueToPixel(b); var A; A = 0 !== a.dataPointYSums[b] ? 100 * (t[h].y / a.dataPointYSums[b]) : 0; var J = n - a.plotType.plotUnits.length * g / 2 + a.index * g << 0, C = J + g << 0; if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < t[h].y) { u[b] = A + (u[b] ? u[b] : 0); if (0 >= u[b]) continue; A = f[b] ? f[b] : q; f[b] = p = a.axisY.convertValueToPixel(u[b]) } else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= t[h].y) z[b] = A + (z[b] ? z[b] : 0), p = l[b] ? l[b] :
                          ...
                          }; b = S(b); s && da(this._eventManager.ghostCtx, A, J, p, C, b, 0, null, !1, !1, !1, !1); (t[h].indexLabel || m.indexLabel || t[h].indexLabelFormatter || m.indexLabelFormatter) && this._indexLabels.push({ chartType: "stackedBar100", dataPoint: t[h], dataSeries: m, point: { x: 0 <= t[h].y ? p : A, y: n }, direction: 0 > t[h].y === a.axisY.reversed ? 1 : -1, bounds: { x1: Math.min(A, p), y1: J, x2: Math.max(A, p), y2: C }, color: b })
                    }
                  }
                } s && (d.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.globalCompositeOperation = "source-atop",
                  a.axisX.maskCanvas && c.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height), a.axisY.maskCanvas && c.drawImage(a.axisY.maskCanvas, 0, 0, this.width, this.height), this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.clearRect(e.x1, e.y1, e.width, e.height), this._eventManager.ghostCtx.restore()); c.restore(); return {
                    source: d, dest: this.plotArea.ctx, animationCallback: L.xScaleAnimation, easingFunction: L.easing.easeOutQuart, animationBase: q < a.axisY.bounds.x1 ? a.axisY.bounds.x1 :
                      q > a.axisY.bounds.x2 ? a.axisY.bounds.x2 : q
                  }
              }
          }; m.prototype.renderArea = function (a) {
            var d, c; function b() { C && (0 < g.lineThickness && f.stroke(), a.axisY.logarithmic || 0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum ? J = A : 0 > a.axisY.viewportMaximum ? J = u.y1 : 0 < a.axisY.viewportMinimum && (J = A), f.lineTo(m, J), f.lineTo(C.x, J), f.closePath(), f.globalAlpha = g.fillOpacity, f.fill(), f.globalAlpha = 1, s && (l.lineTo(m, J), l.lineTo(C.x, J), l.closePath(), l.fill()), f.beginPath(), f.moveTo(m, t), l.beginPath(), l.moveTo(m, t), C = { x: m, y: t }) }
            var e = a.targetCanvasCtx || this.plotArea.ctx, f = s ? this._preRenderCtx : e; if (!(0 >= a.dataSeriesIndexes.length)) {
              var l = this._eventManager.ghostCtx, u = a.axisY.lineCoordinates, z = [], h = this.plotArea, p; f.save(); s && l.save(); f.beginPath(); f.rect(h.x1, h.y1, h.width, h.height); f.clip(); s && (l.beginPath(), l.rect(h.x1, h.y1, h.width, h.height), l.clip()); for (var n = 0; n < a.dataSeriesIndexes.length; n++) {
                var q = a.dataSeriesIndexes[n], g = this.data[q], B = g.dataPoints, z = g.id; this._eventManager.objectMap[z] = { objectType: "dataSeries", dataSeriesIndex: q };
                z = S(z); l.fillStyle = z; z = []; d = !0; var k = 0, m, t, r, A = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), J, C = null; if (0 < B.length) {
                  var y = g._colorSet[k % g._colorSet.length], v = g.lineColor = g.options.lineColor || y, w = v; f.fillStyle = y; f.strokeStyle = v; f.lineWidth = g.lineThickness; c = "solid"; if (f.setLineDash) { var K = Q(g.nullDataLineDashType, g.lineThickness); c = g.lineDashType; var P = Q(c, g.lineThickness); f.setLineDash(P) } for (var ha = !0; k < B.length; k++)if (r = B[k].x.getTime ? B[k].x.getTime() : B[k].x, !(r < a.axisX.dataInfo.viewPortMin ||
                    r > a.axisX.dataInfo.viewPortMax && (!g.connectNullData || !ha))) if ("number" !== typeof B[k].y) g.connectNullData || (ha || d) || b(), ha = !0; else {
                      m = a.axisX.convertValueToPixel(r); t = a.axisY.convertValueToPixel(B[k].y); d || ha ? (!d && g.connectNullData ? (f.setLineDash && (g.options.nullDataLineDashType || c === g.lineDashType && g.lineDashType !== g.nullDataLineDashType) && (d = m, c = t, m = p.x, t = p.y, b(), f.moveTo(p.x, p.y), m = d, t = c, C = p, c = g.nullDataLineDashType, f.setLineDash(K)), f.lineTo(m, t), s && l.lineTo(m, t)) : (f.beginPath(), f.moveTo(m, t), s &&
                        (l.beginPath(), l.moveTo(m, t)), C = { x: m, y: t }), ha = d = !1) : (f.lineTo(m, t), s && l.lineTo(m, t), 0 == k % 250 && b()); p = { x: m, y: t }; k < B.length - 1 && (w !== (B[k].lineColor || v) || c !== (B[k].lineDashType || g.lineDashType)) && (b(), w = B[k].lineColor || v, f.strokeStyle = w, f.setLineDash && (B[k].lineDashType ? (c = B[k].lineDashType, f.setLineDash(Q(c, g.lineThickness))) : (c = g.lineDashType, f.setLineDash(P)))); var $ = g.dataPointIds[k]; this._eventManager.objectMap[$] = { id: $, objectType: "dataPoint", dataSeriesIndex: q, dataPointIndex: k, x1: m, y1: t }; 0 !== B[k].markerSize &&
                          (0 < B[k].markerSize || 0 < g.markerSize) && (r = g.getMarkerProperties(k, m, t, f), z.push(r), $ = S($), s && z.push({ x: m, y: t, ctx: l, type: r.type, size: r.size, color: $, borderColor: $, borderThickness: r.borderThickness })); (B[k].indexLabel || g.indexLabel || B[k].indexLabelFormatter || g.indexLabelFormatter) && this._indexLabels.push({ chartType: "area", dataPoint: B[k], dataSeries: g, point: { x: m, y: t }, direction: 0 > B[k].y === a.axisY.reversed ? 1 : -1, color: y })
                    } b(); Y.drawMarkers(z)
                }
        ...
        m.prototype.renderSplineArea = function (a) {
          function d() {
            var c = v(r, 2); if (0 < c.length) {
              if (0 < p.lineThickness) {
                b.beginPath(); b.moveTo(c[0].x, c[0].y); c[0].newStrokeStyle && (b.strokeStyle = c[0].newStrokeStyle); c[0].newLineDashArray && b.setLineDash(c[0].newLineDashArray); for (var d = 0; d < c.length - 3; d += 3)if (b.bezierCurveTo(c[d + 1].x, c[d + 1].y, c[d + 2].x, c[d + 2].y, c[d + 3].x, c[d + 3].y), s && e.bezierCurveTo(c[d + 1].x, c[d + 1].y, c[d + 2].x, c[d + 2].y, c[d + 3].x, c[d + 3].y), c[d + 3].newStrokeStyle || c[d + 3].newLineDashArray) b.stroke(), b.beginPath(),
                  b.moveTo(c[d + 3].x, c[d + 3].y), c[d + 3].newStrokeStyle && (b.strokeStyle = c[d + 3].newStrokeStyle), c[d + 3].newLineDashArray && b.setLineDash(c[d + 3].newLineDashArray); b.stroke()
                ...
                m = f.y1 : 0 < a.axisY.viewportMinimum && (m = k); t = { x: c[0].x, y: c[0].y }; b.lineTo(c[c.length - 1].x, m); b.lineTo(t.x, m); b.closePath(); b.globalAlpha = p.fillOpacity; b.fill(); b.globalAlpha = 1; s && (e.lineTo(c[c.length - 1].x, m), e.lineTo(t.x, m), e.closePath(), e.fill())
            }
          } var c = a.targetCanvasCtx || this.plotArea.ctx, b = s ? this._preRenderCtx : c; if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            b.clip(); s && (e.beginPath(), e.rect(u.x1, u.y1, u.width, u.height), e.clip()); for (var z = 0; z < a.dataSeriesIndexes.length; z++) {
              var h = a.dataSeriesIndexes[z], p = this.data[h], n = p.dataPoints, l = p.id; this._eventManager.objectMap[l] = { objectType: "dataSeries", dataSeriesIndex: h }; l = S(l); e.fillStyle = l; var l = [], q = 0, g, B, k = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), m, t = null, r = []; if (0 < n.length) {
                var A = p._colorSet[q % p._colorSet.length], J = p.lineColor = p.options.lineColor || A, C = J; b.fillStyle = A; b.strokeStyle =
            ...
            } s && (c.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && b.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height), a.axisY.maskCanvas && b.drawImage(a.axisY.maskCanvas, 0, 0, this.width, this.height), this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.clearRect(u.x1, u.y1, u.width, u.height), this._eventManager.ghostCtx.restore()); b.restore(); return {
              source: c,
              dest: this.plotArea.ctx, animationCallback: L.xClipAnimation, easingFunction: L.easing.linear, animationBase: 0
            }
          }
          ...
          var d, c; function b() {
            ...
            var l = this._eventManager.ghostCtx, u = a.axisY.lineCoordinates, z = [], h = this.plotArea, p; f.save(); s && l.save(); f.beginPath(); f.rect(h.x1, h.y1, h.width, h.height); f.clip(); s && (l.beginPath(), l.rect(h.x1, h.y1, h.width, h.height), l.clip()); for (var n = 0; n < a.dataSeriesIndexes.length; n++) {
              ...
              z = g.id; this._eventManager.objectMap[z] = { objectType: "dataSeries", dataSeriesIndex: q }; z = S(z); l.fillStyle = z; z = []; d = !0; var k = 0, m, t, r, A = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), J, C = null; c = !1; if (0 < B.length) {
                var y = g._colorSet[k % g._colorSet.length], v = g.lineColor = g.options.lineColor || y, w = v; f.fillStyle = y; f.strokeStyle = v; f.lineWidth = g.lineThickness; var K = "solid"; if (f.setLineDash) { var P = Q(g.nullDataLineDashType, g.lineThickness), K = g.lineDashType, D = Q(K, g.lineThickness); f.setLineDash(D) } for (; k <
                  B.length; k++)if (r = B[k].x.getTime ? B[k].x.getTime() : B[k].x, !(r < a.axisX.dataInfo.viewPortMin || r > a.axisX.dataInfo.viewPortMax && (!g.connectNullData || !c))) {
                    var $ = t; "number" !== typeof B[k].y ? (g.connectNullData || (c || d) || b(), c = !0) : (m = a.axisX.convertValueToPixel(r), t = a.axisY.convertValueToPixel(B[k].y), d || c ? (!d && g.connectNullData ? (f.setLineDash && (g.options.nullDataLineDashType || K === g.lineDashType && g.lineDashType !== g.nullDataLineDashType) && (d = m, c = t, m = p.x, t = p.y, b(), f.moveTo(p.x, p.y), m = d, t = c, C = p, K = g.nullDataLineDashType,
                      ...
                      r = g.dataPointIds[k], this._eventManager.objectMap[r] = { id: r, objectType: "dataPoint", dataSeriesIndex: q, dataPointIndex: k, x1: m, y1: t }, 0 !== B[k].markerSize && (0 < B[k].markerSize || 0 < g.markerSize) && ($ = g.getMarkerProperties(k, m, t, f), z.push($), r = S(r), s && z.push({ x: m, y: t, ctx: l, type: $.type, size: $.size, color: r, borderColor: r, borderThickness: $.borderThickness })), (B[k].indexLabel || g.indexLabel || B[k].indexLabelFormatter || g.indexLabelFormatter) && this._indexLabels.push({
          ...
          function d() { if (!(1 > h.length)) { for (0 < y.lineThickness && b.stroke(); 0 < h.length;) { var a = h.pop(); b.lineTo(a.x, a.y); s && r.lineTo(a.x, a.y) } b.closePath(); b.globalAlpha = y.fillOpacity; b.fill(); b.globalAlpha = 1; b.beginPath(); s && (r.closePath(), r.fill(), r.beginPath()); h = [] } } var c = a.targetCanvasCtx || this.plotArea.ctx, b = s ? this._preRenderCtx :
            c; if (!(0 >= a.dataSeriesIndexes.length)) {
              var e = null, f = null, l = [], u = this.plotArea, z = [], h = [], p = [], n = [], q = 0, g, k, m = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), r = this._eventManager.ghostCtx, t, x, A; s && r.beginPath(); b.save(); s && r.save(); b.beginPath(); b.rect(u.x1, u.y1, u.width, u.height); b.clip(); s && (r.beginPath(), r.rect(u.x1, u.y1, u.width, u.height), r.clip()); for (var e = [], J = 0; J < a.dataSeriesIndexes.length; J++) {
                var C = a.dataSeriesIndexes[J], y = this.data[C], v = y.dataPoints; y.dataPointIndexes =
                  []; for (q = 0; q < v.length; q++)C = v[q].x.getTime ? v[q].x.getTime() : v[q].x, y.dataPointIndexes[C] = q, e[C] || (p.push(C), e[C] = !0); p.sort(Pa)
              } for (J = 0; J < a.dataSeriesIndexes.length; J++) {
                C = a.dataSeriesIndexes[J]; y = this.data[C]; v = y.dataPoints; x = !0; h = []; q = y.id; this._eventManager.objectMap[q] = { objectType: "dataSeries", dataSeriesIndex: C }; q = S(q); r.fillStyle = q; if (0 < p.length) {
                  var e = y._colorSet[0], w = y.lineColor = y.options.lineColor || e, K = w; b.fillStyle = e; b.strokeStyle = w; b.lineWidth = y.lineThickness; A = "solid"; if (b.setLineDash) {
                    var P =
                      Q(y.nullDataLineDashType, y.lineThickness); A = y.lineDashType; var D = Q(A, y.lineThickness); b.setLineDash(D)
                  } for (var $ = !0, q = 0; q < p.length; q++) {
                    var f = p[q], ia = null, ia = 0 <= y.dataPointIndexes[f] ? v[y.dataPointIndexes[f]] : { x: f, y: null }; if (!(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax && (!y.connectNullData || !$))) if ("number" !== typeof ia.y) y.connectNullData || ($ || x) || d(), $ = !0; else {
                      g = a.axisX.convertValueToPixel(f); var na = z[f] ? z[f] : 0; if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length) {
                        n[f] =
                        ia.y + (n[f] ? n[f] : 0); if (0 >= n[f] && a.axisY.logarithmic) continue; k = a.axisY.convertValueToPixel(n[f])
                      } else k = a.axisY.convertValueToPixel(ia.y), k -= na; h.push({ x: g, y: m - na }); z[f] = m - k; x || $ ? (!x && y.connectNullData ? (b.setLineDash && (y.options.nullDataLineDashType || A === y.lineDashType && y.lineDashType !== y.nullDataLineDashType) && (x = h.pop(), A = h[h.length - 1], d(), b.moveTo(t.x, t.y), h.push(A), h.push(x), A = y.nullDataLineDashType, b.setLineDash(P)), b.lineTo(g, k), s && r.lineTo(g, k)) : (b.beginPath(), b.moveTo(g, k), s && (r.beginPath(),
                        r.moveTo(g, k))), $ = x = !1) : (b.lineTo(g, k), s && r.lineTo(g, k), 0 == q % 250 && (d(), b.moveTo(g, k), s && r.moveTo(g, k), h.push({ x: g, y: m - na }))); t = { x: g, y: k }; q < v.length - 1 && (K !== (v[q].lineColor || w) || A !== (v[q].lineDashType || y.lineDashType)) && (d(), b.beginPath(), b.moveTo(g, k), h.push({ x: g, y: m - na }), K = v[q].lineColor || w, b.strokeStyle = K, b.setLineDash && (v[q].lineDashType ? (A = v[q].lineDashType, b.setLineDash(Q(A, y.lineThickness))) : (A = y.lineDashType, b.setLineDash(D)))); if (0 <= y.dataPointIndexes[f]) {
                          ...
                          this._eventManager.objectMap[E] = { id: E, objectType: "dataPoint", dataSeriesIndex: C, dataPointIndex: y.dataPointIndexes[f], x1: g, y1: k }
                        } 0 <= y.dataPointIndexes[f] && 0 !== ia.markerSize && (0 < ia.markerSize || 0 < y.markerSize) && (na = y.getMarkerProperties(y.dataPointIndexes[f], g, k, b), l.push(na), f = S(E), s && l.push({ x: g, y: k, ctx: r, type: na.type, size: na.size, color: f, borderColor: f, borderThickness: na.borderThickness })); (ia.indexLabel || y.indexLabel || ia.indexLabelFormatter || y.indexLabelFormatter) && this._indexLabels.push({
                          chartType: "stackedArea",
                          dataPoint: ia, dataSeries: y, point: { x: g, y: k }, direction: 0 > v[q].y === a.axisY.reversed ? 1 : -1, color: e
                        })
                    }
                  } d(); b.moveTo(g, k); s && r.moveTo(g, k)
                } delete y.dataPointIndexes
              } Y.drawMarkers(l); s && (c.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && b.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height), a.axisY.maskCanvas && b.drawImage(a.axisY.maskCanvas, 0, 0, this.width, this.height), this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas,
                0, 0, this.width, this.height), b.clearRect(u.x1, u.y1, u.width, u.height), r.restore()); b.restore(); return { source: c, dest: this.plotArea.ctx, animationCallback: L.xClipAnimation, easingFunction: L.easing.linear, animationBase: 0 }
            }
        }; m.prototype.renderStackedArea100 = function (a) {
          function d() { for (0 < y.lineThickness && b.stroke(); 0 < h.length;) { var a = h.pop(); b.lineTo(a.x, a.y); s && A.lineTo(a.x, a.y) } b.closePath(); b.globalAlpha = y.fillOpacity; b.fill(); b.globalAlpha = 1; b.beginPath(); s && (A.closePath(), A.fill(), A.beginPath()); h = [] }
          var c = a.targetCanvasCtx || this.plotArea.ctx, b = s ? this._preRenderCtx : c; if (!(0 >= a.dataSeriesIndexes.length)) {
            var e = null, f = null, l = this.plotArea, u = [], k = [], h = [], p = [], n = [], q = 0, g, m, r, O, t, x = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), A = this._eventManager.ghostCtx; b.save(); s && A.save(); b.beginPath(); b.rect(l.x1, l.y1, l.width, l.height); b.clip(); s && (A.beginPath(), A.rect(l.x1, l.y1, l.width, l.height), A.clip()); for (var e = [], v = 0; v < a.dataSeriesIndexes.length; v++) {
              ...
              y = this.data[C], w = y.dataPoints; y.dataPointIndexes = []; for (q = 0; q < w.length; q++)C = w[q].x.getTime ? w[q].x.getTime() : w[q].x, y.dataPointIndexes[C] = q, e[C] || (p.push(C), e[C] = !0); p.sort(Pa)
            } for (v = 0; v < a.dataSeriesIndexes.length; v++) {
              C = a.dataSeriesIndexes[v]; y = this.data[C]; w = y.dataPoints; O = !0; e = y.id; this._eventManager.objectMap[e] = { objectType: "dataSeries", dataSeriesIndex: C }; e = S(e); A.fillStyle = e; h = []; if (0 < p.length) {
                var e = y._colorSet[q % y._colorSet.length], D = y.lineColor = y.options.lineColor || e, K = D; b.fillStyle = e; b.strokeStyle =
                  D; b.lineWidth = y.lineThickness; t = "solid"; if (b.setLineDash) { var P = Q(y.nullDataLineDashType, y.lineThickness); t = y.lineDashType; var E = Q(t, y.lineThickness); b.setLineDash(E) } for (var $ = !0, q = 0; q < p.length; q++) {
                    var f = p[q], ia = null, ia = 0 <= y.dataPointIndexes[f] ? w[y.dataPointIndexes[f]] : { x: f, y: null }; if (!(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax && (!y.connectNullData || !$))) if ("number" !== typeof ia.y) y.connectNullData || ($ || O) || d(), $ = !0; else {
                      var na; na = 0 !== a.dataPointYSums[f] ? 100 * (ia.y / a.dataPointYSums[f]) :
                      ...
                      (ia.indexLabel || y.indexLabel || ia.indexLabelFormatter || y.indexLabelFormatter) && this._indexLabels.push({ chartType: "stackedArea100", dataPoint: ia, dataSeries: y, point: { x: g, y: m }, direction: 0 > w[q].y === a.axisY.reversed ? 1 : -1, color: e })
                    }
                  } d(); b.moveTo(g, m); s && A.moveTo(g, m)
              } delete y.dataPointIndexes
            } Y.drawMarkers(u); s && (c.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && b.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height), a.axisY.maskCanvas &&
              b.drawImage(a.axisY.maskCanvas, 0, 0, this.width, this.height), this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.clearRect(l.x1, l.y1, l.width, l.height), A.restore()); b.restore(); return { source: c, dest: this.plotArea.ctx, animationCallback: L.xClipAnimation, easingFunction: L.easing.linear, animationBase: 0 }
          }
              ...
              this.plotArea, e = 0, f, l; c.save(); s && this._eventManager.ghostCtx.save(); c.beginPath(); c.rect(b.x1, b.y1, b.width, b.height); c.clip(); s && (this._eventManager.ghostCtx.beginPath(), this._eventManager.ghostCtx.rect(b.x1, b.y1, b.width, b.height), this._eventManager.ghostCtx.clip()); for (var u = -Infinity, k = Infinity, h = 0; h < a.dataSeriesIndexes.length; h++)for (var p = a.dataSeriesIndexes[h], n = this.data[p], q = n.dataPoints, g = 0, e = 0; e < q.length; e++)f = q[e].getTime ? f = q[e].x.getTime() : f = q[e].x, f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax ||
                "undefined" === typeof q[e].z || (g = q[e].z, g > u && (u = g), g < k && (k = g)); for (var m = 25 * Math.PI, r = Math.max(Math.pow(0.25 * Math.min(b.height, b.width) / 2, 2) * Math.PI, m), h = 0; h < a.dataSeriesIndexes.length; h++)if (p = a.dataSeriesIndexes[h], n = this.data[p], q = n.dataPoints, 0 < q.length) for (c.strokeStyle = "#4572A7 ", e = 0; e < q.length; e++)if (f = q[e].getTime ? f = q[e].x.getTime() : f = q[e].x, !(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax) && "number" === typeof q[e].y) {
                  ...
                  var g = q[e].z, O = 2 * Math.max(Math.sqrt((u === k ? r / 2 : m + (r - m) / (u - k) * (g - k)) / Math.PI) << 0, 1), g = n.getMarkerProperties(e, c); g.size = O; c.globalAlpha = n.fillOpacity; Y.drawMarker(f, l, c, g.type, g.size, g.color, g.borderColor, g.borderThickness); c.globalAlpha = 1; var t = n.dataPointIds[e]; this._eventManager.objectMap[t] = { id: t, objectType: "dataPoint", dataSeriesIndex: p, dataPointIndex: e, x1: f, y1: l, size: O }; O = S(t); s && Y.drawMarker(f, l, this._eventManager.ghostCtx, g.type, g.size, O, O, g.borderThickness); (q[e].indexLabel || n.indexLabel ||
                    q[e].indexLabelFormatter || n.indexLabelFormatter) && this._indexLabels.push({ chartType: "bubble", dataPoint: q[e], dataSeries: n, point: { x: f, y: l }, direction: 1, bounds: { x1: f - g.size / 2, y1: l - g.size / 2, x2: f + g.size / 2, y2: l + g.size / 2 }, color: null })
                } s && (d.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && c.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height), a.axisY.maskCanvas && c.drawImage(a.axisY.maskCanvas, 0, 0, this.width, this.height), this._breaksCanvasCtx &&
                  this._breaksCanvasCtx.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.clearRect(b.x1, b.y1, b.width, b.height), this._eventManager.ghostCtx.restore()); c.restore(); return { source: d, dest: this.plotArea.ctx, animationCallback: L.fadeInAnimation, easingFunction: L.easing.easeInQuad, animationBase: 0 }
          }
        }; m.prototype.renderScatter = function (a) {
          var d = a.targetCanvasCtx || this.plotArea.ctx, c = s ? this._preRenderCtx : d; if (!(0 >= a.dataSeriesIndexes.length)) {
            var b = this.plotArea, e = 0, f, l; c.save(); s && this._eventManager.ghostCtx.save();
            c.beginPath(); c.rect(b.x1, b.y1, b.width, b.height); c.clip(); s && (this._eventManager.ghostCtx.beginPath(), this._eventManager.ghostCtx.rect(b.x1, b.y1, b.width, b.height), this._eventManager.ghostCtx.clip()); for (var u = 0; u < a.dataSeriesIndexes.length; u++) {
              var k = a.dataSeriesIndexes[u], h = this.data[k], p = h.dataPoints; if (0 < p.length) {
                c.strokeStyle = "#4572A7 "; Math.pow(0.3 * Math.min(b.height, b.width) / 2, 2); for (var n = 0, q = 0, e = 0; e < p.length; e++)if (f = p[e].getTime ? f = p[e].x.getTime() : f = p[e].x, !(f < a.axisX.dataInfo.viewPortMin ||
                  f > a.axisX.dataInfo.viewPortMax) && "number" === typeof p[e].y) {
                    f = a.axisX.convertValueToPixel(f); l = a.axisY.convertValueToPixel(p[e].y); var g = h.getMarkerProperties(e, f, l, c); c.globalAlpha = h.fillOpacity; Y.drawMarker(g.x, g.y, g.ctx, g.type, g.size, g.color, g.borderColor, g.borderThickness); c.globalAlpha = 1; Math.sqrt((n - f) * (n - f) + (q - l) * (q - l)) < Math.min(g.size, 5) && p.length > Math.min(this.plotArea.width, this.plotArea.height) || (n = h.dataPointIds[e], this._eventManager.objectMap[n] = {
                      id: n, objectType: "dataPoint", dataSeriesIndex: k,
                      dataPointIndex: e, x1: f, y1: l
                    }, n = S(n), s && Y.drawMarker(g.x, g.y, this._eventManager.ghostCtx, g.type, g.size, n, n, g.borderThickness), (p[e].indexLabel || h.indexLabel || p[e].indexLabelFormatter || h.indexLabelFormatter) && this._indexLabels.push({ chartType: "scatter", dataPoint: p[e], dataSeries: h, point: { x: f, y: l }, direction: 1, bounds: { x1: f - g.size / 2, y1: l - g.size / 2, x2: f + g.size / 2, y2: l + g.size / 2 }, color: null }), n = f, q = l)
                }
              }
            } s && (d.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.globalCompositeOperation = "source-atop",
          ...
          function (a) {
            var d = a.targetCanvasCtx || this.plotArea.ctx, c = s ? this._preRenderCtx : d, b = this._eventManager.ghostCtx; if (!(0 >= a.dataSeriesIndexes.length)) {
              var e = null, f = null, l = this.plotArea, u = 0, k, h, p, n, q, g, e = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1, f = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth : 0.015 * this.width, m = a.axisX.dataInfo.minDiff; isFinite(m) || (m = 0.3 * Math.abs(a.axisX.range)); m = this.options.dataPointWidth ?
                this.dataPointWidth : 0.7 * l.width * (a.axisX.logarithmic ? Math.log(m) / Math.log(a.axisX.range) : Math.abs(m) / Math.abs(a.axisX.range)) << 0; this.dataPointMaxWidth && e > f && (e = Math.min(this.options.dataPointWidth ? this.dataPointWidth : Infinity, f)); !this.dataPointMaxWidth && (this.dataPointMinWidth && f < e) && (f = Math.max(this.options.dataPointWidth ? this.dataPointWidth : -Infinity, e)); m < e && (m = e); m > f && (m = f); c.save(); s && b.save(); c.beginPath(); c.rect(l.x1, l.y1, l.width, l.height); c.clip(); s && (b.beginPath(), b.rect(l.x1, l.y1, l.width,
                  l.height), b.clip()); for (var ga = 0; ga < a.dataSeriesIndexes.length; ga++) {
                    var O = a.dataSeriesIndexes[ga], t = this.data[O], x = t.dataPoints; if (0 < x.length) for (var A = 5 < m && t.bevelEnabled ? !0 : !1, u = 0; u < x.length; u++)if (x[u].getTime ? g = x[u].x.getTime() : g = x[u].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax) && !r(x[u].y) && x[u].y.length && "number" === typeof x[u].y[0] && "number" === typeof x[u].y[1] && "number" === typeof x[u].y[2] && "number" === typeof x[u].y[3]) {
                      k = a.axisX.convertValueToPixel(g); h = a.axisY.convertValueToPixel(x[u].y[0]);
                      ...
                      c.lineWidth = y; b.lineWidth = Math.max(y, 4); "candlestick" === t.type ? (c.moveTo(k - w, p), c.lineTo(k - w, Math.min(h, q)), c.stroke(), c.moveTo(k - w, Math.max(h, q)), c.lineTo(k - w, n), c.stroke(), da(c, v, Math.min(h, q), C, Math.max(h, q), x[u].y[0] <= x[u].y[3] ? t.risingColor : f, y, e, A, A, !1, !1, t.fillOpacity), s && (e = S(D), b.strokeStyle = e, b.moveTo(k - w, p), b.lineTo(k - w, Math.min(h, q)), b.stroke(), b.moveTo(k - w, Math.max(h, q)), b.lineTo(k - w, n), b.stroke(), da(b, v, Math.min(h, q), C, Math.max(h, q), e, 0, null, !1, !1, !1, !1))) : "ohlc" === t.type && (c.moveTo(k -
                        w, p), c.lineTo(k - w, n), c.stroke(), c.beginPath(), c.moveTo(k, h), c.lineTo(v, h), c.stroke(), c.beginPath(), c.moveTo(k, q), c.lineTo(C, q), c.stroke(), s && (e = S(D), b.strokeStyle = e, b.moveTo(k - w, p), b.lineTo(k - w, n), b.stroke(), b.beginPath(), b.moveTo(k, h), b.lineTo(v, h), b.stroke(), b.beginPath(), b.moveTo(k, q), b.lineTo(C, q), b.stroke())); (x[u].indexLabel || t.indexLabel || x[u].indexLabelFormatter || t.indexLabelFormatter) && this._indexLabels.push({
                          chartType: t.type, dataPoint: x[u], dataSeries: t, point: {
                            x: v + (C - v) / 2, y: a.axisY.reversed ?
                              n : p
                          }, direction: 1, bounds: { x1: v, y1: Math.min(p, n), x2: C, y2: Math.max(p, n) }, color: e
                        })
                    }
            ...
            var d = a.targetCanvasCtx || this.plotArea.ctx, c = s ? this._preRenderCtx : d, b = this._eventManager.ghostCtx; if (!(0 >= a.dataSeriesIndexes.length)) {
              var e = null, f = this.plotArea, l = 0, u, k, h, p, n, q, g, e = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1, l = this.options.dataPointMaxWidth ?
                this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth : 0.015 * this.width, m = a.axisX.dataInfo.minDiff; isFinite(m) || (m = 0.3 * Math.abs(a.axisX.range)); m = this.options.dataPointWidth ? this.dataPointWidth : 0.7 * f.width * (a.axisX.logarithmic ? Math.log(m) / Math.log(a.axisX.range) : Math.abs(m) / Math.abs(a.axisX.range)) << 0; this.dataPointMaxWidth && e > l && (e = Math.min(this.options.dataPointWidth ? this.dataPointWidth : Infinity, l)); !this.dataPointMaxWidth && (this.dataPointMinWidth && l < e) && (l = Math.max(this.options.dataPointWidth ?
                  this.dataPointWidth : -Infinity, e)); m < e && (m = e); m > l && (m = l); c.save(); s && b.save(); c.beginPath(); c.rect(f.x1, f.y1, f.width, f.height); c.clip(); s && (b.beginPath(), b.rect(f.x1, f.y1, f.width, f.height), b.clip()); for (var ga = !1, ga = !!a.axisY.reversed, O = 0; O < a.dataSeriesIndexes.length; O++) {
                    var t = a.dataSeriesIndexes[O], x = this.data[t], A = x.dataPoints; if (0 < A.length) for (var v = 5 < m && x.bevelEnabled ? !0 : !1, l = 0; l < A.length; l++)if (A[l].getTime ? g = A[l].x.getTime() : g = A[l].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax) &&
                      !r(A[l].y) && A[l].y.length && "number" === typeof A[l].y[0] && "number" === typeof A[l].y[1] && "number" === typeof A[l].y[2] && "number" === typeof A[l].y[3] && "number" === typeof A[l].y[4] && 5 === A[l].y.length) {
                        u = a.axisX.convertValueToPixel(g); k = a.axisY.convertValueToPixel(A[l].y[0]); h = a.axisY.convertValueToPixel(A[l].y[1]); p = a.axisY.convertValueToPixel(A[l].y[2]); n = a.axisY.convertValueToPixel(A[l].y[3]); q = a.axisY.convertValueToPixel(A[l].y[4]); var C = u - m / 2 << 0, y = u + m / 2 << 0, e = A[l].color ? A[l].color : x._colorSet[0], w = Math.round(Math.max(1,
                          0.15 * m)), D = 0 === w % 2 ? 0 : 0.5, K = A[l].whiskerColor ? A[l].whiskerColor : A[l].color ? x.whiskerColor ? x.whiskerColor : A[l].color : x.whiskerColor ? x.whiskerColor : e, P = "number" === typeof A[l].whiskerThickness ? A[l].whiskerThickness : "number" === typeof x.options.whiskerThickness ? x.whiskerThickness : w, E = A[l].whiskerDashType ? A[l].whiskerDashType : x.whiskerDashType, $ = r(A[l].whiskerLength) ? r(x.options.whiskerLength) ? m : x.whiskerLength : A[l].whiskerLength, $ = "number" === typeof $ ? 0 >= $ ? 0 : $ >= m ? m : $ : "string" === typeof $ ? parseInt($) * m / 100 >
                            m ? m : parseInt($) * m / 100 : m, ia = 1 === Math.round(P) % 2 ? 0.5 : 0, na = A[l].stemColor ? A[l].stemColor : A[l].color ? x.stemColor ? x.stemColor : A[l].color : x.stemColor ? x.stemColor : e, ca = "number" === typeof A[l].stemThickness ? A[l].stemThickness : "number" === typeof x.options.stemThickness ? x.stemThickness : w, F = 1 === Math.round(ca) % 2 ? 0.5 : 0, I = A[l].stemDashType ? A[l].stemDashType : x.stemDashType, G = A[l].lineColor ? A[l].lineColor : A[l].color ? x.lineColor ? x.lineColor : A[l].color : x.lineColor ? x.lineColor : e, N = "number" === typeof A[l].lineThickness ?
                              A[l].lineThickness : "number" === typeof x.options.lineThickness ? x.lineThickness : w, T = A[l].lineDashType ? A[l].lineDashType : x.lineDashType, M = 1 === Math.round(N) % 2 ? 0.5 : 0, W = x.upperBoxColor, xa = x.lowerBoxColor, sa = r(x.options.fillOpacity) ? 1 : x.fillOpacity, R = x.dataPointIds[l]; this._eventManager.objectMap[R] = {
                                id: R, objectType: "dataPoint", dataSeriesIndex: t, dataPointIndex: l, x1: C, y1: k, x2: y, y2: h, x3: u, y3: p, x4: u, y4: n, y5: q, borderThickness: w, color: e, stemThickness: ca, stemColor: na, whiskerThickness: P, whiskerLength: $, whiskerColor: K,
                                lineThickness: N, lineColor: G
                              }; c.save(); 0 < ca && (c.beginPath(), c.strokeStyle = na, c.lineWidth = ca, c.setLineDash && c.setLineDash(Q(I, ca)), c.moveTo(u - F, h), c.lineTo(u - F, k), c.stroke(), c.moveTo(u - F, n), c.lineTo(u - F, p), c.stroke()); c.restore(); b.lineWidth = Math.max(w, 4); c.beginPath(); da(c, C, Math.min(q, h), y, Math.max(h, q), xa, 0, e, ga ? v : !1, ga ? !1 : v, !1, !1, sa); c.beginPath(); da(c, C, Math.min(p, q), y, Math.max(q, p), W, 0, e, ga ? !1 : v, ga ? v : !1, !1, !1, sa); c.beginPath(); c.lineWidth = w; c.strokeStyle = e; c.rect(C - D, Math.min(h, p) - D, y - C + 2 * D, Math.max(h,
                                p) - Math.min(h, p) + 2 * D); c.stroke(); c.save(); 0 < N && (c.beginPath(), c.globalAlpha = 1, c.setLineDash && c.setLineDash(Q(T, N)), c.strokeStyle = G, c.lineWidth = N, c.moveTo(C, q - M), c.lineTo(y, q - M), c.stroke()); c.restore(); c.save(); 0 < P && (c.beginPath(), c.setLineDash && c.setLineDash(Q(E, P)), c.strokeStyle = K, c.lineWidth = P, c.moveTo(u - $ / 2 << 0, n - ia), c.lineTo(u + $ / 2 << 0, n - ia), c.stroke(), c.moveTo(u - $ / 2 << 0, k + ia), c.lineTo(u + $ / 2 << 0, k + ia), c.stroke()); c.restore(); s && (e = S(R), b.strokeStyle = e, b.lineWidth = ca, 0 < ca && (b.moveTo(u - D - F, h), b.lineTo(u -
                                  D - F, Math.max(k, n)), b.stroke(), b.moveTo(u - D - F, Math.min(k, n)), b.lineTo(u - D - F, p), b.stroke()), da(b, C, Math.max(h, p), y, Math.min(h, p), e, 0, null, !1, !1, !1, !1), 0 < P && (b.beginPath(), b.lineWidth = P, b.moveTo(u + $ / 2, n - ia), b.lineTo(u - $ / 2, n - ia), b.stroke(), b.moveTo(u + $ / 2, k + ia), b.lineTo(u - $ / 2, k + ia), b.stroke())); (A[l].indexLabel || x.indexLabel || A[l].indexLabelFormatter || x.indexLabelFormatter) && this._indexLabels.push({
                                    chartType: x.type, dataPoint: A[l], dataSeries: x, point: { x: C + (y - C) / 2, y: a.axisY.reversed ? k : n }, direction: 1, bounds: {
                                      x1: C,
                    ...
                    source: d,
                    dest: this.plotArea.ctx, animationCallback: L.fadeInAnimation, easingFunction: L.easing.easeInQuad, animationBase: 0
                  }
            }
          }; m.prototype.renderRangeColumn = function (a) {
            var d = a.targetCanvasCtx || this.plotArea.ctx, c = s ? this._preRenderCtx : d; if (!(0 >= a.dataSeriesIndexes.length)) {
              var b = null, e = this.plotArea, f = 0, l, u, k, f = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1; l = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth :
                0.03 * this.width; var h = a.axisX.dataInfo.minDiff; isFinite(h) || (h = 0.3 * Math.abs(a.axisX.range)); h = this.options.dataPointWidth ? this.dataPointWidth : 0.9 * (e.width * (a.axisX.logarithmic ? Math.log(h) / Math.log(a.axisX.range) : Math.abs(h) / Math.abs(a.axisX.range)) / a.plotType.totalDataSeries) << 0; this.dataPointMaxWidth && f > l && (f = Math.min(this.options.dataPointWidth ? this.dataPointWidth : Infinity, l)); !this.dataPointMaxWidth && (this.dataPointMinWidth && l < f) && (l = Math.max(this.options.dataPointWidth ? this.dataPointWidth : -Infinity,
                  f)); h < f && (h = f); h > l && (h = l); c.save(); s && this._eventManager.ghostCtx.save(); c.beginPath(); c.rect(e.x1, e.y1, e.width, e.height); c.clip(); s && (this._eventManager.ghostCtx.beginPath(), this._eventManager.ghostCtx.rect(e.x1, e.y1, e.width, e.height), this._eventManager.ghostCtx.clip()); for (var p = 0; p < a.dataSeriesIndexes.length; p++) {
                    var n = a.dataSeriesIndexes[p], q = this.data[n], g = q.dataPoints; if (0 < g.length) for (var m = 5 < h && q.bevelEnabled ? !0 : !1, f = 0; f < g.length; f++)if (g[f].getTime ? k = g[f].x.getTime() : k = g[f].x, !(k < a.axisX.dataInfo.viewPortMin ||
                      k > a.axisX.dataInfo.viewPortMax) && !r(g[f].y) && g[f].y.length && "number" === typeof g[f].y[0] && "number" === typeof g[f].y[1]) {
                        b = a.axisX.convertValueToPixel(k); l = a.axisY.convertValueToPixel(g[f].y[0]); u = a.axisY.convertValueToPixel(g[f].y[1]); var ga = a.axisX.reversed ? b + a.plotType.totalDataSeries * h / 2 - (a.previousDataSeriesCount + p) * h << 0 : b - a.plotType.totalDataSeries * h / 2 + (a.previousDataSeriesCount + p) * h << 0, O = a.axisX.reversed ? ga - h << 0 : ga + h << 0, b = g[f].color ? g[f].color : q._colorSet[f % q._colorSet.length]; if (l > u) {
                          var t = l;
                          l = u; u = t
                        } t = q.dataPointIds[f]; this._eventManager.objectMap[t] = { id: t, objectType: "dataPoint", dataSeriesIndex: n, dataPointIndex: f, x1: ga, y1: l, x2: O, y2: u }; da(c, ga, l, O, u, b, 0, b, m, m, !1, !1, q.fillOpacity); b = S(t); s && da(this._eventManager.ghostCtx, ga, l, O, u, b, 0, null, !1, !1, !1, !1); if (g[f].indexLabel || q.indexLabel || g[f].indexLabelFormatter || q.indexLabelFormatter) this._indexLabels.push({
                          chartType: "rangeColumn", dataPoint: g[f], dataSeries: q, indexKeyword: 0, point: { x: ga + (O - ga) / 2, y: g[f].y[1] >= g[f].y[0] ? u : l }, direction: g[f].y[1] >=
                            g[f].y[0] ? -1 : 1, bounds: { x1: ga, y1: Math.min(l, u), x2: O, y2: Math.max(l, u) }, color: b
                        }), this._indexLabels.push({ chartType: "rangeColumn", dataPoint: g[f], dataSeries: q, indexKeyword: 1, point: { x: ga + (O - ga) / 2, y: g[f].y[1] >= g[f].y[0] ? l : u }, direction: g[f].y[1] >= g[f].y[0] ? 1 : -1, bounds: { x1: ga, y1: Math.min(l, u), x2: O, y2: Math.max(l, u) }, color: b })
                    }
            ...
            var d = a.targetCanvasCtx || this.plotArea.ctx, c = s ? this._preRenderCtx :
              d, b = a.axisY._position ? "left" === a.axisY._position || "right" === a.axisY._position ? !1 : !0 : !1; if (!(0 >= a.dataSeriesIndexes.length)) {
                var e = null, f = !1, l = this.plotArea, u = 0, k, h, p, n, q, g, m, ga = a.axisX.dataInfo.minDiff; isFinite(ga) || (ga = 0.3 * Math.abs(a.axisX.range)); c.save(); s && this._eventManager.ghostCtx.save(); c.beginPath(); c.rect(l.x1, l.y1, l.width, l.height); c.clip(); s && (this._eventManager.ghostCtx.beginPath(), this._eventManager.ghostCtx.rect(l.x1, l.y1, l.width, l.height), this._eventManager.ghostCtx.clip()); for (var O =
                  0, t = 0; t < this.data.length; t++)!this.data[t].type.match(/(bar|column)/ig) || !this.data[t].visible || this.data[t].type.match(/(stacked)/ig) && O || O++; for (var x = 0; x < a.dataSeriesIndexes.length; x++) {
                    var A = a.dataSeriesIndexes[x], v = this.data[A], C = v.dataPoints, y = r(v._linkedSeries) ? !1 : v._linkedSeries.type.match(/(bar|column)/ig) && v._linkedSeries.visible ? !0 : !1, D = 0; if (y) for (e = v._linkedSeries.id, t = 0; t < e; t++)!this.data[t].type.match(/(bar|column)/ig) || !this.data[t].visible || this.data[t].type.match(/(stacked)/ig) &&
                        ...
                        (y ? O : 1))) << 0 : 0.03 * this.width); t = this.options.dataPointWidth ? this.dataPointWidth : 0.9 * ((b ? l.height : l.width) * (a.axisX.logarithmic ? Math.log(ga) / Math.log(a.axisX.range) : Math.abs(ga) / Math.abs(a.axisX.range)) / (y ? O : 1)) << 0; this.dataPointMaxWidth && e > u && (e = Math.min(this.options.dataPointWidth ? this.dataPointWidth : Infinity, u)); !this.dataPointMaxWidth && (this.dataPointMinWidth && u < e) && (u = Math.max(this.options.dataPointWidth ? this.dataPointWidth : -Infinity, e)); t < e && (t = e); t > u && (t = u); if (0 < C.length) for (var E = v._colorSet,
                          u = 0; u < C.length; u++) {
                            var e = v.lineColor = v.options.color ? v.options.color : E[0], K = {
                              color: C[u].whiskerColor ? C[u].whiskerColor : C[u].color ? v.whiskerColor ? v.whiskerColor : C[u].color : v.whiskerColor ? v.whiskerColor : e, thickness: r(C[u].whiskerThickness) ? v.whiskerThickness : C[u].whiskerThickness, dashType: C[u].whiskerDashType ? C[u].whiskerDashType : v.whiskerDashType, length: r(C[u].whiskerLength) ? r(v.options.whiskerLength) ? t : v.options.whiskerLength : C[u].whiskerLength, trimLength: r(C[u].whiskerLength) ? r(v.options.whiskerLength) ?
                                50 : 0 : 0
                            }; K.length = "number" === typeof K.length ? 0 >= K.length ? 0 : K.length >= t ? t : K.length : "string" === typeof K.length ? parseInt(K.length) * t / 100 > t ? t : parseInt(K.length) * t / 100 > t : t; K.thickness = "number" === typeof K.thickness ? 0 > K.thickness ? 0 : Math.round(K.thickness) : 2; var P = { color: C[u].stemColor ? C[u].stemColor : C[u].color ? v.stemColor ? v.stemColor : C[u].color : v.stemColor ? v.stemColor : e, thickness: C[u].stemThickness ? C[u].stemThickness : v.stemThickness, dashType: C[u].stemDashType ? C[u].stemDashType : v.stemDashType }; P.thickness =
                              "number" === typeof P.thickness ? 0 > P.thickness ? 0 : Math.round(P.thickness) : 2; C[u].getTime ? m = C[u].x.getTime() : m = C[u].x; if (!(m < a.axisX.dataInfo.viewPortMin || m > a.axisX.dataInfo.viewPortMax) && !r(C[u].y) && C[u].y.length && "number" === typeof C[u].y[0] && "number" === typeof C[u].y[1]) {
                                var ha = a.axisX.convertValueToPixel(m); b ? h = ha : k = ha; ha = a.axisY.convertValueToPixel(C[u].y[0]); b ? p = ha : q = ha; ha = a.axisY.convertValueToPixel(C[u].y[1]); b ? n = ha : g = ha; b ? (q = a.axisX.reversed ? h + (y ? O : 1) * t / 2 - (y ? D - 1 : 0) * t << 0 : h - (y ? O : 1) * t / 2 + (y ? D - 1 : 0) *
                                  t << 0, g = a.axisX.reversed ? q - t << 0 : q + t << 0) : (p = a.axisX.reversed ? k + (y ? O : 1) * t / 2 - (y ? D - 1 : 0) * t << 0 : k - (y ? O : 1) * t / 2 + (y ? D - 1 : 0) * t << 0, n = a.axisX.reversed ? p - t << 0 : p + t << 0); !b && q > g && (ha = q, q = g, g = ha); b && p > n && (ha = p, p = n, n = ha); ha = v.dataPointIds[u]; this._eventManager.objectMap[ha] = { id: ha, objectType: "dataPoint", dataSeriesIndex: A, dataPointIndex: u, x1: Math.min(p, n), y1: Math.min(q, g), x2: Math.max(n, p), y2: Math.max(g, q), isXYSwapped: b, stemProperties: P, whiskerProperties: K }; w(c, Math.min(p, n), Math.min(q, g), Math.max(n, p), Math.max(g, q), e,
                                    K, P, b); s && w(this._eventManager.ghostCtx, p, q, n, g, e, K, P, b); if (C[u].indexLabel || v.indexLabel || C[u].indexLabelFormatter || v.indexLabelFormatter) this._indexLabels.push({ chartType: "error", dataPoint: C[u], dataSeries: v, indexKeyword: 0, point: { x: b ? C[u].y[1] >= C[u].y[0] ? p : n : p + (n - p) / 2, y: b ? q + (g - q) / 2 : C[u].y[1] >= C[u].y[0] ? g : q }, direction: C[u].y[1] >= C[u].y[0] ? -1 : 1, bounds: { x1: b ? Math.min(p, n) : p, y1: b ? q : Math.min(q, g), x2: b ? Math.max(p, n) : n, y2: b ? g : Math.max(q, g) }, color: e, axisSwapped: b }), this._indexLabels.push({
                                      chartType: "error",
                                      dataPoint: C[u], dataSeries: v, indexKeyword: 1, point: { x: b ? C[u].y[1] >= C[u].y[0] ? n : p : p + (n - p) / 2, y: b ? q + (g - q) / 2 : C[u].y[1] >= C[u].y[0] ? q : g }, direction: C[u].y[1] >= C[u].y[0] ? 1 : -1, bounds: { x1: b ? Math.min(p, n) : p, y1: b ? q : Math.min(q, g), x2: b ? Math.max(p, n) : n, y2: b ? g : Math.max(q, g) }, color: e, axisSwapped: b
                                    })
                              }
                        }
                    ...
                    0, 0, this.width, this.height), this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.clearRect(l.x1, l.y1, l.width, l.height), this._eventManager.ghostCtx.restore()); c.restore(); return { source: d, dest: this.plotArea.ctx, animationCallback: L.fadeInAnimation, easingFunction: L.easing.easeInQuad, animationBase: 0 }
              }
              ...
              var b =
                null, e = this.plotArea, f = 0, l, u, k, h, f = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1; l = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth : Math.min(0.15 * this.height, 0.9 * (this.plotArea.height / a.plotType.totalDataSeries)) << 0; var p = a.axisX.dataInfo.minDiff; isFinite(p) || (p = 0.3 * Math.abs(a.axisX.range)); p = this.options.dataPointWidth ? this.dataPointWidth : 0.9 * (e.height * (a.axisX.logarithmic ? Math.log(p) / Math.log(a.axisX.range) :
                  Math.abs(p) / Math.abs(a.axisX.range)) / a.plotType.totalDataSeries) << 0; this.dataPointMaxWidth && f > l && (f = Math.min(this.options.dataPointWidth ? this.dataPointWidth : Infinity, l)); !this.dataPointMaxWidth && (this.dataPointMinWidth && l < f) && (l = Math.max(this.options.dataPointWidth ? this.dataPointWidth : -Infinity, f)); p < f && (p = f); p > l && (p = l); c.save(); s && this._eventManager.ghostCtx.save(); c.beginPath(); c.rect(e.x1, e.y1, e.width, e.height); c.clip(); s && (this._eventManager.ghostCtx.beginPath(), this._eventManager.ghostCtx.rect(e.x1,
                    e.y1, e.width, e.height), this._eventManager.ghostCtx.clip()); for (var n = 0; n < a.dataSeriesIndexes.length; n++) {
                      var q = a.dataSeriesIndexes[n], g = this.data[q], m = g.dataPoints; if (0 < m.length) {
                        var ga = 5 < p && g.bevelEnabled ? !0 : !1; c.strokeStyle = "#4572A7 "; for (f = 0; f < m.length; f++)if (m[f].getTime ? h = m[f].x.getTime() : h = m[f].x, !(h < a.axisX.dataInfo.viewPortMin || h > a.axisX.dataInfo.viewPortMax) && !r(m[f].y) && m[f].y.length && "number" === typeof m[f].y[0] && "number" === typeof m[f].y[1]) {
                          l = a.axisY.convertValueToPixel(m[f].y[0]); u = a.axisY.convertValueToPixel(m[f].y[1]);
                          k = a.axisX.convertValueToPixel(h); k = a.axisX.reversed ? k + a.plotType.totalDataSeries * p / 2 - (a.previousDataSeriesCount + n) * p << 0 : k - a.plotType.totalDataSeries * p / 2 + (a.previousDataSeriesCount + n) * p << 0; var v = a.axisX.reversed ? k - p << 0 : k + p << 0; l > u && (b = l, l = u, u = b); b = m[f].color ? m[f].color : g._colorSet[f % g._colorSet.length]; da(c, l, k, u, v, b, 0, null, ga, !1, !1, !1, g.fillOpacity); b = g.dataPointIds[f]; this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: q, dataPointIndex: f, x1: l, y1: k, x2: u, y2: v }; b = S(b); s && da(this._eventManager.ghostCtx,
                            l, k, u, v, b, 0, null, !1, !1, !1, !1); if (m[f].indexLabel || g.indexLabel || m[f].indexLabelFormatter || g.indexLabelFormatter) this._indexLabels.push({ chartType: "rangeBar", dataPoint: m[f], dataSeries: g, indexKeyword: 0, point: { x: m[f].y[1] >= m[f].y[0] ? l : u, y: k + (v - k) / 2 }, direction: m[f].y[1] >= m[f].y[0] ? -1 : 1, bounds: { x1: Math.min(l, u), y1: k, x2: Math.max(l, u), y2: v }, color: b }), this._indexLabels.push({
                              chartType: "rangeBar", dataPoint: m[f], dataSeries: g, indexKeyword: 1, point: { x: m[f].y[1] >= m[f].y[0] ? u : l, y: k + (v - k) / 2 }, direction: m[f].y[1] >=
                                m[f].y[0] ? 1 : -1, bounds: { x1: Math.min(l, u), y1: k, x2: Math.max(l, u), y2: v }, color: b
                            })
                        }
                      }
            ...
            function d() {
              if (x) {
                for (var a = null, c = k.length - 1; 0 <= c; c--)a = k[c], b.lineTo(a.x, a.y2), e.lineTo(a.x, a.y2); b.closePath(); b.globalAlpha = p.fillOpacity; b.fill(); b.globalAlpha = 1; e.fill(); if (0 < p.lineThickness) {
                  b.beginPath(); b.moveTo(a.x, a.y2); for (c = 0; c < k.length; c++)a = k[c], b.lineTo(a.x, a.y2); b.moveTo(k[0].x, k[0].y1); for (c = 0; c < k.length; c++)a =
                    k[c], b.lineTo(a.x, a.y1); b.stroke()
                } b.beginPath(); b.moveTo(m, r); e.beginPath(); e.moveTo(m, r); x = { x: m, y: r }; k = []; k.push({ x: m, y1: r, y2: v })
              }
            } var c = a.targetCanvasCtx || this.plotArea.ctx, b = s ? this._preRenderCtx : c; if (!(0 >= a.dataSeriesIndexes.length)) {
              var e = this._eventManager.ghostCtx, f = [], l = this.plotArea; b.save(); s && e.save(); b.beginPath(); b.rect(l.x1, l.y1, l.width, l.height); b.clip(); s && (e.beginPath(), e.rect(l.x1, l.y1, l.width, l.height), e.clip()); for (var u = 0; u < a.dataSeriesIndexes.length; u++) {
                var k = [], h = a.dataSeriesIndexes[u],
                p = this.data[h], n = p.dataPoints, f = p.id; this._eventManager.objectMap[f] = { objectType: "dataSeries", dataSeriesIndex: h }; f = S(f); e.fillStyle = f; var f = [], q = !0, g = 0, m, r, v, t, x = null; if (0 < n.length) {
                  var A = p._colorSet[g % p._colorSet.length], w = p.lineColor = p.options.lineColor || A, C = w; b.fillStyle = A; b.strokeStyle = w; b.lineWidth = p.lineThickness; var y = "solid"; if (b.setLineDash) { var D = Q(p.nullDataLineDashType, p.lineThickness), y = p.lineDashType, E = Q(y, p.lineThickness); b.setLineDash(E) } for (var K = !0; g < n.length; g++)if (t = n[g].x.getTime ?
                    n[g].x.getTime() : n[g].x, !(t < a.axisX.dataInfo.viewPortMin || t > a.axisX.dataInfo.viewPortMax && (!p.connectNullData || !K))) if (null !== n[g].y && n[g].y.length && "number" === typeof n[g].y[0] && "number" === typeof n[g].y[1]) {
                      m = a.axisX.convertValueToPixel(t); r = a.axisY.convertValueToPixel(n[g].y[0]); v = a.axisY.convertValueToPixel(n[g].y[1]); q || K ? (p.connectNullData && !q ? (b.setLineDash && (p.options.nullDataLineDashType || y === p.lineDashType && p.lineDashType !== p.nullDataLineDashType) && (k[k.length - 1].newLineDashArray = E, y = p.nullDataLineDashType,
                        b.setLineDash(D)), b.lineTo(m, r), s && e.lineTo(m, r), k.push({ x: m, y1: r, y2: v })) : (b.beginPath(), b.moveTo(m, r), x = { x: m, y: r }, k = [], k.push({ x: m, y1: r, y2: v }), s && (e.beginPath(), e.moveTo(m, r))), K = q = !1) : (b.lineTo(m, r), k.push({ x: m, y1: r, y2: v }), s && e.lineTo(m, r), 0 == g % 250 && d()); t = p.dataPointIds[g]; this._eventManager.objectMap[t] = { id: t, objectType: "dataPoint", dataSeriesIndex: h, dataPointIndex: g, x1: m, y1: r, y2: v }; g < n.length - 1 && (C !== (n[g].lineColor || w) || y !== (n[g].lineDashType || p.lineDashType)) && (d(), C = n[g].lineColor || w, k[k.length -
                          1].newStrokeStyle = C, b.strokeStyle = C, b.setLineDash && (n[g].lineDashType ? (y = n[g].lineDashType, k[k.length - 1].newLineDashArray = Q(y, p.lineThickness), b.setLineDash(k[k.length - 1].newLineDashArray)) : (y = p.lineDashType, k[k.length - 1].newLineDashArray = E, b.setLineDash(E)))); if (0 !== n[g].markerSize && (0 < n[g].markerSize || 0 < p.markerSize)) {
                            var P = p.getMarkerProperties(g, m, v, b); f.push(P); var ha = S(t); s && f.push({ x: m, y: v, ctx: e, type: P.type, size: P.size, color: ha, borderColor: ha, borderThickness: P.borderThickness }); P = p.getMarkerProperties(g,
                              m, r, b); f.push(P); ha = S(t); s && f.push({ x: m, y: r, ctx: e, type: P.type, size: P.size, color: ha, borderColor: ha, borderThickness: P.borderThickness })
                          } if (n[g].indexLabel || p.indexLabel || n[g].indexLabelFormatter || p.indexLabelFormatter) this._indexLabels.push({ chartType: "rangeArea", dataPoint: n[g], dataSeries: p, indexKeyword: 0, point: { x: m, y: r }, direction: n[g].y[0] > n[g].y[1] === a.axisY.reversed ? -1 : 1, color: A }), this._indexLabels.push({
                            chartType: "rangeArea", dataPoint: n[g], dataSeries: p, indexKeyword: 1, point: { x: m, y: v }, direction: n[g].y[0] >
                              n[g].y[1] === a.axisY.reversed ? 1 : -1, color: A
                          })
                    } else K || q || d(), K = !0; d(); Y.drawMarkers(f)
                }
            ...
            function d(a, c) {
              var d = v(r, 2); if (0 < d.length) {
                if (0 < h.lineThickness) {
                  ...
                  d[f - 2].y, d[f - 3].x, d[f - 3].y), s && e.bezierCurveTo(d[f - 1].x, d[f - 1].y, d[f - 2].x, d[f - 2].y, d[f - 3].x, d[f - 3].y); b.closePath(); b.globalAlpha = h.fillOpacity; b.fill(); s && (e.closePath(), e.fill()); b.globalAlpha = 1; if (0 < h.lineThickness) {
              ...
              this.plotArea.ctx, b = s ? this._preRenderCtx : c; if (!(0 >= a.dataSeriesIndexes.length)) {
                var e = this._eventManager.ghostCtx, f = [], l = this.plotArea; b.save(); s && e.save(); b.beginPath(); b.rect(l.x1, l.y1, l.width, l.height); b.clip(); s && (e.beginPath(), e.rect(l.x1, l.y1, l.width, l.height), e.clip()); for (var k = 0; k < a.dataSeriesIndexes.length; k++) {
                  var m = a.dataSeriesIndexes[k], h = this.data[m], p = h.dataPoints, f = h.id; this._eventManager.objectMap[f] = { objectType: "dataSeries", dataSeriesIndex: m }; f = S(f); e.fillStyle = f; var f = [], n = 0, q,
                    g, B, r = [], O = []; if (0 < p.length) {
                      var t = h._colorSet[n % h._colorSet.length], x = h.lineColor = h.options.lineColor || t, A = x; b.fillStyle = t; b.lineWidth = h.lineThickness; var w = "solid", C; if (b.setLineDash) { var y = Q(h.nullDataLineDashType, h.lineThickness), w = h.lineDashType; C = Q(w, h.lineThickness) } for (g = !1; n < p.length; n++)if (q = p[n].x.getTime ? p[n].x.getTime() : p[n].x, !(q < a.axisX.dataInfo.viewPortMin || q > a.axisX.dataInfo.viewPortMax && (!h.connectNullData || !g))) if (null !== p[n].y && p[n].y.length && "number" === typeof p[n].y[0] && "number" ===
                        typeof p[n].y[1]) {
                          q = a.axisX.convertValueToPixel(q); g = a.axisY.convertValueToPixel(p[n].y[0]); B = a.axisY.convertValueToPixel(p[n].y[1]); var D = h.dataPointIds[n]; this._eventManager.objectMap[D] = { id: D, objectType: "dataPoint", dataSeriesIndex: m, dataPointIndex: n, x1: q, y1: g, y2: B }; r[r.length] = { x: q, y: g }; O[O.length] = { x: q, y: B }; n < p.length - 1 && (A !== (p[n].lineColor || x) || w !== (p[n].lineDashType || h.lineDashType)) && (A = p[n].lineColor || x, r[r.length - 1].newStrokeStyle = A, b.setLineDash && (p[n].lineDashType ? (w = p[n].lineDashType,
                            r[r.length - 1].newLineDashArray = Q(w, h.lineThickness)) : (w = h.lineDashType, r[r.length - 1].newLineDashArray = C))); if (0 !== p[n].markerSize && (0 < p[n].markerSize || 0 < h.markerSize)) { var E = h.getMarkerProperties(n, q, g, b); f.push(E); var K = S(D); s && f.push({ x: q, y: g, ctx: e, type: E.type, size: E.size, color: K, borderColor: K, borderThickness: E.borderThickness }); E = h.getMarkerProperties(n, q, B, b); f.push(E); K = S(D); s && f.push({ x: q, y: B, ctx: e, type: E.type, size: E.size, color: K, borderColor: K, borderThickness: E.borderThickness }) } if (p[n].indexLabel ||
                              h.indexLabel || p[n].indexLabelFormatter || h.indexLabelFormatter) this._indexLabels.push({ chartType: "rangeSplineArea", dataPoint: p[n], dataSeries: h, indexKeyword: 0, point: { x: q, y: g }, direction: p[n].y[0] <= p[n].y[1] ? -1 : 1, color: t }), this._indexLabels.push({ chartType: "rangeSplineArea", dataPoint: p[n], dataSeries: h, indexKeyword: 1, point: { x: q, y: B }, direction: p[n].y[0] <= p[n].y[1] ? 1 : -1, color: t }); g = !1
                      } else 0 < n && !g && (h.connectNullData ? b.setLineDash && (0 < r.length && (h.options.nullDataLineDashType || !p[n - 1].lineDashType)) && (r[r.length -
                        1].newLineDashArray = y, w = h.nullDataLineDashType) : (d(C, x), r = [], O = [])), g = !0; d(C, x); Y.drawMarkers(f)
                    }
            ...
            var d = a.targetCanvasCtx || this.plotArea.ctx, c = s ? this._preRenderCtx : d; if (!(0 >= a.dataSeriesIndexes.length)) {
              var b = this._eventManager.ghostCtx, e = null, f = this.plotArea, l = 0, k, m, h, p, n = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), l = this.options.dataPointMinWidth ? this.dataPointMinWidth :
                        ...
                        k = a.axisX.convertValueToPixel(p); m = 0 === v.dataPointEOs[l].cumulativeSum ? n : a.axisY.convertValueToPixel(v.dataPointEOs[l].cumulativeSum); h = 0 === v.dataPointEOs[l].cumulativeSumYStartValue ? n : a.axisY.convertValueToPixel(v.dataPointEOs[l].cumulativeSumYStartValue); k = a.axisX.reversed ? k + a.plotType.totalDataSeries * q / 2 - (a.previousDataSeriesCount + g) * q << 0 : k - a.plotType.totalDataSeries * q / 2 + (a.previousDataSeriesCount +
                          g) * q << 0; var E = a.axisX.reversed ? k - q << 0 : k + q << 0; m > h && (e = m, m = h, h = e); a.axisY.reversed && (e = m, m = h, h = e); e = v.dataPointIds[l]; this._eventManager.objectMap[e] = { id: e, objectType: "dataPoint", dataSeriesIndex: r, dataPointIndex: l, x1: k, y1: m, x2: E, y2: h }; var K = O[l].color ? O[l].color : 0 < O[l].y ? v.risingColor : v.fallingColor; da(c, k, m, E, h, K, 0, K, A, A, !1, !1, v.fillOpacity); e = S(e); s && da(this._eventManager.ghostCtx, k, m, E, h, e, 0, null, !1, !1, !1, !1); var P, K = k; P = "undefined" !== typeof O[l].isIntermediateSum && !0 === O[l].isIntermediateSum || "undefined" !==
                            typeof O[l].isCumulativeSum && !0 === O[l].isCumulativeSum ? 0 < O[l].y ? m : h : 0 < O[l].y ? h : m; 0 < l && C && (!w || v.connectNullData) && (w && c.setLineDash && c.setLineDash(Q(D, t)), c.beginPath(), c.moveTo(C, y - x), c.lineTo(K, P - x), 0 < t && c.stroke(), s && (b.beginPath(), b.moveTo(C, y - x), b.lineTo(K, P - x), 0 < t && b.stroke())); w = !1; C = E; y = 0 < O[l].y ? m : h; K = O[l].lineDashType ? O[l].lineDashType : v.options.lineDashType ? v.options.lineDashType : "shortDash"; c.strokeStyle = O[l].lineColor ? O[l].lineColor : v.options.lineColor ? v.options.lineColor : "#9e9e9e"; c.lineWidth =
                              t; c.setLineDash && (K = Q(K, t), c.setLineDash(K)); (O[l].indexLabel || v.indexLabel || O[l].indexLabelFormatter || v.indexLabelFormatter) && this._indexLabels.push({ chartType: "waterfall", dataPoint: O[l], dataSeries: v, point: { x: k + (E - k) / 2, y: 0 <= O[l].y ? m : h }, direction: 0 > O[l].y === a.axisY.reversed ? 1 : -1, bounds: { x1: k, y1: Math.min(m, h), x2: E, y2: Math.max(m, h) }, color: e })
                      }
                  } s && (d.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && c.drawImage(a.axisX.maskCanvas,
            ...
            function d() {
              if (h &&
                p) {
                  for (var a = 0, b = 0, c = 0, d = 0, e = 0; e < p.length; e++) {
                    var f = p[e], l = h.dataPointIds[e]; g[e].id = l; g[e].objectType = "dataPoint"; g[e].dataPointIndex = e; g[e].dataSeriesIndex = 0; var n = g[e], k = { percent: null, total: null }, u = null, k = m.getPercentAndTotal(h, f); if (h.indexLabelFormatter || f.indexLabelFormatter) u = { chart: m.options, dataSeries: h, dataPoint: f, total: k.total, percent: k.percent }; k = f.indexLabelFormatter ? f.indexLabelFormatter(u) : f.indexLabel ? m.replaceKeywordsWithValue(f.indexLabel, f, h, e) : h.indexLabelFormatter ? h.indexLabelFormatter(u) :
                    ...
                    n.startAngle = (n.startAngle + 2 * Math.PI) % (2 * Math.PI); n.endAngle = n.startAngle + 2 * Math.PI / w * Math.abs(f.y); f = (n.endAngle + n.startAngle) / 2; f = (f + 2 * Math.PI) % (2 * Math.PI); n.midAngle = f; if (n.midAngle > Math.PI / 2 - t && n.midAngle < Math.PI / 2 + t) { if (0 === a || g[c].midAngle > n.midAngle) c = e; a++ } else if (n.midAngle > 3 * Math.PI / 2 - t && n.midAngle < 3 * Math.PI / 2 + t) { if (0 === b || g[d].midAngle > n.midAngle) d = e; b++ } n.hemisphere = f > Math.PI / 2 && f <= 3 * Math.PI / 2 ? "left" : "right"; n.indexLabelTextBlock = new la(m.plotArea.ctx, {
                      fontSize: n.indexLabelFontSize, fontFamily: n.indexLabelFontFamily,
                      fontColor: n.indexLabelFontColor, fontStyle: n.indexLabelFontStyle, fontWeight: n.indexLabelFontWeight, horizontalAlign: "left", backgroundColor: n.indexLabelBackgroundColor, maxWidth: n.indexLabelMaxWidth, maxHeight: n.indexLabelWrap ? 5 * n.indexLabelFontSize : 1.5 * n.indexLabelFontSize, text: n.indexLabelText, padding: 0, textBaseline: "top"
                    }); n.indexLabelTextBlock.measureText()
                  } l = f = 0; k = !1; for (e = 0; e < p.length; e++)n = g[(c + e) % p.length], 1 < a && (n.midAngle > Math.PI / 2 - t && n.midAngle < Math.PI / 2 + t) && (f <= a / 2 && !k ? (n.hemisphere = "right",
                    f++) : (n.hemisphere = "left", k = !0)); k = !1; for (e = 0; e < p.length; e++)n = g[(d + e) % p.length], 1 < b && (n.midAngle > 3 * Math.PI / 2 - t && n.midAngle < 3 * Math.PI / 2 + t) && (l <= b / 2 && !k ? (n.hemisphere = "left", l++) : (n.hemisphere = "right", k = !0))
              }
            } function c(a) {
              var b = m.plotArea.ctx; b.clearRect(q.x1, q.y1, q.width, q.height); b.fillStyle = m.backgroundColor; b.fillRect(q.x1, q.y1, q.width, q.height); for (b = 0; b < p.length; b++) {
                var c = g[b].startAngle, d = g[b].endAngle; if (d > c) {
                  var e = 0.07 * y * Math.cos(g[b].midAngle), f = 0.07 * y * Math.sin(g[b].midAngle), l = !1; if (p[b].exploded) {
                    if (1E-9 <
                      Math.abs(g[b].center.x - (A.x + e)) || 1E-9 < Math.abs(g[b].center.y - (A.y + f))) g[b].center.x = A.x + e * a, g[b].center.y = A.y + f * a, l = !0
                  } else if (0 < Math.abs(g[b].center.x - A.x) || 0 < Math.abs(g[b].center.y - A.y)) g[b].center.x = A.x + e * (1 - a), g[b].center.y = A.y + f * (1 - a), l = !0; l && (e = {}, e.dataSeries = h, e.dataPoint = h.dataPoints[b], e.index = b, m.toolTip.highlightObjects([e])); Z(m.plotArea.ctx, g[b].center, g[b].radius, p[b].color ? p[b].color : h._colorSet[b % h._colorSet.length], h.type, c, d, h.fillOpacity, g[b].percentInnerRadius)
                }
              } a = m.plotArea.ctx;
              ...
              for (var c = null, d = 1; d < p.length; d++)if (c = (a + d + g.length) % g.length, g[c].hemisphere !== g[a].hemisphere) { c = null; break } else if (g[c].indexLabelText && c !==
                a && (0 > b(g[c], g[a]) || ("right" === g[a].hemisphere ? g[c].indexLabelTextBlock.y >= g[a].indexLabelTextBlock.y : g[c].indexLabelTextBlock.y <= g[a].indexLabelTextBlock.y))) break; else c = null; return c
            } function f(a, c, d) {
              d = (d || 0) + 1; if (1E3 < d) return 0; c = c || 0; var h = 0, l = A.y - 1 * s, n = A.y + 1 * s; if (0 <= a && a < p.length) {
                var m = g[a]; if (0 > c && m.indexLabelTextBlock.y < l || 0 < c && m.indexLabelTextBlock.y > n) return 0; var k = 0, q = 0, q = k = k = 0; 0 > c ? m.indexLabelTextBlock.y - m.indexLabelTextBlock.height / 2 > l && m.indexLabelTextBlock.y - m.indexLabelTextBlock.height /
              ...
              var a = m.plotArea.ctx; a.fillStyle = "grey"; a.strokeStyle = "grey"; a.font = "16px Arial"; a.textBaseline =
                "middle"; for (var c = a = 0, d = 0, l = !0, c = 0; 10 > c && (1 > c || 0 < d); c++) {
                  if (h.radius || !h.radius && "undefined" !== typeof h.innerRadius && null !== h.innerRadius && y - d <= D) l = !1; l && (y -= d); d = 0; if ("inside" !== h.indexLabelPlacement) {
                    s = y * v; for (a = 0; a < p.length; a++) { var k = g[a]; k.indexLabelTextBlock.x = A.x + s * Math.cos(k.midAngle); k.indexLabelTextBlock.y = A.y + s * Math.sin(k.midAngle); k.indexLabelAngle = k.midAngle; k.radius = y; k.percentInnerRadius = E } for (var u, t, a = 0; a < p.length; a++) {
                      var k = g[a], r = e(a); if (null !== r) {
                        u = g[a]; t = g[r]; var C = 0, C = b(u, t) -
                    ...
                    t = A.y + s * Math.sin(k.midAngle), k.indexLabelTextBlock.x = r, k.indexLabelTextBlock.y = t; for (a = 0; a < p.length; a++)if (k = g[a], r = k.indexLabelTextBlock.measureText(), 0 !== r.height && 0 !== r.width) r = r = 0, "right" === k.hemisphere ? (r = q.x2 - (k.indexLabelTextBlock.x + k.indexLabelTextBlock.width + n), r *= -1) : r = q.x1 - (k.indexLabelTextBlock.x - k.indexLabelTextBlock.width - n), 0 < r && (!l && k.indexLabelText && (t = "right" === k.hemisphere ? q.x2 - k.indexLabelTextBlock.x : k.indexLabelTextBlock.x - q.x1, 0.3 * k.indexLabelTextBlock.maxWidth > t ? k.indexLabelText =
                      "" : k.indexLabelTextBlock.maxWidth = 0.85 * t, 0.3 * k.indexLabelTextBlock.maxWidth < t && (k.indexLabelTextBlock.x -= "right" === k.hemisphere ? 2 : -2)), Math.abs(k.indexLabelTextBlock.y - k.indexLabelTextBlock.height / 2 - A.y) < y || Math.abs(k.indexLabelTextBlock.y + k.indexLabelTextBlock.height / 2 - A.y) < y) && (r /= Math.abs(Math.cos(k.indexLabelAngle)), 9 < r && (r *= 0.3), r > d && (d = r)), r = r = 0, 0 < k.indexLabelAngle && k.indexLabelAngle < Math.PI ? (r = q.y2 - (k.indexLabelTextBlock.y + k.indexLabelTextBlock.height / 2 + 5), r *= -1) : r = q.y1 - (k.indexLabelTextBlock.y -
                        k.indexLabelTextBlock.height / 2 - 5), 0 < r && (!l && k.indexLabelText && (t = 0 < k.indexLabelAngle && k.indexLabelAngle < Math.PI ? -1 : 1, 0 === f(a, r * t) && f(a, 2 * t)), Math.abs(k.indexLabelTextBlock.x - A.x) < y && (r /= Math.abs(Math.sin(k.indexLabelAngle)), 9 < r && (r *= 0.3), r > d && (d = r))); var G = function (a, b, c) {
                          for (var d = [], e = 0; d.push(g[b]), b !== c; b = (b + 1 + p.length) % p.length); d.sort(function (a, b) { return a.y - b.y }); for (b = 0; b < d.length; b++)if (c = d[b], e < 0.7 * a) e += c.indexLabelTextBlock.height, c.indexLabelTextBlock.text = "", c.indexLabelText = "", c.indexLabelTextBlock.measureText();
                          else break
                        }; (function () {
                          for (var a = -1, c = -1, d = 0, f = !1, h = 0; h < p.length; h++)if (f = !1, u = g[h], u.indexLabelText) {
                            var l = e(h); if (null !== l) {
                              var k = g[l]; C = 0; C = b(u, k); var m; if (m = 0 > C) {
                                m = u.indexLabelTextBlock.x; var q = u.indexLabelTextBlock.y - u.indexLabelTextBlock.height / 2, t = u.indexLabelTextBlock.y + u.indexLabelTextBlock.height / 2, r = k.indexLabelTextBlock.y - k.indexLabelTextBlock.height / 2, z = k.indexLabelTextBlock.x + k.indexLabelTextBlock.width, B = k.indexLabelTextBlock.y + k.indexLabelTextBlock.height / 2; m = u.indexLabelTextBlock.x +
                                  u.indexLabelTextBlock.width < k.indexLabelTextBlock.x - n || m > z + n || q > B + n || t < r - n ? !1 : !0
                              } m ? (0 > a && (a = h), l !== a && (c = l, d += -C), 0 === h % Math.max(p.length / 10, 3) && (f = !0)) : f = !0; f && (0 < d && 0 <= a && 0 <= c) && (G(d, a, c), c = a = -1, d = 0)
                            }
                          } 0 < d && G(d, a, c)
                        })()
                }
            } function k() {
              m.plotArea.layoutManager.reset(); m.title && (m.title.dockInsidePlotArea || "center" === m.title.horizontalAlign && "center" === m.title.verticalAlign) && m.title.render(); if (m.subtitles) for (var a = 0; a < m.subtitles.length; a++) {
                var b = m.subtitles[a]; (b.dockInsidePlotArea || "center" ===
              ...
              var h = this.data[a.dataSeriesIndexes[0]], p = h.dataPoints, n = 10, q = this.plotArea, g = h.dataPointEOs, B = 2, s, v = 1.3, t = 20 / 180 * Math.PI, x = 6, A = { x: (q.x2 + q.x1) / 2, y: (q.y2 + q.y1) / 2 }, w = 0; a = !1; for (var C = 0; C < p.length; C++)w += Math.abs(p[C].y), !a && ("undefined" !== typeof p[C].indexLabel &&
                null !== p[C].indexLabel && 0 < p[C].indexLabel.toString().length) && (a = !0), !a && ("undefined" !== typeof p[C].label && null !== p[C].label && 0 < p[C].label.toString().length) && (a = !0); if (0 !== w) {
                  a = a || "undefined" !== typeof h.indexLabel && null !== h.indexLabel && 0 < h.indexLabel.toString().length; var y = "inside" !== h.indexLabelPlacement && a ? 0.75 * Math.min(q.width, q.height) / 2 : 0.92 * Math.min(q.width, q.height) / 2; h.radius && (y = Ra(h.radius, y)); var D = "undefined" !== typeof h.innerRadius && null !== h.innerRadius ? Ra(h.innerRadius, y) : 0.7 * y; h.radius =
                    y; "doughnut" === h.type && (h.innerRadius = D); var E = Math.min(D / y, (y - 1) / y); this.pieDoughnutClickHandler = function (a) { m.isAnimating || !r(a.dataSeries.explodeOnClick) && !a.dataSeries.explodeOnClick || (a = a.dataPoint, a.exploded = a.exploded ? !1 : !0, 1 < this.dataPoints.length && m._animator.animate(0, 500, function (a) { c(a); k() })) }; d(); l(); l(); l(); l(); this.disableToolTip = !0; this._animator.animate(0, this.animatedRender ? this.animationDuration : 0, function (a) {
                      var b = m.plotArea.ctx; b.clearRect(q.x1, q.y1, q.width, q.height); b.fillStyle =
                    ...
                    }, function () { m.disableToolTip = !1; m._animator.animate(0, m.animatedRender ? 500 : 0, function (a) { c(a); k() }) })
                }
            }
            ...
            function d() {
              for (var a =
                0, b = [], c = 0; c < x.length; c++) { if ("undefined" === typeof x[c].y) return -1; x[c].y = "number" === typeof x[c].y ? x[c].y : 0; a += Math.abs(x[c].y) } if (0 === a) return -1; for (c = b[0] = 0; c < x.length; c++)b.push(Math.abs(x[c].y) * E / a); return b
            } function c() {
              var a = X, b = aa, c = M, d = Y, e, f; e = $; f = T - ca; d = Math.abs((f - e) * (b - a + (d - c)) / 2); c = Y - M; e = f - e; f = c * (f - T); f = Math.abs(f); f = d + f; for (var d = [], g = 0, h = 0; h < x.length; h++) { if ("undefined" === typeof x[h].y) return -1; x[h].y = "number" === typeof x[h].y ? x[h].y : 0; g += Math.abs(x[h].y) } if (0 === g) return -1; for (var l =
              ...
              if (t && x) {
                for (var a, b, c, d, e, f, h, l, k, n, m, p, q, u, B = [], z = [], v = { percent: null, total: null }, A = null, y = 0; y < x.length; y++)u = R[y], u = "undefined" !==
                  typeof u.x5 ? (u.y2 + u.y4) / 2 : (u.y2 + u.y3) / 2, u = g(u).x2 + 1, B[y] = N - u - W; u = 0.5 * W; for (var y = 0, C = x.length - 1; y < x.length || 0 <= C; y++, C--) {
                    b = t.reversed ? x[C] : x[y]; a = b.color ? b.color : t.reversed ? t._colorSet[(x.length - 1 - y) % t._colorSet.length] : t._colorSet[y % t._colorSet.length]; c = b.indexLabelPlacement || t.indexLabelPlacement || "outside"; d = b.indexLabelBackgroundColor || t.indexLabelBackgroundColor || (s ? "transparent" : null); e = b.indexLabelFontColor || t.indexLabelFontColor || "#979797"; f = r(b.indexLabelFontSize) ? t.indexLabelFontSize :
              ...
              var a, b, c, d, e, f = []; e = !1; c = 0; for (var g, h = N - aa - W / 2, h = t.options.indexLabelMaxWidth ?
              ...
              var a, b, c, d; if ("inside" !== t.indexLabelPlacement) for (var e = 0; e < R.length; e++)0 == H[e].textBlock.text.length ?
              ...
              function a(b, c) {
                var d; if (0 > b || b >= H.length) return 0; var e, f = H[b].textBlock; if (0 > c) {
                  c *= -1; e = n(b); d = k(e, b); if (d >= c) return f.y -= c, c; if (0 == b) return 0 < d && (f.y -= d), d; d += a(e, -(c - d)); 0 < d && (f.y -=
                    d); return d
                } e = q(b); d = k(b, e); if (d >= c) return f.y += c, c; if (b == R.length - 1) return 0 < d && (f.y += d), d; d += a(e, c - d); 0 < d && (f.y += d); return d
              } function b() {
                var a, d, e, f, g = 0, h; f = (T - $ + 2 * D) / m; h = m; for (var l, k = 1; k < h; k++) { e = k * f; for (var p = H.length - 1; 0 <= p; p--)!H[p].isDirty && (H[p].textBlock.y < e && H[p].textBlock.y + H[p].height > e) && (l = q(p), !(l >= H.length - 1) && H[p].textBlock.y + H[p].height + ea > H[l].textBlock.y && (H[p].textBlock.y = H[p].textBlock.y + H[p].height - e > e - H[p].textBlock.y ? e + 1 : e - H[p].height - 1)) } for (l = R.length - 1; 0 < l; l--)if (!H[l].isDirty) {
                  e =
                  n(l); if (0 > e && (e = 0, H[e].isDirty)) break; if (H[l].textBlock.y < H[e].textBlock.y + H[e].height) { d = d || l; f = l; for (h = 0; H[f].textBlock.y < H[e].textBlock.y + H[e].height + ea;) { a = a || H[f].textBlock.y + H[f].height; h += H[f].height; h += ea; f = e; if (0 >= f) { f = 0; h += H[f].height; break } e = n(f); if (0 > e) { f = 0; h += H[f].height; break } } if (f != l) { g = H[f].textBlock.y; a -= g; a = h - a; g = c(a, d, f); break } }
                } return g
              } function c(a, b, d) {
                var e = [], f = 0, g = 0; for (a = Math.abs(a); d <= b; d++)e.push(R[d]); e.sort(function (a, b) { return a.height - b.height }); for (d = 0; d < e.length; d++)if (b =
                  e[d], f < a) g++, f += H[b.id].height + ea, H[b.id].textBlock.text = "", H[b.id].indexLabelText = "", H[b.id].isDirty = !0, H[b.id].textBlock.measureText(); else break; return g
              } for (var d, e, f, g, h, l, m = 1, p = 0; p < 2 * m; p++) { for (var t = H.length - 1; 0 <= t && !(0 <= n(t) && n(t), f = H[t], g = f.textBlock, l = (h = q(t) < R.length ? H[q(t)] : null) ? h.textBlock : null, d = +f.height.toFixed(6), e = +g.y.toFixed(6), !f.isDirty && (h && e + d + ea > +l.y.toFixed(6)) && (d = g.y + d + ea - l.y, e = a(t, -d), e < d && (0 < e && (d -= e), e = a(q(t), d), e != d))); t--); b() }
            } function k(a, b) {
              return (b < R.length ? H[b].textBlock.y :
                t.reversed ? U + D : sa + D) - (0 > a ? t.reversed ? sa - D : U - D : H[a].textBlock.y + H[a].height + ea)
            } function m(a, b, c) {
              var d, e, g, l = [], k = D, n = []; -1 !== b && (0 <= Z.indexOf(b) ? (e = Z.indexOf(b), Z.splice(e, 1)) : (Z.push(b), Z = Z.sort(function (a, b) { return a - b }))); if (0 === Z.length) l = ja; else { e = D * (1 != Z.length || 0 != Z[0] && Z[0] != R.length - 1 ? 2 : 1) / h(); for (var q = 0; q < R.length; q++) { if (1 == Z.length && 0 == Z[0]) { if (0 === q) { l.push(ja[q]); d = k; continue } } else 0 === q && (d = -1 * k); l.push(ja[q] + d); if (0 <= Z.indexOf(q) || q < R.length && 0 <= Z.indexOf(q + 1)) d += e } } g = function () {
                for (var a =
                  [], b = 0; b < R.length; b++)a.push(l[b] - R[b].y1); return a
              }(); var u = { startTime: (new Date).getTime(), duration: c || 500, easingFunction: function (a, b, c, d) { return L.easing.easeOutQuart(a, b, c, d) }, changeSection: function (a) { for (var b, c, d = 0; d < R.length; d++)b = g[d], c = R[d], b *= a, "undefined" === typeof n[d] && (n[d] = 0), 0 > n && (n *= -1), c.y1 += b - n[d], c.y2 += b - n[d], c.y3 += b - n[d], c.y4 += b - n[d], c.y5 && (c.y5 += b - n[d], c.y6 += b - n[d]), n[d] = b } }; a._animator.animate(0, c, function (c) {
                var d = a.plotArea.ctx || a.ctx; ka = !0; d.clearRect(A.x1, A.y1, A.x2 - A.x1,
                  A.y2 - A.y1); d.fillStyle = a.backgroundColor; d.fillRect(A.x1, A.y1, A.width, A.height); u.changeSection(c, b); var e = {}; e.dataSeries = t; e.dataPoint = t.reversed ? t.dataPoints[x.length - 1 - b] : t.dataPoints[b]; e.index = t.reversed ? x.length - 1 - b : b; a.toolTip.highlightObjects([e]); for (e = 0; e < R.length; e++)qa(d, R[e], t.fillOpacity); v(d); K && ("inside" !== t.indexLabelPlacement ? p(d) : f(), B(d)); 1 <= c && (ka = !1)
              }, null, L.easing.easeOutQuart)
            } function h() { for (var a = 0, b = 0; b < R.length - 1; b++)(0 <= Z.indexOf(b) || 0 <= Z.indexOf(b + 1)) && a++; return a }
            function p(a) { for (var b, c, d, e, f = 0; f < R.length; f++)e = 1 === H[f].lineThickness % 2 ? 0.5 : 0, c = ((R[f].y2 + R[f].y4) / 2 << 0) + e, b = g(c).x2 - 1, d = H[f].textBlock.x, e = (H[f].textBlock.y + H[f].height / 2 << 0) + e, H[f].isDirty || 0 == H[f].lineThickness || (a.strokeStyle = H[f].lineColor, a.lineWidth = H[f].lineThickness, a.setLineDash && a.setLineDash(Q(H[f].lineDashType, H[f].lineThickness)), a.beginPath(), a.moveTo(b, c), a.lineTo(d, e), a.stroke()) } function n(a) { for (a -= 1; -1 <= a && -1 != a && H[a].isDirty; a--); return a } function q(a) {
              for (a += 1; a <= R.length &&
                a != R.length && H[a].isDirty; a++); return a
            } function g(a) { for (var b, c = 0; c < x.length; c++)if (R[c].y1 < a && R[c].y4 > a) { b = R[c]; break } return b ? (a = b.y6 ? a > b.y6 ? b.x3 + (b.x4 - b.x3) / (b.y4 - b.y3) * (a - b.y3) : b.x2 + (b.x3 - b.x2) / (b.y3 - b.y2) * (a - b.y2) : b.x2 + (b.x3 - b.x2) / (b.y3 - b.y2) * (a - b.y2), { x1: a, x2: a }) : -1 } function B(a) { for (var b = 0; b < R.length; b++)H[b].isDirty || (a && (H[b].textBlock.ctx = a), H[b].textBlock.render(!0)) } function v(a) {
              w.plotArea.layoutManager.reset(); a.roundRect || Ba(a); w.title && (w.title.dockInsidePlotArea || "center" === w.title.horizontalAlign &&
                "center" === w.title.verticalAlign) && (w.title.ctx = a, w.title.render()); if (w.subtitles) for (var b = 0; b < w.subtitles.length; b++) { var c = w.subtitles[b]; if (c.dockInsidePlotArea || "center" === c.horizontalAlign && "center" === c.verticalAlign) w.subtitles.ctx = a, c.render() } w.legend && (w.legend.dockInsidePlotArea || "center" === w.legend.horizontalAlign && "center" === w.legend.verticalAlign) && (w.legend.ctx = a, w.legend.setLayout(), w.legend.render()); I.fNg && I.fNg(w)
              ...
              for (var t = this.data[a.dataSeriesIndexes[0]],
                x = t.dataPoints, A = this.plotArea, D = 0.025 * A.width, C = 0.01 * A.width, y = 0, E = A.height - 2 * D, G = Math.min(A.width - 2 * C, 2.8 * A.height), K = !1, P = 0; P < x.length; P++)if (!K && ("undefined" !== typeof x[P].indexLabel && null !== x[P].indexLabel && 0 < x[P].indexLabel.toString().length) && (K = !0), !K && ("undefined" !== typeof x[P].label && null !== x[P].label && 0 < x[P].label.toString().length) && (K = !0), !K && "function" === typeof t.indexLabelFormatter || "function" === typeof x[P].indexLabelFormatter) K = !0; K = K || "undefined" !== typeof t.indexLabel && null !== t.indexLabel &&
                  0 < t.indexLabel.toString().length; "inside" !== t.indexLabelPlacement && K || (C = (A.width - 0.75 * G) / 2); var P = A.x1 + C, N = A.x2 - C, $ = A.y1 + D, T = A.y2 - D, S = a.targetCanvasCtx || this.plotArea.ctx || this.ctx; if (0 != t.length && (t.dataPoints && t.visible) && 0 !== x.length) {
                    var ca, F; a = 75 * G / 100; var W = 30 * (N - a) / 100; "funnel" === t.type ? (ca = r(t.options.neckHeight) ? 0.35 * E : t.neckHeight, F = r(t.options.neckWidth) ? 0.25 * a : t.neckWidth, "string" === typeof ca && ca.match(/%$/) ? (ca = parseInt(ca), ca = ca * E / 100) : ca = parseInt(ca), "string" === typeof F && F.match(/%$/) ?
                      (F = parseInt(F), F = F * a / 100) : F = parseInt(F), ca > E ? ca = E : 0 >= ca && (ca = 0), F > a ? F = a - 0.5 : 0 >= F && (F = 0)) : "pyramid" === t.type && (F = ca = 0, t.reversed = t.reversed ? !1 : !0); var C = P + a / 2, X = P, aa = P + a, U = t.reversed ? T : $, M = C - F / 2, Y = C + F / 2, xa = t.reversed ? $ + ca : T - ca, sa = t.reversed ? $ : T; a = []; var C = [], R = [], G = [], V = $, da, ba = (xa - U) / (M - X), fa = -ba, P = "area" === (t.valueRepresents ? t.valueRepresents : "height") ? c() : d(); if (-1 !== P) {
                        if (t.reversed) for (G.push(V), F = P.length - 1; 0 < F; F--)V += P[F], G.push(V); else for (F = 0; F < P.length; F++)V += P[F], G.push(V); if (t.reversed) for (F =
                          0; F < P.length; F++)G[F] < xa ? (a.push(M), C.push(Y), da = F) : (a.push((G[F] - U + ba * X) / ba), C.push((G[F] - U + fa * aa) / fa)); else for (F = 0; F < P.length; F++)G[F] < xa ? (a.push((G[F] - U + ba * X) / ba), C.push((G[F] - U + fa * aa) / fa), da = F) : (a.push(M), C.push(Y)); for (F = 0; F < P.length - 1; F++)V = t.reversed ? x[x.length - 1 - F].color ? x[x.length - 1 - F].color : t._colorSet[(x.length - 1 - F) % t._colorSet.length] : x[F].color ? x[F].color : t._colorSet[F % t._colorSet.length], F === da ? R.push({
                            x1: a[F], y1: G[F], x2: C[F], y2: G[F], x3: Y, y3: xa, x4: C[F + 1], y4: G[F + 1], x5: a[F + 1], y5: G[F +
                              1], x6: M, y6: xa, id: F, height: G[F + 1] - G[F], color: V
                          }) : R.push({ x1: a[F], y1: G[F], x2: C[F], y2: G[F], x3: C[F + 1], y3: G[F + 1], x4: a[F + 1], y4: G[F + 1], id: F, height: G[F + 1] - G[F], color: V }); var ea = 2, H = [], ka = !1, Z = [], ja = [], P = !1; a = a = 0; Ca(Z); for (F = 0; F < x.length; F++)x[F].exploded && (P = !0, t.reversed ? Z.push(x.length - 1 - F) : Z.push(F)); S.clearRect(A.x1, A.y1, A.width, A.height); S.fillStyle = w.backgroundColor; S.fillRect(A.x1, A.y1, A.width, A.height); if (K && t.visible && (b(), f(), e(), "inside" !== t.indexLabelPlacement)) {
                            l(); for (F = 0; F < x.length; F++)H[F].isDirty ||
                              (a = H[F].textBlock.x + H[F].width, a = (N - a) / 2, 0 == F && (y = a), y > a && (y = a)); for (F = 0; F < R.length; F++)R[F].x1 += y, R[F].x2 += y, R[F].x3 += y, R[F].x4 += y, R[F].x5 && (R[F].x5 += y, R[F].x6 += y), H[F].textBlock.x += y
                          } for (F = 0; F < R.length; F++)y = R[F], qa(S, y, t.fillOpacity), ja.push(y.y1); v(S); K && t.visible && ("inside" === t.indexLabelPlacement || w.animationEnabled || p(S), w.animationEnabled || B()); if (!K) for (F = 0; F < x.length; F++)y = t.dataPointIds[F], a = {
                            id: y, objectType: "dataPoint", dataPointIndex: F, dataSeriesIndex: 0, funnelSection: R[t.reversed ? x.length -
                              1 - F : F]
                          }, w._eventManager.objectMap[y] = a; !w.animationEnabled && P ? m(w, -1, 0) : w.animationEnabled && !w.animatedRender && m(w, -1, 0); this.funnelPyramidClickHandler = function (a) { var b = -1; if (!ka && !w.isAnimating && (r(a.dataSeries.explodeOnClick) || a.dataSeries.explodeOnClick) && (b = t.reversed ? x.length - 1 - a.dataPointIndex : a.dataPointIndex, 0 <= b)) { a = b; if ("funnel" === t.type || "pyramid" === t.type) t.reversed ? x[x.length - 1 - a].exploded = x[x.length - 1 - a].exploded ? !1 : !0 : x[a].exploded = x[a].exploded ? !1 : !0; m(w, b, 500) } }; return {
                            source: S,
                            dest: this.plotArea.ctx, animationCallback: function (a, b) { L.fadeInAnimation(a, b); 1 <= a && (m(w, -1, 500), v(w.plotArea.ctx || w.ctx)) }, easingFunction: L.easing.easeInQuad, animationBase: 0
                          }
                      }
                  }
            }
            ...
            window.mozCancelRequestAnimationFrame || window.oCancelRequestAnimationFrame || window.msCancelRequestAnimationFrame || clearTimeout; m.prototype.set = function (a, d, c) { c = "undefined" === typeof c ? !0 : c; "options" === a ? (this.options = d, c && this.render()) : m.base.set.call(this, a, d, c) }; m.prototype.exportChart = function (a) {
              a = "undefined" === typeof a ? {} : a; var d = a.format ? a.format : "png", c = a.fileName ? a.fileName : this.exportFileName; if (a.toDataURL) return this.canvas.toDataURL("image/" + d); var b = this.canvas; if (b && d && c) {
                ...
                } catch (p) { d = window.open(), d.document.write("<img src='" + b + "'></img><div>Please right click on the image and save it to your device</div>"), d.document.close() }
              }
              ...
              var f = this; e = "undefined" === typeof e ? 0 : e; if ((0 <= c.type.indexOf("stacked") ||
                "pie" === c.type || "doughnut" === c.type || "funnel" === c.type || "pyramid" === c.type) && (0 <= a.indexOf("#percent") || 0 <= a.indexOf("#total"))) {
                  var l = "#percent", k = "#total", m = this.getPercentAndTotal(c, d), k = isNaN(m.total) ? k : m.total, l = isNaN(m.percent) ? l : m.percent; do {
                    m = ""; if (c.percentFormatString) m = c.percentFormatString; else { var m = "#,##0.", h = Math.max(Math.ceil(Math.log(1 / Math.abs(l)) / Math.LN10), 2); if (isNaN(h) || !isFinite(h)) h = 2; for (var p = 0; p < h; p++)m += "#"; c.percentFormatString = m } a = a.replace("#percent", fa(l, m, f._cultureInfo));
                    a = a.replace("#total", fa(k, c.yValueFormatString ? c.yValueFormatString : "#,##0.########", f._cultureInfo))
                  } while (0 <= a.indexOf("#percent") || 0 <= a.indexOf("#total"))
              } return a.replace(/\{.*?\}|"[^"]*"|'[^']*'/g, function (a) {
                if ('"' === a[0] && '"' === a[a.length - 1] || "'" === a[0] && "'" === a[a.length - 1]) return a.slice(1, a.length - 1); a = Fa(a.slice(1, a.length - 1)); a = a.replace("#index", e); var h = null; try { var g = a.match(/(.*?)\s*\[\s*(.*?)\s*\]/); g && 0 < g.length && (h = Fa(g[2]), a = Fa(g[1])) } catch (l) { } g = null; if ("color" === a) return "waterfall" ===
                  c.type ? d.color ? d.color : 0 < d.y ? c.risingColor : c.fallingColor : "error" === c.type ? c.color ? c.color : c._colorSet[h % c._colorSet.length] : d.color ? d.color : c.color ? c.color : c._colorSet[b % c._colorSet.length]; if (d.hasOwnProperty(a)) g = d; else if (c.hasOwnProperty(a)) g = c; else return ""; g = g[a]; null !== h && (g = g[h]); if ("x" === a) if ("dateTime" === c.axisX.valueType || "dateTime" === c.xValueType || d.x && d.x.getTime) {
                    if (f.plotInfo.plotTypes[0].plotUnits[0].axisX && !f.plotInfo.plotTypes[0].plotUnits[0].axisX.logarithmic) return Aa(g, d.xValueFormatString ?
                  ...
                  } else return fa(g, d.xValueFormatString ? d.xValueFormatString : c.xValueFormatString ? c.xValueFormatString : c.xValueFormatString = "#,##0.########", f._cultureInfo); else return "y" === a ? fa(g, d.yValueFormatString ? d.yValueFormatString : c.yValueFormatString ? c.yValueFormatString : c.yValueFormatString = "#,##0.########", f._cultureInfo) : "z" ===
                    a ? fa(g, d.zValueFormatString ? d.zValueFormatString : c.zValueFormatString ? c.zValueFormatString : c.zValueFormatString = "#,##0.########", f._cultureInfo) : g
              })
            }; oa(E, X); E.prototype.setLayout = function () {
                  ...
                  if (n.dataPoints && n.dataPoints.length) if ("pie" !== n.type && "doughnut" !== n.type && "funnel" !== n.type && "pyramid" !== n.type) {
                    var q = n.legendMarkerType = n.legendMarkerType ? n.legendMarkerType : "line" !== n.type && "stepLine" !== n.type && "spline" !== n.type && "scatter" !== n.type && "bubble" !== n.type || !n.markerType ? "error" === n.type && n._linkedSeries ? n._linkedSeries.legendMarkerType ? n._linkedSeries.legendMarkerType : G.getDefaultLegendMarker(n._linkedSeries.type) : G.getDefaultLegendMarker(n.type) : n.markerType, g = n.legendText ? n.legendText :
                      this.itemTextFormatter ? this.itemTextFormatter({ chart: this.chart, legend: this.options, dataSeries: n, dataPoint: null }) : n.name, B = n.legendMarkerColor = n.legendMarkerColor ? n.legendMarkerColor : n.markerColor ? n.markerColor : "error" === n.type ? r(n.whiskerColor) ? n._colorSet[0] : n.whiskerColor : n._colorSet[0], s = n.markerSize || "line" !== n.type && "stepLine" !== n.type && "spline" !== n.type ? 0.75 * this.lineHeight : 0, v = n.legendMarkerBorderColor ? n.legendMarkerBorderColor : n.markerBorderColor, t = n.legendMarkerBorderThickness ? n.legendMarkerBorderThickness :
                        n.markerBorderThickness ? Math.max(1, Math.round(0.2 * s)) : 0; "error" === n.type && this.errorMarkerColor.push(B); g = this.chart.replaceKeywordsWithValue(g, n.dataPoints[0], n, p); q = { markerType: q, markerColor: B, text: g, textBlock: null, chartType: n.type, markerSize: s, lineColor: n._colorSet[0], dataSeriesIndex: n.index, dataPointIndex: null, markerBorderColor: v, markerBorderThickness: t }; m.push(q)
                  } else for (var x = 0; x < n.dataPoints.length; x++) {
                    var A = n.dataPoints[x], q = A.legendMarkerType ? A.legendMarkerType : n.legendMarkerType ? n.legendMarkerType :
                      G.getDefaultLegendMarker(n.type), g = A.legendText ? A.legendText : n.legendText ? n.legendText : this.itemTextFormatter ? this.itemTextFormatter({ chart: this.chart, legend: this.options, dataSeries: n, dataPoint: A }) : A.name ? A.name : "DataPoint: " + (x + 1), B = A.legendMarkerColor ? A.legendMarkerColor : n.legendMarkerColor ? n.legendMarkerColor : A.color ? A.color : n.color ? n.color : n._colorSet[x % n._colorSet.length], s = 0.75 * this.lineHeight, v = A.legendMarkerBorderColor ? A.legendMarkerBorderColor : n.legendMarkerBorderColor ? n.legendMarkerBorderColor :
                        A.markerBorderColor ? A.markerBorderColor : n.markerBorderColor, t = A.legendMarkerBorderThickness ? A.legendMarkerBorderThickness : n.legendMarkerBorderThickness ? n.legendMarkerBorderThickness : A.markerBorderThickness || n.markerBorderThickness ? Math.max(1, Math.round(0.2 * s)) : 0, g = this.chart.replaceKeywordsWithValue(g, A, n, x), q = { markerType: q, markerColor: B, text: g, textBlock: null, chartType: n.type, markerSize: s, dataSeriesIndex: p, dataPointIndex: x, markerBorderColor: v, markerBorderThickness: t }; (A.showInLegend || n.showInLegend &&
                          !1 !== A.showInLegend) && m.push(q)
                  }
                } !0 === this.reversed && m.reverse(); if (0 < m.length) {
                  n = null; B = g = A = x = 0; A = null !== this.itemWidth ? null !== this.itemMaxWidth ? Math.min(this.itemWidth, this.itemMaxWidth, f) : this.itemMaxWidth = Math.min(this.itemWidth, f) : null !== this.itemMaxWidth ? Math.min(this.itemMaxWidth, f) : this.itemMaxWidth = f; s = 0 === s ? 0.75 * this.lineHeight : s; A -= s + k; for (p = 0; p < m.length; p++) {
                    q = m[p]; v = A; if ("line" === q.chartType || "spline" === q.chartType || "stepLine" === q.chartType) v -= 2 * 0.1 * this.lineHeight; if (!(0 >= l || "undefined" ===
                      typeof l || 0 >= v || "undefined" === typeof v)) {
                        if ("horizontal" === this.orientation) {
                          q.textBlock = new la(this.ctx, { x: 0, y: 0, maxWidth: v, maxHeight: this.itemWrap ? l : this.lineHeight, angle: 0, text: q.text, horizontalAlign: "left", fontSize: this.fontSize, fontFamily: this.fontFamily, fontWeight: this.fontWeight, fontColor: this.fontColor, fontStyle: this.fontStyle, textBaseline: "middle" }); q.textBlock.measureText(); null !== this.itemWidth && (q.textBlock.width = this.itemWidth - (s + k + ("line" === q.chartType || "spline" === q.chartType || "stepLine" ===
                            q.chartType ? 2 * 0.1 * this.lineHeight : 0))); if (!n || n.width + Math.round(q.textBlock.width + s + k + (0 === n.width ? 0 : this.horizontalSpacing) + ("line" === q.chartType || "spline" === q.chartType || "stepLine" === q.chartType ? 2 * 0.1 * this.lineHeight : 0)) > f) n = { items: [], width: 0 }, h.push(n), this.height += g, g = 0; g = Math.max(g, q.textBlock.height)
                        } else q.textBlock = new la(this.ctx, {
                          x: 0, y: 0, maxWidth: A, maxHeight: !0 === this.itemWrap ? l : 1.5 * this.fontSize, angle: 0, text: q.text, horizontalAlign: "left", fontSize: this.fontSize, fontFamily: this.fontFamily,
                          ...
                          0 : this.horizontalSpacing) + ("line" === q.chartType || "spline" === q.chartType || "stepLine" === q.chartType ? 2 * 0.1 * this.lineHeight : 0)); n.items.push(q); this.width = Math.max(n.width, this.width); B = q.textBlock.width + (s + k + ("line" === q.chartType || "spline" === q.chartType || "stepLine" === q.chartType ? 2 * 0.1 * this.lineHeight : 0))
                    }
                  } this.itemWidth = B; this.height = !1 === this.itemWrap ? h.length * this.lineHeight : this.height + g; this.height = Math.min(l, this.height); this.width = Math.min(f, this.width)
              ...
              var a = this.bounds.x1, d = this.bounds.y1, c = this.markerMargin, b = this.maxWidth, e = this.maxHeight, f = this.markerSize, l = this.rows; (0 < this.borderThickness &&
                this.borderColor || this.backgroundColor) && this.ctx.roundRect(a, d, this.width, this.height, this.cornerRadius, this.borderThickness, this.backgroundColor, this.borderColor); for (var k = 0, m = 0; m < l.length; m++) {
                  for (var h = l[m], p = 0, n = 0; n < h.items.length; n++) {
                    var q = h.items[n], g = q.textBlock.x + a + (0 === n ? 0.2 * f : this.horizontalSpacing), r = d + k, s = g; this.chart.data[q.dataSeriesIndex].visible || (this.ctx.globalAlpha = 0.5); this.ctx.save(); this.ctx.beginPath(); this.ctx.rect(a, d, b, Math.max(e - e % this.lineHeight, 0)); this.ctx.clip();
                    if ("line" === q.chartType || "stepLine" === q.chartType || "spline" === q.chartType) this.ctx.strokeStyle = q.lineColor, this.ctx.lineWidth = Math.ceil(this.lineHeight / 8), this.ctx.beginPath(), this.ctx.moveTo(g - 0.1 * this.lineHeight, r + this.lineHeight / 2), this.ctx.lineTo(g + 0.85 * this.lineHeight, r + this.lineHeight / 2), this.ctx.stroke(), s -= 0.1 * this.lineHeight; if ("error" === q.chartType) {
                      this.ctx.strokeStyle = this.errorMarkerColor[0]; this.ctx.lineWidth = f / 8; this.ctx.beginPath(); var v = g - 0.08 * this.lineHeight + 0.1 * this.lineHeight,
                        t = r + 0.15 * this.lineHeight, x = 0.7 * this.lineHeight, A = x + 0.02 * this.lineHeight; this.ctx.moveTo(v, t); this.ctx.lineTo(v + x, t); this.ctx.stroke(); this.ctx.beginPath(); this.ctx.moveTo(v + x / 2, t); this.ctx.lineTo(v + x / 2, t + A); this.ctx.stroke(); this.ctx.beginPath(); this.ctx.moveTo(v, t + A); this.ctx.lineTo(v + x, t + A); this.ctx.stroke(); this.errorMarkerColor.shift()
                    } Y.drawMarker(g + f / 2, r + this.lineHeight / 2, this.ctx, q.markerType, "error" === q.chartType || "line" === q.chartType || "spline" === q.chartType ? q.markerSize / 2 : q.markerSize, q.markerColor,
                      q.markerBorderColor, q.markerBorderThickness); q.textBlock.x = g + c + f; if ("line" === q.chartType || "stepLine" === q.chartType || "spline" === q.chartType) q.textBlock.x += 0.1 * this.lineHeight; q.textBlock.y = Math.round(r + this.lineHeight / 2); q.textBlock.render(!0); this.ctx.restore(); p = 0 < n ? Math.max(p, q.textBlock.height) : q.textBlock.height; this.chart.data[q.dataSeriesIndex].visible || (this.ctx.globalAlpha = 1); g = S(q.id); this.ghostCtx.fillStyle = g; this.ghostCtx.beginPath(); this.ghostCtx.fillRect(s, q.textBlock.y - this.lineHeight /
                        2, q.textBlock.x + q.textBlock.width - s, q.textBlock.height); q.x1 = this.chart._eventManager.objectMap[q.id].x1 = s; q.y1 = this.chart._eventManager.objectMap[q.id].y1 = q.textBlock.y - this.lineHeight / 2; q.x2 = this.chart._eventManager.objectMap[q.id].x2 = q.textBlock.x + q.textBlock.width; q.y2 = this.chart._eventManager.objectMap[q.id].y2 = q.textBlock.y + q.textBlock.height - this.lineHeight / 2
                  } k += p
                }
            }; oa(G, X); G.prototype.getDefaultAxisPlacement = function () {
              ...
              if (!this.dataPoints || 0 === this.dataPoints.length) return null; var c = { dataPoint: null, distance: Infinity, index: NaN }, b = null, e = 0, f = 0, l = 1, k = Infinity, m = 0, h = 0, p = 0; "none" !== this.chart.plotInfo.axisPlacement && (this.axisX.logarithmic ?
                (p = Math.log(this.dataPoints[this.dataPoints.length - 1].x / this.dataPoints[0].x), p = 1 < p ? Math.min(Math.max((this.dataPoints.length - 1) / p * Math.log(a / this.dataPoints[0].x) >> 0, 0), this.dataPoints.length) : 0) : (p = this.dataPoints[this.dataPoints.length - 1].x - this.dataPoints[0].x, p = 0 < p ? Math.min(Math.max((this.dataPoints.length - 1) / p * (a - this.dataPoints[0].x) >> 0, 0), this.dataPoints.length) : 0)); for (; ;) {
                  f = 0 < l ? p + e : p - e; if (0 <= f && f < this.dataPoints.length) {
                    var b = this.dataPoints[f], n = this.axisX.logarithmic ? b.x > a ? b.x / a : a / b.x :
                      Math.abs(b.x - a); n < c.distance && (c.dataPoint = b, c.distance = n, c.index = f); b = n; b <= k ? k = b : 0 < l ? m++ : h++; if (1E3 < m && 1E3 < h) break
              ...
              c = c || !1; var b = [], e = 0, f = 0, l = 1, k = !1, m = Infinity, h = 0, p = 0, n = 0; if ("none" !== this.chart.plotInfo.axisPlacement) if (n = (this.chart.axisX[0] ? this.chart.axisX[0] : this.chart.axisX2[0]).getXValueAt({ x: a, y: d }), this.axisX.logarithmic) var q = Math.log(this.dataPoints[this.dataPoints.length - 1].x / this.dataPoints[0].x), n = 1 < q ? Math.min(Math.max((this.dataPoints.length - 1) / q * Math.log(n / this.dataPoints[0].x) >> 0, 0), this.dataPoints.length) : 0; else q = this.dataPoints[this.dataPoints.length - 1].x - this.dataPoints[0].x, n = 0 < q ? Math.min(Math.max((this.dataPoints.length -
                1) / q * (n - this.dataPoints[0].x) >> 0, 0), this.dataPoints.length) : 0; for (; ;) {
                  f = 0 < l ? n + e : n - e; if (0 <= f && f < this.dataPoints.length) {
                    var q = this.chart._eventManager.objectMap[this.dataPointIds[f]], g = this.dataPoints[f], r = null; if (q) {
                      switch (this.type) {
                        ...
                        }), k = !0); break; case "line": case "stepLine": case "spline": case "area": case "stepArea": case "stackedArea": case "stackedArea100": case "splineArea": case "scatter": var s = ma("markerSize", g, this) || 4, v = c ? 20 : s, r = Math.sqrt(Math.pow(q.x1 - a, 2) + Math.pow(q.y1 - d, 2)); r <= v && b.push({ dataPoint: g, dataPointIndex: f, dataSeries: this, distance: r }); q = Math.abs(q.x1 - a); q <= m ? m = q : 0 < l ? h++ : p++; r <= s / 2 && (k = !0); break; case "rangeArea": case "rangeSplineArea": s = ma("markerSize", g, this) ||
            ...
            }; oa(D, X); D.prototype.createExtraLabelsForLog = function (a) {
              a = (a || 0) + 1; if (!(5 < a)) {
                var d = this.logLabelValues[0] || this.intervalStartPosition; if (Math.log(this.range) / Math.log(d / this.viewportMinimum) < this.noTicks - 1) {
                  for (var c = D.getNiceNumber((d - this.viewportMinimum) / Math.min(Math.max(2, this.noTicks - this.logLabelValues.length),
                    3), !0), b = Math.ceil(this.viewportMinimum / c) * c; b < d; b += c)b < this.viewportMinimum || this.logLabelValues.push(b); this.logLabelValues.sort(Pa); this.createExtraLabelsForLog(a)
                }
              }
            }; D.prototype.createLabels = function () {
              var a, d, c = 0, b = 0, e, f = 0, l = 0, b = 0, b = this.interval, k = 0, m, h = 0.6 * this.chart.height, p; a = !1; var n = this.scaleBreaks ? this.scaleBreaks._appliedBreaks : [], q = n.length ? r(this.scaleBreaks.firstBreakIndex) ? 0 : this.scaleBreaks.firstBreakIndex : 0; if ("axisX" !== this.type || "dateTime" !== this.valueType || this.logarithmic) {
                e =
                this.viewportMaximum; if (this.labels) { a = Math.ceil(b); for (var b = Math.ceil(this.intervalStartPosition), g = !1, c = b; c < this.viewportMaximum; c += a)if (this.labels[c]) g = !0; else { g = !1; break } g && (this.interval = a, this.intervalStartPosition = b) } if (this.logarithmic && !this.equidistantInterval) for (this.logLabelValues || (this.logLabelValues = [], this.createExtraLabelsForLog()), b = 0, g = q; b < this.logLabelValues.length; b++)if (c = this.logLabelValues[b], c < this.viewportMinimum) b++; else {
                  for (; g < n.length && c > n[g].endValue; g++); a = g < n.length &&
                    c >= n[g].startValue && c <= n[g].endValue; p = c; a || (a = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.options, value: p, label: this.labels[p] ? this.labels[p] : null }) : "axisX" === this.type && this.labels[p] ? this.labels[p] : fa(p, this.valueFormatString, this.chart._cultureInfo), a = new la(this.ctx, {
                  ...
                  this.interval) : c + this.interval).toFixed(12))) {
                    for (; g < n.length && c > n[g].endValue; g++); a = g < n.length && c >= n[g].startValue && c <= n[g].endValue; p = c; a || (a = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.options, value: p, label: this.labels[p] ? this.labels[p] : null }) : "axisX" === this.type && this.labels[p] ? this.labels[p] : fa(p, this.valueFormatString, this.chart._cultureInfo), a = new la(this.ctx, {
                ...
                this.interval), e = Va(new Date(this.viewportMaximum), this.interval, this.intervalType), g = q, c = this.intervalStartPosition; c < e; Va(c, b, this.intervalType)) {
                  for (a = c.getTime(); g < n.length && a > n[g].endValue; g++); p = a; a = g < n.length && a >= n[g].startValue && a <= n[g].endValue; a || (a = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.options, value: new Date(p), label: this.labels[p] ? this.labels[p] : null }) : "axisX" === this.type && this.labels[p] ? this.labels[p] : Aa(p, this.valueFormatString, this.chart._cultureInfo),
                    ...
                    0 : 1.5 * this.labelFontSize; for (b = 0; b < this._labels.length; b++) { a = this._labels[b].textBlock; a.maxWidth = f; a.maxHeight = l; var B = a.measureText(); m = B.height } e = []; q = n = 0; if (this.labelAutoFit || this.options.labelAutoFit) if (r(this.labelAngle) || (this.labelAngle = (this.labelAngle % 360 + 360) % 360, 90 < this.labelAngle && 270 > this.labelAngle ? this.labelAngle -= 180 : 270 <= this.labelAngle && 360 >= this.labelAngle && (this.labelAngle -= 360)), "bottom" === this._position || "top" === this._position) if (f = 0.9 * k >> 0, q = 0, !this.chart.panEnabled && 1 <=
                      this._labels.length) {
                        this.sessionVariables.labelFontSize = this.labelFontSize; this.sessionVariables.labelMaxWidth = f; this.sessionVariables.labelMaxHeight = l; this.sessionVariables.labelAngle = this.labelAngle; this.sessionVariables.labelWrap = this.labelWrap; for (c = 0; c < this._labels.length; c++)if (!this._labels[c].breaksLabelType) {
                          a = this._labels[c].textBlock; for (var v, g = a.text.split(" "), b = 0; b < g.length; b++)p = g[b], this.ctx.font = a.fontStyle + " " + a.fontWeight + " " + a.fontSize + "px " + a.fontFamily, p = this.ctx.measureText(p),
                                    ...
                                    l, this.sessionVariables.labelMaxWidth = f, this.sessionVariables.labelAngle = r(this.sessionVariables.labelAngle) ? 0 : this.sessionVariables.labelAngle))) : (this.sessionVariables.labelMaxHeight = l, this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth ? this.options.labelMaxWidth : this.sessionVariables.labelMaxWidth)) : (this.sessionVariables.labelMaxWidth = this.labelWrap ? this.options.labelMaxWidth ? this.options.labelMaxWidth : this.sessionVariables.labelMaxWidth : this.labelMaxWidth ? this.options.labelMaxWidth ?
                                      this.options.labelMaxWidth : this.sessionVariables.labelMaxWidth : f, this.sessionVariables.labelMaxHeight = l) : (this.sessionVariables.labelAngle = this.labelAngle, this.sessionVariables.labelMaxWidth = 0 === this.labelAngle ? f : Math.min((b - l * Math.sin(Math.PI / 180 * Math.abs(this.labelAngle))) / Math.cos(Math.PI / 180 * Math.abs(this.labelAngle)), l), r(this.options.labelWrap)) ? r(this.options.labelWrap) && (this.labelWrap && !r(this.options.labelMaxWidth) ? (this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth ? this.options.labelMaxWidth >
                                        this.options.labelMaxWidth : this.sessionVariables.labelMaxWidth, this.sessionVariables.labelWrap = this.labelWrap, this.sessionVariables.labelMaxHeight = b) : (this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth ? this.options.labelMaxWidth : f, this.sessionVariables.labelMaxHeight = 0 === this.labelAngle ? l : b, r(this.options.labelMaxWidth) && (this.sessionVariables.labelAngle = this.labelAngle))) : this.options.labelWrap ? (this.sessionVariables.labelMaxHeight = 0 === this.labelAngle ? l : b, this.sessionVariables.labelWrap =
                                          this.labelWrap, this.sessionVariables.labelMaxWidth = f) : (this.sessionVariables.labelMaxHeight = l, r(this.options.labelMaxWidth), this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth ? this.options.labelMaxWidth : this.sessionVariables.labelMaxWidth, this.sessionVariables.labelWrap = this.labelWrap)
                        ...
                        this.sessionVariables.labelFontSize = this.labelFontSize : this.sessionVariables.labelFontSize : this.options.labelFontSize, a.angle = this.labelAngle = r(this.options.labelAngle) ? r(this.sessionVariables.labelAngle) ? this.sessionVariables.labelAngle = this.labelAngle : this.sessionVariables.labelAngle : this.labelAngle, a.wrap = this.labelWrap = r(this.options.labelWrap) ? r(this.sessionVariables.labelWrap) ? this.sessionVariables.labelWrap = this.labelWrap : this.sessionVariables.labelWrap : this.options.labelWrap, a.maxHeight = r(this.sessionVariables.labelMaxHeight) ?
                          this.sessionVariables.labelMaxHeight = l : this.sessionVariables.labelMaxHeight, a.measureText(); for (c = 0; c < this.stripLines.length; c++) {
                            var f = this.stripLines[c], w; if ("outside" === f.labelPlacement) {
                              ...
                              "top" === this._position ? 0.8 * this.chart.width >> 0 : 0.8 * this.chart.height >> 0 : 1.5 * this.labelFontSize, r(f.labelBackgroundColor) && (r(f.startValue) && 0 !== f.startValue ? f.labelBackgroundColor = s ? "transparent" : null : f.labelBackgroundColor = "#EEEEEE"); a = new la(this.ctx, {
                                x: 0, y: 0, backgroundColor: f.labelBackgroundColor, borderColor: f.labelBorderColor, borderThickness: f.labelBorderThickness, cornerRadius: f.labelCornerRadius, maxWidth: f.options.labelMaxWidth ? f.options.labelMaxWidth : l, maxHeight: w, angle: this.labelAngle, text: f.labelFormatter ?
              ...
              var l, k, m, h, p = a[0] ? a[0].chart : d[0].chart, n = p.isNavigator ? 0 : 10, q = p._axes; if (a && 0 < a.length) for (var g = 0; g < a.length; g++)a[g] && a[g].calculateAxisParameters(); if (d && 0 < d.length) for (g = 0; g < d.length; g++)d[g].calculateAxisParameters(); if (c && 0 < c.length) for (g = 0; g < c.length; g++)c[g].calculateAxisParameters(); if (b && 0 < b.length) for (g = 0; g < b.length; g++)b[g].calculateAxisParameters(); for (g = 0; g < q.length; g++)if (q[g] && q[g].scaleBreaks &&
                                        ...
                                        b[g].lineCoordinates.height), X += C[g] + b[g].margin); if (a && 0 < a.length) for (g = 0; g < a.length; g++)a[g] && (a[g].calculateValueToPixelConversionParameters(), a[g].calculateBreaksSizeInValues(), a[g]._labels && 1 < a[g]._labels.length && (y = (a[g].logarithmic ? Math.log(a[g]._labels[1].position / a[g].viewportMinimum) / a[g].conversionParameters.lnLogarithmBase : a[g]._labels[1].position - a[g].viewportMinimum) * Math.abs(a[g].conversionParameters.pixelPerUnit) + a[g].lineCoordinates.x1, l = a[g]._labels[a[g]._labels.length - ("dateTime" ===
                                          a[g].valueType ? 2 : 1)].position, l = a[g].getApparentDifference(a[g].viewportMinimum, l), E = a[g].logarithmic ? (1 < l ? Math.log(l) / a[g].conversionParameters.lnLogarithmBase * Math.abs(a[g].conversionParameters.pixelPerUnit) : 0) + a[g].lineCoordinates.x1 : (0 < l ? l * Math.abs(a[g].conversionParameters.pixelPerUnit) : 0) + a[g].lineCoordinates.x1)); if (d && 0 < d.length) for (g = 0; g < d.length; g++)d[g].calculateValueToPixelConversionParameters(), d[g].calculateBreaksSizeInValues(), d[g]._labels && 1 < d[g]._labels.length && (y = (d[g].logarithmic ?
                                            Math.log(d[g]._labels[1].position / d[g].viewportMinimum) / d[g].conversionParameters.lnLogarithmBase : d[g]._labels[1].position - d[g].viewportMinimum) * Math.abs(d[g].conversionParameters.pixelPerUnit) + d[g].lineCoordinates.x1, l = d[g]._labels[d[g]._labels.length - ("dateTime" === d[g].valueType ? 2 : 1)].position, l = d[g].getApparentDifference(d[g].viewportMinimum, l), E = d[g].logarithmic ? (1 < l ? Math.log(l) / d[g].conversionParameters.lnLogarithmBase * Math.abs(d[g].conversionParameters.pixelPerUnit) : 0) + d[g].lineCoordinates.x1 :
                                              (0 < l ? l * Math.abs(d[g].conversionParameters.pixelPerUnit) : 0) + d[g].lineCoordinates.x1); for (g = 0; g < q.length; g++)"axisY" === q[g].type && (q[g].calculateValueToPixelConversionParameters(), q[g].calculateBreaksSizeInValues()); if (0 < s) {
                                                if (a && 0 < a.length) for (g = 0; g < a.length; g++)B = N[s - 1][g] === N[s][g] ? !0 : !1; else B = !0; if (d && 0 < d.length) for (g = 0; g < d.length; g++)I = Q[s - 1][g] === Q[s][g] ? !0 : !1; else I = !0; if (c && 0 < c.length) for (g = 0; g < c.length; g++)P = S[s - 1][g] === S[s][g] ? !0 : !1; else P = !0; if (b && 0 < b.length) for (g = 0; g < b.length; g++)L = T[s -
                          ...
                          h, b[g].lineCoordinates.y2 = h, "inside" === b[g].labelPlacement && 0 < g && (b[g].lineCoordinates.y1 = h - y[g] + (b[g]._titleTextBlock ? b[g]._titleTextBlock.height : 0)), b[g].bounds = { x1: l, y1: k + (b[g].margin + F), x2: m, y2: h, width: m - l, height: W }, b[g].title && (b[g]._titleTextBlock.maxWidth = 0 < b[g].titleMaxWidth && b[g].titleMaxWidth < b[g].lineCoordinates.width ? b[g].titleMaxWidth : b[g].lineCoordinates.width), F += y[g] + b[g].margin); if (a && 0 < a.length) for (g = 0; g < a.length; g++) {
                            M = a[g]._labels && 0 < a[g]._labels.length ? a[g]._labels[0].textBlock.fontSize /
                              2 : 0; l = Math.round(f.x1 + e); k = b && 0 < b.length ? Math.round(b[0] ? b[0].lineCoordinates.y2 : f.y1 < Math.max(M, 10) ? Math.max(M, 10) : f.y1) : f.y1 < Math.max(M, 10) ? Math.max(M, 10) : f.y1; m = Math.round(f.x1 + X + e); h = c && 0 < c.length ? Math.round(c[0] ? c[0].lineCoordinates.y1 : f.y2 - U > p.height - Math.max(M, 10) ? p.height - Math.max(M, 10) : f.y2 - U) : f.y2 > p.height - Math.max(M, 10) ? p.height - Math.max(M, 10) : f.y2; if (c && 0 < c.length) for (M = 0; M < c.length; M++)c[M] && c[M].labelAutoFit && (m = 0 > c[M].labelAngle ? Math.max(m, x) : 0 === c[M].labelAngle ? Math.max(m, x / 2) : m, l =
                                ...
                                }; a[g].title && (a[g]._titleTextBlock.maxWidth = 0 < a[g].titleMaxWidth && a[g].titleMaxWidth < a[g].lineCoordinates.height ? a[g].titleMaxWidth : a[g].lineCoordinates.height); a[g].calculateValueToPixelConversionParameters(); a[g].calculateBreaksSizeInValues(); S += G[g] + a[g].margin
                          } if (d && 0 < d.length) for (g = 0; g < d.length; g++) {
                            M = d[g]._labels && 0 < d[g]._labels.length ? d[g]._labels[0].textBlock.fontSize / 2 : 0; l = Math.round(f.x1 - e); k = b && 0 < b.length ? Math.round(b[0] ? b[0].lineCoordinates.y2 : f.y1 <
                              Math.max(M, 10) ? Math.max(M, 10) : f.y1) : f.y1 < Math.max(M, 10) ? Math.max(M, 10) : f.y1; m = Math.round(f.x2 - V - Z); h = c && 0 < c.length ? Math.round(c[0] ? c[0].lineCoordinates.y1 : f.y2 - U > p.height - Math.max(M, 10) ? p.height - Math.max(M, 10) : f.y2 - U) : f.y2 > p.height - Math.max(M, 10) ? p.height - Math.max(M, 10) : f.y2; if (c && 0 < c.length) for (M = 0; M < c.length; M++)c[M] && c[M].labelAutoFit && (m = 0 > c[M].labelAngle ? Math.max(m, x) : 0 === c[M].labelAngle ? Math.max(m, x / 2) : m, l = 0 > c[M].labelAngle || 0 === c[M].labelAngle ? m - V : l); if (b && 0 < b.length) for (M = 0; M < b.length; M++)b[M] &&
                                b[M].labelAutoFit && (m = b[M].lineCoordinates.x2, l = m - V); d[g].lineCoordinates = { x1: m + T, y1: k, x2: m + T, y2: h, height: Math.abs(h - k) }; "inside" === d[g].labelPlacement && 0 < g && (d[g].lineCoordinates.x1 = d[g].lineCoordinates.x1 + (v[g] - (d[g]._titleTextBlock ? d[g]._titleTextBlock.height : 0) - 2) - ("outside" === d[g].tickPlacement ? d[g].tickLength : 0), d[g].lineCoordinates.x2 = d[g].lineCoordinates.x1 + d[g].lineThickness / 2); d[g].bounds = { x1: d[g].lineCoordinates.x1, y1: k, x2: m + v[g] + T, y2: h, width: m - l, height: h - k }; d[g].title && (d[g]._titleTextBlock.maxWidth =
                                  0 < d[g].titleMaxWidth && d[g].titleMaxWidth < d[g].lineCoordinates.height ? d[g].titleMaxWidth : d[g].lineCoordinates.height); d[g].calculateValueToPixelConversionParameters(); d[g].calculateBreaksSizeInValues(); T += v[g] + d[g].margin
                          } for (g = 0; g < q.length; g++)"axisY" === q[g].type && (q[g].calculateValueToPixelConversionParameters(), q[g].calculateBreaksSizeInValues()); if (0 < s) {
                            if (a && 0 < a.length) for (g = 0; g < a.length; g++)B = N[s - 1][g] === N[s][g] ? !0 : !1; else B = !0; if (d && 0 < d.length) for (g = 0; g < d.length; g++)I = Q[s - 1][g] === Q[s][g] ? !0 :
                              !1; else I = !0; if (c && 0 < c.length) for (g = 0; g < c.length; g++)P = E[s - 1][g] === E[s][g] ? !0 : !1; else P = !0; if (b && 0 < b.length) for (g = 0; g < b.length; g++)L = t[s - 1][g] === t[s][g] ? !0 : !1; else L = !0
                          } if (B && I && P && L) break; s++
                ...
                var a = this, d = !1, c = 0, b = 0, e = 1, f = 0; 0 !== this.labelAngle && 360 !== this.labelAngle && (e = 1.2); if ("undefined" === typeof this.options.interval) {
                  if ("bottom" === this._position || "top" === this._position) if (this.logarithmic && !this.equidistantInterval && this.labelAutoFit) {
                    ...
                    for (var c = [], p, k = this.viewportMaximum, m = this.lineCoordinates.height / Math.log(this.range), h = this._labels.length - 1; 0 <= h; h--) {
                      n = this._labels[h]; if (n.position < this.viewportMinimum) break; n.position > this.viewportMaximum || !(h === this._labels.length - 1 || p < Math.log(k / n.position) *
                  ...
                  } else { for (h = 0; h < this._labels.length; h++)n = this._labels[h], n.position < this.viewportMinimum || (p = n.textBlock.height * Math.abs(Math.cos(Math.PI / 180 * this.labelAngle)) + n.textBlock.width * Math.abs(Math.sin(Math.PI / 180 * this.labelAngle)), b += p); b > this.lineCoordinates.height * e && this.labelAutoFit && (d = !0) }
                } this.logarithmic && (!this.equidistantInterval &&
                  this.labelAutoFit) && this._labels.sort(function (a, b) { return a.position - b.position }); var h = 0, n, q; if ("bottom" === this._position) {
                ...
                function () {
                      ...
                      for (var d = this, c, b = 0, e = 0, f = !1, l = !1, k = [], m = [], l = !1, b = 0; b < this.stripLines.length; b++) { var h = this.stripLines[b]; h._thicknessType === a && ("pixel" === a && (h.value < this.viewportMinimum || h.value > this.viewportMaximum || r(h.value) || isNaN(this.range)) || "value" === a && (h.startValue <= this.viewportMinimum && h.endValue <= this.viewportMinimum || h.startValue >= this.viewportMaximum && h.endValue >= this.viewportMaximum || r(h.startValue) || r(h.endValue) || isNaN(this.range)) || k.push(h)) } for (b = 0; b < this._stripLineLabels.length; b++)if (h =
                        this.stripLines[b], c = this._stripLineLabels[b], !(c.position < this.viewportMinimum || c.position > this.viewportMaximum || isNaN(this.range))) {
                          a = this.getPixelCoordinatesOnAxis(c.position); if ("outside" === c.stripLine.labelPlacement) if (h && (this.ctx.strokeStyle = h.color, "pixel" === h._thicknessType && (this.ctx.lineWidth = h.thickness)), "bottom" === this._position) {
                            var p = 1 === this.ctx.lineWidth % 2 ? (a.x << 0) + 0.5 : a.x << 0; this.ctx.beginPath(); this.ctx.moveTo(p, a.y << 0); this.ctx.lineTo(p, a.y + this.tickLength << 0); this.ctx.stroke();
                        ...
                        l = !1; this.ctx.save(); this.ctx.beginPath(); this.ctx.rect(this.chart.plotArea.x1, this.chart.plotArea.y1, this.chart.plotArea.width, this.chart.plotArea.height); this.ctx.clip(); for (b = 0; b < k.length; b++)h =
                          k[b], h.showOnTop ? f || (f = !0, this.chart.addEventListener("dataAnimationIterationEnd", function () { this.ctx.save(); this.ctx.beginPath(); this.ctx.rect(this.chart.plotArea.x1, this.chart.plotArea.y1, this.chart.plotArea.width, this.chart.plotArea.height); this.ctx.clip(); for (e = 0; e < k.length; e++)h = k[e], h.showOnTop && h.render(); this.ctx.restore() }, h)) : h.render(); for (b = 0; b < m.length; b++)c = m[b], c.stripLine.showOnTop ? l || (l = !0, this.chart.addEventListener("dataAnimationIterationEnd", function () {
                  ...
                  if (this.scaleBreaks &&
                    0 < this.scaleBreaks._appliedBreaks.length) {
                      var a = this.scaleBreaks._appliedBreaks; s ? (this.maskCanvas = ta(this.chart.width, this.chart.height), this.maskCtx = this.maskCanvas.getContext("2d")) : (this.maskCanvas = this.chart.plotArea.canvas, this.maskCtx = this.chart.plotArea.ctx); this.maskCtx.save(); this.maskCtx.beginPath(); this.maskCtx.rect(this.chart.plotArea.x1, this.chart.plotArea.y1, this.chart.plotArea.width, this.chart.plotArea.height); this.maskCtx.clip(); for (var d = 0; d < a.length; d++)a[d].endValue < this.viewportMinimum ||
                        (a[d].startValue > this.viewportMaximum || isNaN(this.range)) || a[d].render(this.maskCtx); this.maskCtx.restore()
                  }
                }; D.prototype.renderCrosshair = function (a, d) { isFinite(this.minimum) && isFinite(this.maximum) && (this.crosshair.render(a, d), this.crosshair.dispatchEvent("updated", { chart: this.chart, crosshair: this.options, axis: this, value: this.crosshair.value }, this)) }; D.prototype.showCrosshair = function (a) {
                  ...
                  var a = this.chart.ctx, d = s ? this.chart._preRenderCtx : a, c = Math.ceil(this.tickThickness / (this.reversed ? -2 : 2)), b = Math.ceil(this.tickThickness / (this.reversed ? 2 : -2)), e, f; d.save(); if ("bottom" === this._position || "top" === this._position) {
                    if (this.lineThickness) {
                      ...
                      d.lineWidth = this.lineThickness; d.strokeStyle = this.lineColor ? this.lineColor : "black"; d.setLineDash && d.setLineDash(Q(this.lineDashType, this.lineThickness)); var l = 1 === this.lineThickness % 2 ? (this.lineCoordinates.y1 << 0) + 0.5 : this.lineCoordinates.y1 << 0; d.beginPath(); if (this.scaleBreaks && !r(this.scaleBreaks.firstBreakIndex)) if (r(this.scaleBreaks.lastBreakIndex)) e = this.scaleBreaks._appliedBreaks[this.scaleBreaks.firstBreakIndex].endPixel + b; else for (var k = this.scaleBreaks.firstBreakIndex; k <= this.scaleBreaks.lastBreakIndex; k++)d.moveTo(e,
                        l), d.lineTo(this.scaleBreaks._appliedBreaks[k].startPixel + c, l), e = this.scaleBreaks._appliedBreaks[k].endPixel + b; e && (d.moveTo(e, l), d.lineTo(f, l)); d.stroke()
                    }
                  } else if (("left" === this._position || "right" === this._position) && this.lineThickness) {
                    this.reversed ? (e = this.lineCoordinates.y1, f = this.lineCoordinates.y2) : (e = this.lineCoordinates.y2, f = this.lineCoordinates.y1); d.lineWidth = this.lineThickness; d.strokeStyle = this.lineColor; d.setLineDash && d.setLineDash(Q(this.lineDashType, this.lineThickness)); l = 1 === this.lineThickness %
                  ...
                  function (a) {
                    ...
                    var c = "#,##0.",
                    b = d; 1 > a && (b += Math.floor(Math.abs(Math.log(a) / Math.LN10)), isNaN(b) || !isFinite(b)) && (b = d); for (var e = 0; e < b; e++)c += "#"; return c
                  }; D.getNiceExponent = function (a, d) { var c = Math.floor(Math.log(a) / Math.LN10), b = a / Math.pow(10, c), b = 0 > c ? 1 >= b ? 1 : 5 >= b ? 5 : 10 : Math.max(Math.floor(b), 1); return -20 > c ? Number(b * Math.pow(10, c)) : Number((b * Math.pow(10, c)).toFixed(20)) }; D.getNiceNumber = function (a, d) {
                    var c = Math.floor(Math.log(a) / Math.LN10), b = a / Math.pow(10, c), b = d ? 1.5 > b ? 1 : 3 > b ? 2 : 7 > b ? 5 : 10 : 1 >= b ? 1 : 2 >= b ? 2 : 5 >= b ? 5 : 10; return -20 > c ? Number(b *
                      Math.pow(10, c)) : Number((b * Math.pow(10, c)).toFixed(20))
        ...
        V.prototype.render = function (a) {
          if (0 !== this.spacing || 0 !== this.options.lineThickness && ("undefined" !== typeof this.options.lineThickness || 0 !== this.parent.lineThickness)) {
            ...
            this.ctx.strokeStyle = this.lineColor; this.ctx.fillStyle = this.color; this.ctx.beginPath(); this.ctx.globalAlpha = 1; S(this.id); var f, l, k, m, h, p; a = Math.max(this.spacing, 3); var n = Math.max(0, this.lineThickness); this.ctx.lineWidth = n; this.ctx.setLineDash && this.ctx.setLineDash(Q(this.lineDashType, n)); if ("bottom" === this.scaleBreaks.parent._position || "top" === this.scaleBreaks.parent._position) if (b = 1 === n % 2 ? (b.x << 0) + 0.5 : b.x << 0, l = 1 === n % 2 ? (e.x << 0) + 0.5 : e.x << 0, "top" === this.scaleBreaks.parent._position ? (e = this.chart.plotArea.y1,
              k = this.chart.plotArea.y2 + n / 2 + 0.5 << 0) : (e = this.chart.plotArea.y2, k = this.chart.plotArea.y1 - n / 2 + 0.5 << 0, a *= -1), this.bounds = { x1: b - n / 2, y1: e, x2: l + n / 2, y2: k }, this.ctx.moveTo(b, e), "straight" === this.type || "top" === this.scaleBreaks.parent._position && 0 >= a || "bottom" === this.scaleBreaks.parent._position && 0 <= a) this.ctx.lineTo(b, k), this.ctx.lineTo(l, k), this.ctx.lineTo(l, e); else if ("wavy" === this.type) {
                m = b; h = e; f = 0.5; p = (k - h) / a / 3; for (var q = 0; q < p; q++)this.ctx.bezierCurveTo(m + f * a, h + a, m + f * a, h + 2 * a, m, h + 3 * a), h += 3 * a, f *= -1; this.ctx.bezierCurveTo(m +
                  f * a, h + a, m + f * a, h + 2 * a, m, h + 3 * a); m = l; f *= -1; this.ctx.lineTo(m, h); for (q = 0; q < p; q++)this.ctx.bezierCurveTo(m + f * a, h - a, m + f * a, h - 2 * a, m, h - 3 * a), h -= 3 * a, f *= -1
              } else { if ("zigzag" === this.type) { f = -1; h = e + a; m = b + a; p = (k - h) / a / 2; for (q = 0; q < p; q++)this.ctx.lineTo(m, h), m += 2 * f * a, h += 2 * a, f *= -1; this.ctx.lineTo(m, h); m += l - b; for (q = 0; q < p + 1; q++)this.ctx.lineTo(m, h), m += 2 * f * a, h -= 2 * a, f *= -1; this.ctx.lineTo(m + f * a, h + a) } } else if ("left" === this.scaleBreaks.parent._position || "right" === this.scaleBreaks.parent._position) if (e = 1 === n % 2 ? (e.y << 0) + 0.5 : e.y <<
                0, k = 1 === n % 2 ? (b.y << 0) + 0.5 : b.y << 0, "left" === this.scaleBreaks.parent._position ? (b = this.chart.plotArea.x1, l = this.chart.plotArea.x2 + n / 2 + 0.5 << 0) : (b = this.chart.plotArea.x2, l = this.chart.plotArea.x1 - n / 2 + 0.5 << 0, a *= -1), this.bounds = { x1: b, y1: e - n / 2, x2: l, y2: k + n / 2 }, this.ctx.moveTo(b, e), "straight" === this.type || "left" === this.scaleBreaks.parent._position && 0 >= a || "right" === this.scaleBreaks.parent._position && 0 <= a) this.ctx.lineTo(l, e), this.ctx.lineTo(l, k), this.ctx.lineTo(b, k); else if ("wavy" === this.type) {
                  m = b; h = e; f = 0.5; p =
                    (l - m) / a / 3; for (q = 0; q < p; q++)this.ctx.bezierCurveTo(m + a, h + f * a, m + 2 * a, h + f * a, m + 3 * a, h), m += 3 * a, f *= -1; this.ctx.bezierCurveTo(m + a, h + f * a, m + 2 * a, h + f * a, m + 3 * a, h); h = k; f *= -1; this.ctx.lineTo(m, h); for (q = 0; q < p; q++)this.ctx.bezierCurveTo(m - a, h + f * a, m - 2 * a, h + f * a, m - 3 * a, h), m -= 3 * a, f *= -1
                } else if ("zigzag" === this.type) { f = 1; h = e - a; m = b + a; p = (l - m) / a / 2; for (q = 0; q < p; q++)this.ctx.lineTo(m, h), h += 2 * f * a, m += 2 * a, f *= -1; this.ctx.lineTo(m, h); h += k - e; for (q = 0; q < p + 1; q++)this.ctx.lineTo(m, h), h += 2 * f * a, m -= 2 * a, f *= -1; this.ctx.lineTo(m + a, h + f * a) } 0 < n && this.ctx.stroke();
        ...
        }; oa(N, X); N.prototype.createUserOptions = function (a) {
          if ("undefined" !== typeof a || this.options._isPlaceholder) {
            var d = 0; this.parent.options._isPlaceholder && this.parent.createUserOptions(); this.options._isPlaceholder || (Ca(this.parent.stripLines), d = this.parent.options.stripLines.indexOf(this.options)); this.options = "undefined" ===
          ...
          this.ctx.save(); var a = this.parent.getPixelCoordinatesOnAxis(this.value), d = Math.abs("pixel" === this._thicknessType ? this.thickness : Math.abs(this.parent.convertValueToPixel(this.endValue) - this.parent.convertValueToPixel(this.startValue))); if (0 < d) {
            var c = null === this.opacity ? 1 : this.opacity; this.ctx.strokeStyle = this.color; this.ctx.beginPath(); var b = this.ctx.globalAlpha; this.ctx.globalAlpha = c; S(this.id); var e, f, l,
              k; this.ctx.lineWidth = d; this.ctx.setLineDash && this.ctx.setLineDash(Q(this.lineDashType, d)); if ("bottom" === this.parent._position || "top" === this.parent._position) e = f = 1 === this.ctx.lineWidth % 2 ? (a.x << 0) + 0.5 : a.x << 0, l = this.chart.plotArea.y1, k = this.chart.plotArea.y2, this.bounds = { x1: e - d / 2, y1: l, x2: f + d / 2, y2: k }; else if ("left" === this.parent._position || "right" === this.parent._position) l = k = 1 === this.ctx.lineWidth % 2 ? (a.y << 0) + 0.5 : a.y << 0, e = this.chart.plotArea.x1, f = this.chart.plotArea.x2, this.bounds = {
                x1: e, y1: l - d / 2, x2: f,
                y2: k + d / 2
              }; this.ctx.moveTo(e, l); this.ctx.lineTo(f, k); this.ctx.stroke(); this.ctx.globalAlpha = b
          } this.ctx.restore()
        }; oa(ba, X); ba.prototype.showAt = function (a) {
          ...
          this.chart.toolTip && this.chart.toolTip._entries && this.chart.toolTip.highlightObjects(this.chart.toolTip._entries); return c
        }; ba.prototype.hide = function () { this.chart.resetOverlayedCanvas(); this.chart.renderCrosshairs(this.parent); this._hidden = !0 }; ba.prototype.render = function (a, d, c) {
          var b, e, f, l, k = null, m = null, h = null, p = ""; if (!this.valueFormatString) if ("dateTime" === this.parent.valueType) this.valueFormatString = this.parent.valueFormatString; else {
            var n = 0, n = "xySwapped" === this.chart.plotInfo.axisPlacement ? 50 <
              this.parent.range ? 0 : 500 < this.chart.width && 25 > this.parent.range ? 2 : Math.floor(Math.abs(Math.log(this.parent.range) / Math.LN10)) + (5 > this.parent.range ? 2 : 10 > this.parent.range ? 1 : 0) : 50 < this.parent.range ? 0 : Math.floor(Math.abs(Math.log(this.parent.range) / Math.LN10)) + (5 > this.parent.range ? 2 : 10 > this.parent.range ? 1 : 0); this.valueFormatString = D.generateValueFormatString(this.parent.range, n)
          } var h = null === this.opacity ? 1 : this.opacity, n = Math.abs("pixel" === this._thicknessType ? this.thickness : this.parent.conversionParameters.pixelPerUnit *
            this.thickness), q = this.chart.overlaidCanvasCtx, g = q.globalAlpha; q.globalAlpha = h; q.beginPath(); q.strokeStyle = this.color; q.lineWidth = n; q.save(); this.labelFontSize = r(this.options.labelFontSize) ? this.parent.labelFontSize : this.labelFontSize; this.labelMaxWidth = r(this.options.labelMaxWidth) ? 0.3 * this.chart.width : this.labelMaxWidth; this.labelMaxHeight = r(this.options.labelWrap) || this.labelWrap ? 0.3 * this.chart.height : 2 * this.labelFontSize; 0 < n && q.setLineDash && q.setLineDash(Q(this.lineDashType, n)); h = new la(q, {
              x: 0,
              ...
              var s =
                0, p = []; if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
                  var v = null; if ("bottom" === this.parent._position || "top" === this.parent._position) s = this.parent.dataSeries[0].axisX.convertPixelToValue({ y: d }); else if ("left" === this.parent._position || "right" === this.parent._position) s = this.parent.convertPixelToValue({ y: d }); for (var w = 0; w < this.parent.dataSeries.length; w++)(v = this.parent.dataSeries[w].getDataPointAtX(s, !0)) && 0 <= v.index && (v.dataSeries = this.parent.dataSeries[w], null !== v.dataPoint.y && v.dataSeries.visible &&
                    p.push(v)); v = null; if (0 === p.length) return; p.sort(function (a, b) { return a.distance - b.distance }); v = Math.abs(a - this.parent.convertValueToPixel(p[0].dataPoint.y)); w = 0; if ("rangeBar" === p[0].dataSeries.type || "error" === p[0].dataSeries.type) for (var v = Math.abs(a - this.parent.convertValueToPixel(p[w].dataPoint.y[0])), t = 0, s = 0; s < p.length; s++)if (p[s].dataPoint.y && p[s].dataPoint.y.length) for (var x = 0; x < p[s].dataPoint.y.length; x++)t = Math.abs(a - this.parent.convertValueToPixel(p[s].dataPoint.y[x])), t < v && (v = t, w = s); else t =
                      Math.abs(a - this.parent.convertValueToPixel(p[s].dataPoint.y)), t < v && (v = t, w = s); else if ("stackedBar" === p[0].dataSeries.type) for (var v = Math.abs(a - this.parent.convertValueToPixel(p[0].dataPoint.y)), A = t = 0, s = w = 0; s < p.length; s++)if (p[s].dataPoint.y && p[s].dataPoint.y.length) for (x = 0; x < p[s].dataPoint.y.length; x++)t = Math.abs(a - this.parent.convertValueToPixel(p[s].dataPoint.y[x])), t < v && (v = t, w = s); else A += p[s].dataPoint.y, t = Math.abs(a - this.parent.convertValueToPixel(A)), t < v && (v = t, w = s); else if ("stackedBar100" === p[0].dataSeries.type) for (var v =
                        Math.abs(a - this.parent.convertValueToPixel(p[0].dataPoint.y)), E = A = t = 0, s = 0; s < p.length; s++)if (p[s].dataPoint.y && p[s].dataPoint.y.length) for (x = 0; x < p[s].dataPoint.y.length; x++)t = Math.abs(a - this.parent.convertValueToPixel(p[s].dataPoint.y[x])), t < v && (v = t, w = s); else A += p[s].dataPoint.y, E = p[s].dataPoint.x.getTime ? p[s].dataPoint.x.getTime() : p[s].dataPoint.x, E = 100 * (A / p[s].dataSeries.plotUnit.dataPointYSums[E]), t = Math.abs(a - this.parent.convertValueToPixel(E)), t < v && (v = t, w = s); else for (v = Math.abs(a - this.parent.convertValueToPixel(p[0].dataPoint.y)),
                          s = w = t = 0; s < p.length; s++)if (p[s].dataPoint.y && p[s].dataPoint.y.length) for (x = 0; x < p[s].dataPoint.y.length; x++)t = Math.abs(a - this.parent.convertValueToPixel(p[s].dataPoint.y[x])), t < v && (v = t, w = s); else t = Math.abs(a - this.parent.convertValueToPixel(p[s].dataPoint.y)), t < v && (v = t, w = s); x = p[w]; if ("bottom" === this.parent._position || "top" === this.parent._position) {
                            b = 0; if ("rangeBar" === this.parent.dataSeries[w].type || "error" === this.parent.dataSeries[w].type) {
                              ...
                              this.parent.dataSeries[w].type) {
                                v = Math.abs(a - this.parent.convertValueToPixel(p[0].dataPoint.y)); A = t = 0; for (s = w; 0 <= s; s--)A += p[s].dataPoint.y, t = Math.abs(a - this.parent.convertValueToPixel(A)), t < v && (v = t, b = s); k = 1 === q.lineWidth % 2 ? (this.parent.convertValueToPixel(A) << 0) + 0.5 : this.parent.convertValueToPixel(A) << 0; h.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: c ? c : x.dataPoint.y }) : r(this.options.label) ? fa(c ? c : x.dataPoint.y, this.valueFormatString,
                                  this.chart._cultureInfo) : this.label
                            } else if ("stackedBar100" === this.parent.dataSeries[w].type) {
                              v = Math.abs(a - this.parent.convertValueToPixel(p[0].dataPoint.y)); E = A = t = 0; for (s = w; 0 <= s; s--)A += p[s].dataPoint.y, E = p[s].dataPoint.x.getTime ? p[s].dataPoint.x.getTime() : p[s].dataPoint.x, E = 100 * (A / p[s].dataSeries.plotUnit.dataPointYSums[E]), t = Math.abs(a - this.parent.convertValueToPixel(E)), t < v && (v = t, b = s); k = 1 === q.lineWidth % 2 ? (this.parent.convertValueToPixel(E) << 0) + 0.5 : this.parent.convertValueToPixel(E) << 0; h.text = this.labelFormatter ?
                                this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: c ? c : E }) : r(this.options.label) ? fa(c ? c : E, this.valueFormatString, this.chart._cultureInfo) : this.label
                            } else k = 1 === q.lineWidth % 2 ? (this.parent.convertValueToPixel(x.dataPoint.y) << 0) + 0.5 : this.parent.convertValueToPixel(x.dataPoint.y) << 0, h.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: c ? c : x.dataPoint.y }) : r(this.options.label) ? fa(c ? c : x.dataPoint.y,
                              this.valueFormatString, this.chart._cultureInfo) : this.label; b = e = k; f = this.chart.plotArea.y1; l = this.chart.plotArea.y2; this.bounds = { x1: b - n / 2, y1: f, x2: e + n / 2, y2: l }; h.x = b - h.measureText().width / 2; h.x + h.width > this.chart.bounds.x2 ? h.x = this.chart.bounds.x2 - h.width : h.x < this.chart.bounds.x1 && (h.x = this.chart.bounds.x1); h.y = this.parent.lineCoordinates.y2 + h.fontSize / 2 + 2; h.y + h.height > this.chart.bounds.y2 ? h.y = this.chart.bounds.y2 - h.height : h.y < this.chart.bounds.y1 && (h.y = this.chart.bounds.y1)
                          } else if ("left" === this.parent._position ||
                            "right" === this.parent._position) {
                              f = l = m = 1 === q.lineWidth % 2 ? (this.parent.convertValueToPixel(x.dataPoint.x) << 0) + 0.5 : this.parent.convertValueToPixel(x.dataPoint.x) << 0; b = this.chart.plotArea.x1; e = this.chart.plotArea.x2; this.bounds = { x1: b, y1: f - n / 2, x2: e, y2: l + n / 2 }; E = !1; if (this.parent.labels) for (p = Math.ceil(this.parent.interval), s = 0; s < this.parent.viewportMaximum; s += p)if (this.parent.labels[s]) E = !0; else { E = !1; break } if (E) {
                                if ("axisX" === this.parent.type) for (s = this.parent.convertPixelToValue({ y: d }), v = null, w = 0; w < this.parent.dataSeries.length; w++)(v =
                                  this.parent.dataSeries[w].getDataPointAtX(s, !0)) && 0 <= v.index && (h.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: x.dataPoint.x }) : r(this.options.label) ? v.dataPoint.label : this.label)
                              } else "dateTime" === this.parent.valueType ? h.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: c ? c : x.dataPoint.x }) : r(this.options.label) ? Aa(c ? c : x.dataPoint.x, this.valueFormatString, this.chart._cultureInfo) :
                                this.label : "number" === this.parent.valueType && (h.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: c ? c : x.dataPoint.x }) : r(this.options.label) ? fa(c ? c : x.dataPoint.x, this.valueFormatString, this.chart._cultureInfo) : this.label); h.y = l + h.fontSize / 2 - h.measureText().height / 2 + 2; h.y - h.fontSize / 2 < this.chart.bounds.y1 ? h.y = this.chart.bounds.y1 + h.fontSize / 2 + 2 : h.y + h.measureText().height - h.fontSize / 2 > this.chart.bounds.y2 && (h.y = this.chart.bounds.y2 - h.measureText().height +
                                  h.fontSize / 2); "left" === this.parent._position ? h.x = this.parent.lineCoordinates.x2 - h.measureText().width : "right" === this.parent._position && (h.x = this.parent.lineCoordinates.x2)
                  }
                } else if ("bottom" === this.parent._position || "top" === this.parent._position) {
                  s = this.parent.convertPixelToValue({ x: a }); for (w = 0; w < this.parent.dataSeries.length; w++)(v = this.parent.dataSeries[w].getDataPointAtX(s, !0)) && 0 <= v.index && (v.dataSeries = this.parent.dataSeries[w], null !== v.dataPoint.y && v.dataSeries.visible && p.push(v)); if (0 === p.length) return;
                  p.sort(function (a, b) { return a.distance - b.distance }); x = p[0]; b = e = k = 1 === q.lineWidth % 2 ? (this.parent.convertValueToPixel(x.dataPoint.x) << 0) + 0.5 : this.parent.convertValueToPixel(x.dataPoint.x) << 0; f = this.chart.plotArea.y1; l = this.chart.plotArea.y2; this.bounds = { x1: b - n / 2, y1: f, x2: e + n / 2, y2: l }; E = !1; if (this.parent.labels) for (p = Math.ceil(this.parent.interval), s = 0; s < this.parent.viewportMaximum; s += p)if (this.parent.labels[s]) E = !0; else { E = !1; break } if (E) {
                    if ("axisX" === this.parent.type) for (s = this.parent.convertPixelToValue({ x: a }),
                      v = null, w = 0; w < this.parent.dataSeries.length; w++)(v = this.parent.dataSeries[w].getDataPointAtX(s, !0)) && 0 <= v.index && (h.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: x.dataPoint.x }) : r(this.options.label) ? v.dataPoint.label : this.label)
                  } else "dateTime" === this.parent.valueType ? h.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: x.dataPoint.x }) : r(this.options.label) ? Aa(c ?
                    c : x.dataPoint.x, this.valueFormatString, this.chart._cultureInfo) : this.label : "number" === this.parent.valueType && (h.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: x.dataPoint.x }) : r(this.options.label) ? fa(c ? c : x.dataPoint.x, this.valueFormatString, this.chart._cultureInfo) : this.label); this.value = x.dataPoint.x; h.x = b - h.measureText().width / 2; h.x + h.width > this.chart.bounds.x2 && (h.x = this.chart.bounds.x2 - h.width); h.x < this.chart.bounds.x1 && (h.x =
                      this.chart.bounds.x1); "bottom" === this.parent._position ? h.y = this.parent.lineCoordinates.y2 + h.fontSize / 2 + 2 : "top" === this.parent._position && (h.y = this.parent.lineCoordinates.y1 - h.height + h.fontSize / 2 + 2)
                } else if ("left" === this.parent._position || "right" === this.parent._position) {
                  !r(this.parent.dataSeries) && 0 < this.parent.dataSeries.length && (s = this.parent.dataSeries[0].axisX.convertPixelToValue({ x: a })); for (w = 0; w < this.parent.dataSeries.length; w++)(v = this.parent.dataSeries[w].getDataPointAtX(s, !0)) && 0 <= v.index &&
                      ...
                      s = t = 0; s < p.length; s++)if (p[s].dataPoint.y && p[s].dataPoint.y.length) for (x = 0; x < p[s].dataPoint.y.length; x++)t = Math.abs(d - this.parent.convertValueToPixel(p[s].dataPoint.y[x])), t < v && (v = t, w = s); else t = Math.abs(d - this.parent.convertValueToPixel(p[s].dataPoint.y)), t < v && (v = t, w = s); else if ("stackedColumn" === p[0].dataSeries.type || "stackedArea" === p[0].dataSeries.type) for (v = Math.abs(d - this.parent.convertValueToPixel(p[0].dataPoint.y)), s = A = t = 0; s < p.length; s++)if (p[s].dataPoint.y && p[s].dataPoint.y.length) for (x = 0; x <
                        p[s].dataPoint.y.length; x++)t = Math.abs(d - this.parent.convertValueToPixel(p[s].dataPoint.y[x])), t < v && (v = t, w = s); else A += p[s].dataPoint.y, t = Math.abs(d - this.parent.convertValueToPixel(A)), t < v && (v = t, w = s); else if ("stackedColumn100" === p[0].dataSeries.type || "stackedArea100" === p[0].dataSeries.type) for (v = Math.abs(d - this.parent.convertValueToPixel(p[0].dataPoint.y)), s = E = A = t = 0; s < p.length; s++)if (p[s].dataPoint.y && p[s].dataPoint.y.length) for (x = 0; x < p[s].dataPoint.y.length; x++)t = Math.abs(d - this.parent.convertValueToPixel(p[s].dataPoint.y[x])),
                          t < v && (v = t, w = s); else A += p[s].dataPoint.y, E = p[s].dataPoint.x.getTime ? p[s].dataPoint.x.getTime() : p[s].dataPoint.x, E = 100 * (A / p[s].dataSeries.plotUnit.dataPointYSums[E]), t = Math.abs(d - this.parent.convertValueToPixel(E)), t < v && (v = t, w = s); else for (v = Math.abs(d - this.parent.convertValueToPixel(p[0].dataPoint.y)), s = t = 0; s < p.length; s++)if (p[s].dataPoint.y && p[s].dataPoint.y.length) for (x = 0; x < p[s].dataPoint.y.length; x++)t = Math.abs(d - this.parent.convertValueToPixel(p[s].dataPoint.y[x])), t < v && (v = t, w = s); else t = Math.abs(d -
                            this.parent.convertValueToPixel(p[s].dataPoint.y)), t < v && (v = t, w = s); x = p[w]; b = 0; if ("rangeColumn" === this.parent.dataSeries[w].type || "rangeArea" === this.parent.dataSeries[w].type || "error" === this.parent.dataSeries[w].type || "rangeSplineArea" === this.parent.dataSeries[w].type || "candlestick" === this.parent.dataSeries[w].type || "ohlc" === this.parent.dataSeries[w].type || "boxAndWhisker" === this.parent.dataSeries[w].type) {
                              v = Math.abs(d - this.parent.convertValueToPixel(x.dataPoint.y[0])); for (s = t = 0; s < x.dataPoint.y.length; s++)t =
                              ...
                              this.parent.dataSeries[w].type || "stackedArea" === this.parent.dataSeries[w].type) {
                                v = Math.abs(d - this.parent.convertValueToPixel(p[0].dataPoint.y)); A = t = 0; for (s = w; 0 <= s; s--)A += p[s].dataPoint.y, t = Math.abs(d - this.parent.convertValueToPixel(A)), t < v && (v = t, b = s); m = 1 === q.lineWidth % 2 ? (this.parent.convertValueToPixel(A) << 0) + 0.5 : this.parent.convertValueToPixel(A) << 0; h.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: c ? c : x.dataPoint.y }) : r(this.options.label) ?
                                  fa(c ? c : x.dataPoint.y, this.valueFormatString, this.chart._cultureInfo) : this.label; this.value = A
                  } else if ("stackedColumn100" === this.parent.dataSeries[w].type || "stackedArea100" === this.parent.dataSeries[w].type) {
                    v = Math.abs(d - this.parent.convertValueToPixel(p[0].dataPoint.y)); A = t = 0; for (s = w; 0 <= s; s--)A += p[s].dataPoint.y, E = p[s].dataPoint.x.getTime ? p[s].dataPoint.x.getTime() : p[s].dataPoint.x, E = 100 * (A / p[s].dataSeries.plotUnit.dataPointYSums[E]), t = Math.abs(d - this.parent.convertValueToPixel(E)), t < v && (v = t, b = s); m =
                    ...
                    0, h.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: c ? c : x.dataSeries.dataPointEOs[x.index].cumulativeSum }) : r(this.options.label) ? fa(c ? c : x.dataSeries.dataPointEOs[x.index].cumulativeSum, this.valueFormatString, this.chart._cultureInfo) : this.label, this.value = x.dataSeries.dataPointEOs[x.index].cumulativeSum) : (m = 1 === q.lineWidth % 2 ? (r(a) ? d : this.parent.convertValueToPixel(x.dataPoint.y) << 0) + 0.5 : r(a) ? d : this.parent.convertValueToPixel(x.dataPoint.y) <<
                      0, h.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: x.dataPoint.y }) : r(this.options.label) ? fa(c ? c : x.dataPoint.y, this.valueFormatString, this.chart._cultureInfo) : this.label, this.value = x.dataPoint.y); f = l = m; b = this.chart.plotArea.x1; e = this.chart.plotArea.x2; this.bounds = { x1: b, y1: f - n / 2, x2: e, y2: l + n / 2 }; h.y = l + h.fontSize / 2 - h.measureText().height / 2 + 2; h.y - h.fontSize / 2 < this.chart.bounds.y1 ? h.y = this.chart.bounds.y1 + h.fontSize / 2 + 2 : h.y + h.measureText().height -
                        h.fontSize / 2 > this.chart.bounds.y2 && (h.y = this.chart.bounds.y2 - h.measureText().height + h.fontSize / 2); "left" === this.parent._position ? h.x = this.parent.lineCoordinates.x2 - h.measureText().width : "right" === this.parent._position && (h.x = this.parent.lineCoordinates.x2)
                } p = null; if ("bottom" === this.parent._position || "top" === this.parent._position) "top" === this.parent._position && h.y - h.fontSize / 2 < this.chart.bounds.y1 && (h.y = this.chart.bounds.y1 + h.fontSize / 2), "bottom" === this.parent._position && this.parent.lineCoordinates.y2 -
              ...
              if ("bottom" === this.parent._position || "top" === this.parent._position) b = e = k = 1 === q.lineWidth % 2 ? (a << 0) + 0.5 : a << 0, f = this.chart.plotArea.y1, l = this.chart.plotArea.y2, this.bounds = { x1: b - n / 2, y1: f, x2: e + n / 2, y2: l }; else if ("left" === this.parent._position || "right" === this.parent._position) f = l = m = 1 === q.lineWidth % 2 ? (d << 0) + 0.5 : d << 0, b = this.chart.plotArea.x1, e = this.chart.plotArea.x2,
                this.bounds = { x1: b, y1: f - n / 2, x2: e, y2: l + n / 2 }; if ("xySwapped" === this.chart.plotInfo.axisPlacement) if ("left" === this.parent._position || "right" === this.parent._position) {
                  E = !1; if (this.parent.labels) for (p = Math.ceil(this.parent.interval), s = 0; s < this.parent.viewportMaximum; s += p)if (this.parent.labels[s]) E = !0; else { E = !1; break } if (E) {
                    if ("axisX" === this.parent.type) for (s = this.parent.convertPixelToValue({ y: d }), v = null, w = 0; w < this.parent.dataSeries.length; w++)(v = this.parent.dataSeries[w].getDataPointAtX(s, !0)) && 0 <= v.index &&
                      (h.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: c ? c : this.parent.convertPixelToValue(a) }) : r(this.options.label) ? v.dataPoint.label : this.label)
                  } else "dateTime" === this.parent.valueType ? h.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: c ? c : this.parent.convertPixelToValue(d) }) : r(this.options.label) ? Aa(c ? c : this.parent.convertPixelToValue(d), this.valueFormatString, this.chart._cultureInfo) :
                  ...
                  if ("bottom" === this.parent._position || "top" === this.parent._position) h.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: c ? c : this.parent.convertPixelToValue(a) }) : r(this.options.label) ? fa(c ? c : this.parent.convertPixelToValue(a),
                  ...
                  E = !1; p = ""; if (this.parent.labels) for (p = Math.ceil(this.parent.interval),
                    s = 0; s < this.parent.viewportMaximum; s += p)if (this.parent.labels[s]) E = !0; else { E = !1; break } if (E) { if ("axisX" === this.parent.type) for (s = this.parent.convertPixelToValue({ x: a }), v = null, w = 0; w < this.parent.dataSeries.length; w++)(v = this.parent.dataSeries[w].getDataPointAtX(s, !0)) && 0 <= v.index && (h.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: c ? c : this.parent.convertPixelToValue(a) }) : r(this.options.label) ? c ? c : v.dataPoint.label : this.label) } else "dateTime" ===
                      this.parent.valueType ? h.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: c ? c : this.parent.convertPixelToValue(a) }) : r(this.options.label) ? Aa(c ? c : this.parent.convertPixelToValue(a), this.valueFormatString, this.chart._cultureInfo) : this.label : "number" === this.parent.valueType && (h.text = this.labelFormatter ? this.labelFormatter({
            ...
            "top" === this.parent._position) this._updatedValue = this.parent.convertPixelToValue(k); if ("left" === this.parent._position || "right" === this.parent._position) this._updatedValue = this.parent.convertPixelToValue(m); q.globalAlpha = g
        }; oa(aa, X); aa.prototype._initialize = function () {
        ...
        }; aa.prototype.mouseMoveHandler = function (a, d) { this._lastUpdated && 4 > (new Date).getTime() - this._lastUpdated || (this._lastUpdated = (new Date).getTime(), this.chart.resetOverlayedCanvas(), this._updateToolTip(a, d)) }; aa.prototype._updateToolTip = function (a, d, c) {
          ...
          this.enabled || (this.hide(), this.dispatchEvent("hidden", { chart: this.chart, toolTip: this }, this)); if (!this.chart.disableToolTip) {
            if ("undefined" === typeof a || "undefined" === typeof d) { if (isNaN(this._prevX) || isNaN(this._prevY)) return; a = this._prevX; d = this._prevY } else this._prevX = a, this._prevY = d; var b = null, e = null, f = [], l = 0; if (this.shared && this.enabled && "none" !== this.chart.plotInfo.axisPlacement) {
              if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
                var k = []; if (this.chart.axisX) for (var m = 0; m < this.chart.axisX.length; m++) {
                  for (var l =
                    this.chart.axisX[m].convertPixelToValue({ y: d }), h = null, b = 0; b < this.chart.axisX[m].dataSeries.length; b++)(h = this.chart.axisX[m].dataSeries[b].getDataPointAtX(l, c)) && 0 <= h.index && (h.dataSeries = this.chart.axisX[m].dataSeries[b], null !== h.dataPoint.y && k.push(h)); h = null
                } if (this.chart.axisX2) for (m = 0; m < this.chart.axisX2.length; m++) {
                  l = this.chart.axisX2[m].convertPixelToValue({ y: d }); h = null; for (b = 0; b < this.chart.axisX2[m].dataSeries.length; b++)(h = this.chart.axisX2[m].dataSeries[b].getDataPointAtX(l, c)) && 0 <= h.index &&
                    (h.dataSeries = this.chart.axisX2[m].dataSeries[b], null !== h.dataPoint.y && k.push(h)); h = null
                }
              } else {
                k = []; if (this.chart.axisX) for (m = 0; m < this.chart.axisX.length; m++)for (l = this.chart.axisX[m].convertPixelToValue({ x: a }), h = null, b = 0; b < this.chart.axisX[m].dataSeries.length; b++)(h = this.chart.axisX[m].dataSeries[b].getDataPointAtX(l, c)) && 0 <= h.index && (h.dataSeries = this.chart.axisX[m].dataSeries[b], null !== h.dataPoint.y && k.push(h)); if (this.chart.axisX2) for (m = 0; m < this.chart.axisX2.length; m++)for (l = this.chart.axisX2[m].convertPixelToValue({ x: a }),
              ...
              } if (0 === k.length) return; k.sort(function (a, b) { return a.distance - b.distance }); c = k[0]; for (b = 0; b < k.length; b++)k[b].dataPoint.x.valueOf() === c.dataPoint.x.valueOf() && f.push(k[b]); k = null
            } else {
                  ...
                  e = this.chart.data[this.currentSeriesIndex]; h = {}; if (0 <= this.currentDataPointIndex) b =
                    e.dataPoints[this.currentDataPointIndex], h.dataSeries = e, h.dataPoint = b, h.index = this.currentDataPointIndex, h.distance = Math.abs(b.x - l), "waterfall" === e.type && (h.cumulativeSumYStartValue = e.dataPointEOs[this.currentDataPointIndex].cumulativeSumYStartValue, h.cumulativeSum = e.dataPointEOs[this.currentDataPointIndex].cumulativeSum); else {
                      if (!this.enabled || "line" !== e.type && "stepLine" !== e.type && "spline" !== e.type && "area" !== e.type && "stepArea" !== e.type && "splineArea" !== e.type && "stackedArea" !== e.type && "stackedArea100" !==
                        e.type && "rangeArea" !== e.type && "rangeSplineArea" !== e.type && "candlestick" !== e.type && "ohlc" !== e.type && "boxAndWhisker" !== e.type) return; l = e.axisX.convertPixelToValue({ x: a }); h = e.getDataPointAtX(l, c); r(h) || (h.dataSeries = e, this.currentDataPointIndex = h.index, b = h.dataPoint)
              ...
              this.highlightObjects(f); if (this.enabled) {
                var p = "", p = this.getToolTipInnerHTML({ entries: f }); if (null !== p) {
                  this.contentDiv.innerHTML = p; c = !1; "none" === this.container.style.display && (c = !0, this.container.style.display = "block"); try {
                      ...
                      this.contentDiv.style.borderColor = this.options.borderColor ? this.options.borderColor : f[0].dataPoint.color ? f[0].dataPoint.color : 0 < f[0].dataPoint.y ? f[0].dataSeries.risingColor : f[0].dataSeries.fallingColor : "error" === f[0].dataSeries.type ? this.contentDiv.style.borderRightColor = this.contentDiv.style.borderLeftColor = this.contentDiv.style.borderColor = this.options.borderColor ? this.options.borderColor : f[0].dataSeries.color ? f[0].dataSeries.color : f[0].dataSeries._colorSet[e.index % f[0].dataSeries._colorSet.length] :
                        this.contentDiv.style.borderRightColor = this.contentDiv.style.borderLeftColor = this.contentDiv.style.borderColor = this.options.borderColor ? this.options.borderColor : f[0].dataPoint.color ? f[0].dataPoint.color : f[0].dataSeries.color ? f[0].dataSeries.color : f[0].dataSeries._colorSet[f[0].index % f[0].dataSeries._colorSet.length], this.contentDiv.style.borderWidth = this.borderThickness || 0 === this.borderThickness ? this.borderThickness + "px" : "2px", this.contentDiv.style.borderRadius = this.cornerRadius || 0 === this.cornerRadius ?
                          this.cornerRadius + "px" : "5px", this.container.style.borderRadius = this.contentDiv.style.borderRadius, this.contentDiv.style.fontSize = this.fontSize || 0 === this.fontSize ? this.fontSize + "px" : "14px", this.contentDiv.style.color = this.fontColor ? this.fontColor : "#000000", this.contentDiv.style.fontFamily = this.fontFamily ? this.fontFamily : "Calibri, Arial, Georgia, serif;", this.contentDiv.style.fontWeight = this.fontWeight ? this.fontWeight : "normal", this.contentDiv.style.fontStyle = this.fontStyle ? this.fontStyle : s ? "italic" :
                            "normal"
                  } catch (n) { } "pie" === f[0].dataSeries.type || "doughnut" === f[0].dataSeries.type || "funnel" === f[0].dataSeries.type || "pyramid" === f[0].dataSeries.type || "bar" === f[0].dataSeries.type || "rangeBar" === f[0].dataSeries.type || "stackedBar" === f[0].dataSeries.type || "stackedBar100" === f[0].dataSeries.type ? a = a - 10 - this.container.clientWidth : (a = f[0].dataSeries.axisX.convertValueToPixel(f[0].dataPoint.x) - this.container.clientWidth << 0, a -= 10); 0 > a && (a += this.container.clientWidth + 20); a + this.container.clientWidth > Math.max(this.chart.container.clientWidth,
                  ...
                  this)
              } d = []; for (b = 0; b < f.length; b++)d.push({ xValue: f[b].dataPoint.x, dataPoint: f[b].dataPoint, dataSeries: f[b].dataSeries, dataPointIndex: f[b].index, dataSeriesIndex: f[b].dataSeries._index }); p = { chart: this.chart, toolTip: this.options, content: p, entries: d }; this._entries = f; this.dispatchEvent("updated", p, this)
            } else this.hide()
          }
        }; aa.prototype.highlightObjects = function (a) {
          var d = this.chart.overlaidCanvasCtx; if (r(this.chart.clearedOverlayedCanvas) || "toolTip" === this.chart.clearedOverlayedCanvas) this.chart.resetOverlayedCanvas(),
            d.clearRect(0, 0, this.chart.width, this.chart.height), this.chart.clearedOverlayedCanvas = "toolTip"; d.save(); var c = this.chart.plotArea, b = 0; d.beginPath(); d.rect(c.x1, c.y1, c.x2 - c.x1, c.y2 - c.y1); d.clip(); for (c = 0; c < a.length; c++) {
              var e = a[c]; if ((e = this.chart._eventManager.objectMap[e.dataSeries.dataPointIds[e.index]]) && e.objectType && "dataPoint" === e.objectType) {
                var b = this.chart.data[e.dataSeriesIndex], f = b.dataPoints[e.dataPointIndex], l = e.dataPointIndex; !1 === f.highlightEnabled || !0 !== b.highlightEnabled && !0 !== f.highlightEnabled ||
          ...
          a = a.entries; for (var d = null, c = null, b = null, e = 0, f = "", l = !0, k = 0; k < a.length; k++)if (a[k].dataSeries.toolTipContent ||
            a[k].dataPoint.toolTipContent) { l = !1; break } if (l && (this.content && "function" === typeof this.content || this.contentFormatter)) a = { chart: this.chart, toolTip: this.options, entries: a }, d = this.contentFormatter ? this.contentFormatter(a) : this.content(a); else if (this.shared && "none" !== this.chart.plotInfo.axisPlacement) {
              for (var m = null, h = "", k = 0; k < a.length; k++)c = a[k].dataSeries, b = a[k].dataPoint, e = a[k].index, f = "", 0 === k && (l && !this.content) && (this.chart.axisX && 0 < this.chart.axisX.length ? h += "undefined" !== typeof this.chart.axisX[0].labels[b.x] ?
                this.chart.axisX[0].labels[b.x] : "{x}" : this.chart.axisX2 && 0 < this.chart.axisX2.length && (h += "undefined" !== typeof this.chart.axisX2[0].labels[b.x] ? this.chart.axisX2[0].labels[b.x] : "{x}"), h += "</br>", h = this.chart.replaceKeywordsWithValue(h, b, c, e)), null === b.toolTipContent || "undefined" === typeof b.toolTipContent && null === c.options.toolTipContent || ("line" === c.type || "stepLine" === c.type || "spline" === c.type || "area" === c.type || "stepArea" === c.type || "splineArea" === c.type || "column" === c.type || "bar" === c.type || "scatter" ===
                  ...
                  null === d && (d = ""), !0 === this.reversed ? (d = this.chart.replaceKeywordsWithValue(f, b, c, e) + d, k < a.length - 1 && (d = "</br>" + d)) : (d += this.chart.replaceKeywordsWithValue(f, b, c, e), k < a.length - 1 && (d += "</br>"))); null !== d && (d = h + d)
            } else {
        ...
        }; aa.prototype.hide = function (a) { this.container && (this.container.style.display = "none", this.currentSeriesIndex = -1, this._prevY = this._prevX = NaN, ("undefined" === typeof a || a) && this.chart.resetOverlayedCanvas()) }; aa.prototype.show = function (a, d, c) { this._updateToolTip(a, d, "undefined" === typeof c ? !1 : c) }; aa.prototype.showAtIndex = function (a, d) { }; aa.prototype.showAtX = function (a, d) {
          if (!this.enabled) return !1;
          this.chart.clearedOverlayedCanvas = null; var c, b, e, f = []; e = !1; d = !r(d) && 0 <= d && d < this.chart.data.length ? d : 0; if (this.shared) for (var l = 0; l < this.chart.data.length; l++)c = this.chart.data[l], (b = c.getDataPointAtX(a, !1)) && (b.dataPoint && !r(b.dataPoint.y) && c.visible) && (b.dataSeries = c, f.push(b)); else c = this.chart.data[d], (b = c.getDataPointAtX(a, !1)) && (b.dataPoint && !r(b.dataPoint.y) && c.visible) && (b.dataSeries = c, f.push(b)); if (0 < f.length) {
            for (l = 0; l < f.length; l++)if (b = f[l], b.dataPoint.x < b.dataSeries.axisX.viewportMinimum ||
              b.dataPoint.x > b.dataSeries.axisX.viewportMaximum || b.dataPoint.y < b.dataSeries.axisY.viewportMinimum || b.dataPoint.y > b.dataSeries.axisY.viewportMaximum) e = !0; else { e = !1; break } if (e) return this.hide(), !1; this.highlightObjects(f); this._entries = f; b = ""; b = this.getToolTipInnerHTML({ entries: f }); if (null !== b) {
                ...
                } catch (k) { } "pie" === f[0].dataSeries.type || "doughnut" === f[0].dataSeries.type || "funnel" === f[0].dataSeries.type || "pyramid" === f[0].dataSeries.type ? c = mouseX - 10 - this.container.clientWidth : (c = "bar" === f[0].dataSeries.type || "rangeBar" === f[0].dataSeries.type || "stackedBar" === f[0].dataSeries.type || "stackedBar100" === f[0].dataSeries.type ? f[0].dataSeries.axisY.convertValueToPixel(f[0].dataPoint.y) -
        ...
        }; aa.prototype.getContainerTransition = function (a) { return "left " + a + "s ease-out 0s, bottom " + a + "s ease-out 0s" }; ea.prototype.reset = function () {
          ...
          if ("mousemove" === a.type || "click" === a.type) {
            var d = [], c = Na(a), b = null; if ((b = this.chart.getObjectAtXY(c.x, c.y, !1)) && "undefined" !== typeof this.objectMap[b]) if (b = this.objectMap[b], "dataPoint" === b.objectType) {
              var e = this.chart.data[b.dataSeriesIndex], f = e.dataPoints[b.dataPointIndex], l = b.dataPointIndex; b.eventParameter = {
          ...
          yScaleAnimation: function (a, d) { if (0 !== a) { var c = d.dest, b = d.source.canvas, e = d.animationBase; c.drawImage(b, 0, 0, b.width, b.height, 0, e - e * a, c.canvas.width / ja, a * c.canvas.height / ja) } }, xScaleAnimation: function (a, d) { if (0 !== a) { var c = d.dest, b = d.source.canvas, e = d.animationBase; c.drawImage(b, 0, 0, b.width, b.height, e - e * a, 0, a * c.canvas.width / ja, c.canvas.height / ja) } }, xClipAnimation: function (a, d) {
            if (0 !== a) {
              var c = d.dest, b = d.source.canvas; c.save(); 0 < a && c.drawImage(b, 0, 0, b.width * a, b.height, 0, 0, b.width * a / ja, b.height /
                ja); c.restore()
            }
          ...
          drawMarker: function (a,
            ...
            for (var d = 0; d < a.length; d++) {
              var c = a[d]; Y.drawMarker(c.x, c.y, c.ctx, c.type,
                c.size, c.color, c.borderColor, c.borderThickness)
            }
          }
        }; return m
      }(); w.version = "v3.2.3 GA"; window.CanvasJS && (w && !window.CanvasJS.Chart) && (window.CanvasJS.Chart = w)
})();
